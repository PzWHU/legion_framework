...
class PredictionObstacles {
 public:
  PredictionObstacles() {
    ...
    end_timestamp_ = 0.0;
    self_intent_ = legion::interface::PredictionObstacles::SelfIntent::UNKNOWN;
  ...
  inline void set_prediction_obstacles(
      const std::vector<legion::interface::PredictionObstacle>&
          prediction_obstacles) {
    std::lock_guard<std::mutex> lock(*prediction_obstacles_mutex_);
  ...
  inline void set_prediction_obstacles(
      ...
      legion::interface::PredictionObstacle& prediction_obstacles) {
    std::lock_guard<std::mutex> lock(*prediction_obstacles_mutex_);
    prediction_obstacles_[index] = prediction_obstacles;
  }

  inline void add_prediction_obstacles(
      const legion::interface::PredictionObstacle& prediction_obstacles) {
    std::lock_guard<std::mutex> lock(*prediction_obstacles_mutex_);
    prediction_obstacles_.emplace_back(prediction_obstacles);
  }

  inline const legion::interface::PredictionObstacle& prediction_obstacles(
      uint32_t index) const {
    std::lock_guard<std::mutex> lock(*prediction_obstacles_mutex_);
    return prediction_obstacles_[index];
  }

  inline std::vector<legion::interface::PredictionObstacle>*
  ...
  inline void prediction_obstacles(
      std::vector<legion::interface::PredictionObstacle>& prediction_obstacles)
      const {
    std::lock_guard<std::mutex> lock(*prediction_obstacles_mutex_);
  ...
  inline const std::vector<legion::interface::PredictionObstacle>&
  ...
  inline void set_self_intent(
      const legion::interface::PredictionObstacles::SelfIntent& self_intent) {
    self_intent_ = self_intent;
    self_intent_ptr_ = &self_intent_;
  }

  inline const legion::interface::PredictionObstacles::SelfIntent& self_intent()
      const {
    return self_intent_;
  }

  inline legion::interface::PredictionObstacles::SelfIntent*
  mutable_self_intent() {
    return &self_intent_;
  }
 ...
 protected:
  ...
  std::vector<legion::interface::PredictionObstacle> prediction_obstacles_;
  ...
  legion::interface::PredictionObstacles::SelfIntent self_intent_;
  legion::interface::PredictionObstacles::SelfIntent* self_intent_ptr_ =
      nullptr;
