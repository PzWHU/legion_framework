...
class ControlAnalysis {
 public:
  ControlAnalysis() {
    ...
    driving_mode_fd_ = legion::common::DrivingMode::COMPLETE_MANUAL;
    gear_location_fd_ = legion::common::GearPosition::GEAR_NEUTRAL;
    gear_location_cmd_ = legion::common::GearPosition::GEAR_NEUTRAL;
    epb_level_fd_ = legion::common::EPBLevel::RELEASED;
    epb_level_cmd_ = legion::common::EPBLevel::RELEASED;
    speed_mps_ = 0.0;
  ...
  inline void set_driving_mode_fd(
      const legion::common::DrivingMode& driving_mode_fd) {
    driving_mode_fd_ = driving_mode_fd;
    driving_mode_fd_ptr_ = &driving_mode_fd_;
  }

  inline const legion::common::DrivingMode& driving_mode_fd() const {
    return driving_mode_fd_;
  }

  inline legion::common::DrivingMode* mutable_driving_mode_fd() {
    return &driving_mode_fd_;
  }
  ...
  inline void set_gear_location_fd(
      const legion::common::GearPosition& gear_location_fd) {
    gear_location_fd_ = gear_location_fd;
    gear_location_fd_ptr_ = &gear_location_fd_;
  }

  inline const legion::common::GearPosition& gear_location_fd() const {
    return gear_location_fd_;
  }

  inline legion::common::GearPosition* mutable_gear_location_fd() {
    return &gear_location_fd_;
  }
  ...
  inline void set_gear_location_cmd(
      const legion::common::GearPosition& gear_location_cmd) {
    gear_location_cmd_ = gear_location_cmd;
    gear_location_cmd_ptr_ = &gear_location_cmd_;
  }

  inline const legion::common::GearPosition& gear_location_cmd() const {
    return gear_location_cmd_;
  }

  inline legion::common::GearPosition* mutable_gear_location_cmd() {
    return &gear_location_cmd_;
  }
  ...
  inline void set_epb_level_fd(const legion::common::EPBLevel& epb_level_fd) {
    epb_level_fd_ = epb_level_fd;
    epb_level_fd_ptr_ = &epb_level_fd_;
  }

  inline const legion::common::EPBLevel& epb_level_fd() const {
    return epb_level_fd_;
  }

  inline legion::common::EPBLevel* mutable_epb_level_fd() {
    return &epb_level_fd_;
  }

  inline bool has_epb_level_fd() { return (epb_level_fd_ptr_ != nullptr); }

  inline void set_epb_level_cmd(const legion::common::EPBLevel& epb_level_cmd) {
    epb_level_cmd_ = epb_level_cmd;
    epb_level_cmd_ptr_ = &epb_level_cmd_;
  }

  inline const legion::common::EPBLevel& epb_level_cmd() const {
    return epb_level_cmd_;
  }

  inline legion::common::EPBLevel* mutable_epb_level_cmd() {
    return &epb_level_cmd_;
  }
  ...
  inline void set_acceleration_cmd_closeloop(
      const double& acceleration_cmd_closeloop) {
  ...
  inline void set_slope_offset_compensation(
      const double& slope_offset_compensation) {
  ...
  inline void set_turning_offset_compensation(
      const double& turning_offset_compensation) {
  ...
  inline void set_lon_calculate_time_max(
      const int64_t& lon_calculate_time_max) {
  ...
  inline void set_front_steering_value_fd(
      const double& front_steering_value_fd) {
  ...
  inline void set_front_steer_angle_feedback(
      const double& front_steer_angle_feedback) {
  ...
  inline void set_rear_steer_angle_feedforward(
      const double& rear_steer_angle_feedforward) {
  ...
  inline void set_rear_steer_angle_feedback(
      const double& rear_steer_angle_feedback) {
  ...
  inline void set_lqr_calculate_time_max(
      const int64_t& lqr_calculate_time_max) {
 ...
 protected:
  ...
  //驾驶模式反馈
  legion::common::DrivingMode driving_mode_fd_;
  legion::common::DrivingMode* driving_mode_fd_ptr_ = nullptr;
  //档位反馈
  legion::common::GearPosition gear_location_fd_;
  legion::common::GearPosition* gear_location_fd_ptr_ = nullptr;
  //档位命令
  legion::common::GearPosition gear_location_cmd_;
  legion::common::GearPosition* gear_location_cmd_ptr_ = nullptr;
  // EPB状态反馈
  legion::common::EPBLevel epb_level_fd_;
  legion::common::EPBLevel* epb_level_fd_ptr_ = nullptr;
  // EPB命令
  legion::common::EPBLevel epb_level_cmd_;
  legion::common::EPBLevel* epb_level_cmd_ptr_ = nullptr;
  //车辆速度
  double speed_mps_;
