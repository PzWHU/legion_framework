...
class CameraParkingInfoList {
 public:
  ...
  inline void set_camera_parking(
      std::vector<legion::interface::CameraParkingInfo>* camera_parking) {
    std::lock_guard<std::mutex> lock(*camera_parking_mutex_);
    camera_parking_.assign(camera_parking->begin(), camera_parking->end());
  }

  inline void set_camera_parking(
      const std::vector<legion::interface::CameraParkingInfo>& camera_parking) {
    std::lock_guard<std::mutex> lock(*camera_parking_mutex_);
  ...
  inline void set_camera_parking(
      ...
      legion::interface::CameraParkingInfo& camera_parking) {
    std::lock_guard<std::mutex> lock(*camera_parking_mutex_);
    camera_parking_[index] = camera_parking;
  }

  inline void add_camera_parking(
      const legion::interface::CameraParkingInfo& camera_parking) {
    std::lock_guard<std::mutex> lock(*camera_parking_mutex_);
    camera_parking_.emplace_back(camera_parking);
  }

  inline const legion::interface::CameraParkingInfo& camera_parking(
      uint32_t index) const {
    std::lock_guard<std::mutex> lock(*camera_parking_mutex_);
    return camera_parking_[index];
  }

  inline std::vector<legion::interface::CameraParkingInfo>*
  ...
  inline void camera_parking(
      std::vector<legion::interface::CameraParkingInfo>& camera_parking) const {
    std::lock_guard<std::mutex> lock(*camera_parking_mutex_);
    camera_parking.assign(camera_parking_.begin(), camera_parking_.end());
  }

  inline const std::vector<legion::interface::CameraParkingInfo>&
  ...
  inline void set_camera_parking_stoppers(
      std::vector<legion::interface::CameraParkingStopper>*
  ...
  inline void set_camera_parking_stoppers(
      const std::vector<legion::interface::CameraParkingStopper>&
          camera_parking_stoppers) {
    std::lock_guard<std::mutex> lock(*camera_parking_stoppers_mutex_);
  ...
  inline void set_camera_parking_stoppers(
      const uint32_t index,
      legion::interface::CameraParkingStopper& camera_parking_stoppers) {
    std::lock_guard<std::mutex> lock(*camera_parking_stoppers_mutex_);
    camera_parking_stoppers_[index] = camera_parking_stoppers;
  }

  inline void add_camera_parking_stoppers(
      const legion::interface::CameraParkingStopper& camera_parking_stoppers) {
    std::lock_guard<std::mutex> lock(*camera_parking_stoppers_mutex_);
    camera_parking_stoppers_.emplace_back(camera_parking_stoppers);
  }

  inline const legion::interface::CameraParkingStopper& camera_parking_stoppers(
      uint32_t index) const {
    std::lock_guard<std::mutex> lock(*camera_parking_stoppers_mutex_);
    return camera_parking_stoppers_[index];
  }

  inline std::vector<legion::interface::CameraParkingStopper>*
  mutable_camera_parking_stoppers() {
    std::lock_guard<std::mutex> lock(*camera_parking_stoppers_mutex_);
    return &camera_parking_stoppers_;
  }

  inline void camera_parking_stoppers(
      std::vector<legion::interface::CameraParkingStopper>&
  ...
  inline const std::vector<legion::interface::CameraParkingStopper>&
  camera_parking_stoppers() const {
    std::lock_guard<std::mutex> lock(*camera_parking_stoppers_mutex_);
    return camera_parking_stoppers_;
  }
 ...
 protected:
  ...
  //检测出的障碍物数组
  std::vector<legion::interface::CameraParkingInfo> camera_parking_;
  //检测出的限位器数组
  std::vector<legion::interface::CameraParkingStopper> camera_parking_stoppers_;
  //错误码（default = OK）
