...
class ParkingOutInfo {
 public:
  ...
  inline void set_parking_out_point(
      const legion::interface::Point3D& parking_out_point) {
    parking_out_point_ = parking_out_point;
    parking_out_point_ptr_ = &parking_out_point_;
  }

  inline const legion::interface::Point3D& parking_out_point() const {
    return parking_out_point_;
  }

  inline legion::interface::Point3D* mutable_parking_out_point() {
    return &parking_out_point_;
  }
 ...
 protected:
  ...
  //世界坐标系下提车点位置
  legion::interface::Point3D parking_out_point_;
  legion::interface::Point3D* parking_out_point_ptr_ = nullptr;
