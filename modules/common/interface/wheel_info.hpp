...
class WheelInfo {
 public:
  WheelInfo() {
    ...
    speed_mps_ = 0.0;
    veh_spd_vld_ = false;
    gear_ = legion::common::GearPosition::GEAR_NEUTRAL;
    gear_vld_ = false;
  ...
  inline void set_gear(const legion::common::GearPosition& gear) {
    gear_ = gear;
    gear_ptr_ = &gear_;
  }

  inline const legion::common::GearPosition& gear() const { return gear_; }

  inline legion::common::GearPosition* mutable_gear() { return &gear_; }
 ...
 protected:
  ...
  //档位
  legion::common::GearPosition gear_;
  legion::common::GearPosition* gear_ptr_ = nullptr;
  //档位有效性
  bool gear_vld_;
