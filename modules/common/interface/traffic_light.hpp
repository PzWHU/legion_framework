...
class TrafficLight {
 public:
  TrafficLight() {
    ...
    color_ = legion::common::TrafficLightColor::COLOR_UNKNOWN;
    id_ = 0;
    type_ = legion::common::TrafficLightType::STRAIGHT;
    confidence_ = 0.0;
    distance_ = 0.0;
    clear_light_lanes();
    tracking_time_ = 0.0;
  ...
  inline void set_color(const legion::common::TrafficLightColor& color) {
    color_ = color;
    color_ptr_ = &color_;
  }

  inline const legion::common::TrafficLightColor& color() const {
    return color_;
  }

  inline legion::common::TrafficLightColor* mutable_color() { return &color_; }
  ...
  inline void set_type(const legion::common::TrafficLightType& type) {
    type_ = type;
    type_ptr_ = &type_;
  }

  inline const legion::common::TrafficLightType& type() const { return type_; }

  inline legion::common::TrafficLightType* mutable_type() { return &type_; }
  ...
  inline void set_light_rect(const legion::interface::ImageRect& light_rect) {
    light_rect_ = light_rect;
    light_rect_ptr_ = &light_rect_;
  }

  inline const legion::interface::ImageRect& light_rect() const {
    return light_rect_;
  }

  inline legion::interface::ImageRect* mutable_light_rect() {
    return &light_rect_;
  }
 ...
 protected:
  ...
  legion::common::TrafficLightColor color_;
  legion::common::TrafficLightColor* color_ptr_ = nullptr;
  // light id
  uint32_t id_;
  ...
  // 8;
  legion::common::TrafficLightType type_;
  legion::common::TrafficLightType* type_ptr_ = nullptr;
  //置信度confdence: [0-1]
  double confidence_;
  double* confidence_ptr_ = nullptr;
  //交通灯矩形框light rect
  legion::interface::ImageRect light_rect_;
  legion::interface::ImageRect* light_rect_ptr_ = nullptr;
