...
class ObstacleFeature {
 public:
  ...
  inline void set_polygon_point(
      const legion::interface::Point3D& polygon_point) {
    polygon_point_ = polygon_point;
    polygon_point_ptr_ = &polygon_point_;
  }

  inline const legion::interface::Point3D& polygon_point() const {
    return polygon_point_;
  }

  inline legion::interface::Point3D* mutable_polygon_point() {
    return &polygon_point_;
  }

  inline bool has_polygon_point() { return (polygon_point_ptr_ != nullptr); }

  inline void set_position(const legion::interface::Point3D& position) {
    position_ = position;
    position_ptr_ = &position_;
  }

  inline const legion::interface::Point3D& position() const {
    return position_;
  }

  inline legion::interface::Point3D* mutable_position() { return &position_; }

  inline bool has_position() { return (position_ptr_ != nullptr); }

  inline void set_front_position(
      const legion::interface::Point3D& front_position) {
    front_position_ = front_position;
    front_position_ptr_ = &front_position_;
  }

  inline const legion::interface::Point3D& front_position() const {
    return front_position_;
  }

  inline legion::interface::Point3D* mutable_front_position() {
    return &front_position_;
  }

  inline bool has_front_position() { return (front_position_ptr_ != nullptr); }

  inline void set_velocity(const legion::interface::Point3D& velocity) {
    velocity_ = velocity;
    velocity_ptr_ = &velocity_;
  }

  inline const legion::interface::Point3D& velocity() const {
    return velocity_;
  }

  inline legion::interface::Point3D* mutable_velocity() { return &velocity_; }

  inline bool has_velocity() { return (velocity_ptr_ != nullptr); }

  inline void set_raw_velocity(const legion::interface::Point3D& raw_velocity) {
    raw_velocity_ = raw_velocity;
    raw_velocity_ptr_ = &raw_velocity_;
  }

  inline const legion::interface::Point3D& raw_velocity() const {
    return raw_velocity_;
  }

  inline legion::interface::Point3D* mutable_raw_velocity() {
    return &raw_velocity_;
  }

  inline bool has_raw_velocity() { return (raw_velocity_ptr_ != nullptr); }

  inline void set_acceleration(const legion::interface::Point3D& acceleration) {
    acceleration_ = acceleration;
    acceleration_ptr_ = &acceleration_;
  }

  inline const legion::interface::Point3D& acceleration() const {
    return acceleration_;
  }

  inline legion::interface::Point3D* mutable_acceleration() {
    return &acceleration_;
  }
  ...
  inline void set_t_position(const legion::interface::Point3D& t_position) {
    t_position_ = t_position;
    t_position_ptr_ = &t_position_;
  }

  inline const legion::interface::Point3D& t_position() const {
    return t_position_;
  }

  inline legion::interface::Point3D* mutable_t_position() {
    return &t_position_;
  }

  inline bool has_t_position() { return (t_position_ptr_ != nullptr); }

  inline void set_t_velocity(const legion::interface::Point3D& t_velocity) {
    t_velocity_ = t_velocity;
    t_velocity_ptr_ = &t_velocity_;
  }

  inline const legion::interface::Point3D& t_velocity() const {
    return t_velocity_;
  }

  inline legion::interface::Point3D* mutable_t_velocity() {
    return &t_velocity_;
  }
  ...
  inline void set_t_acceleration(
      const legion::interface::Point3D& t_acceleration) {
    t_acceleration_ = t_acceleration;
    t_acceleration_ptr_ = &t_acceleration_;
  }

  inline const legion::interface::Point3D& t_acceleration() const {
    return t_acceleration_;
  }

  inline legion::interface::Point3D* mutable_t_acceleration() {
    return &t_acceleration_;
  }
  ...
  inline void set_label_update_time_delta(
      const double& label_update_time_delta) {
  ...
  inline void set_priority(
      const legion::interface::ObstaclePriority& priority) {
    priority_ = priority;
    priority_ptr_ = &priority_;
  }

  inline const legion::interface::ObstaclePriority& priority() const {
    return priority_;
  }

  inline legion::interface::ObstaclePriority* mutable_priority() {
    return &priority_;
  }
  ...
  inline void set_future_trajectory_points(
      std::vector<legion::interface::PredictionTrajectoryPoint>*
  ...
  inline void set_future_trajectory_points(
      const std::vector<legion::interface::PredictionTrajectoryPoint>&
          future_trajectory_points) {
    std::lock_guard<std::mutex> lock(*future_trajectory_points_mutex_);
  ...
  inline const std::vector<legion::interface::PredictionTrajectoryPoint>&
  future_trajectory_points() const {
    std::lock_guard<std::mutex> lock(*future_trajectory_points_mutex_);
    return future_trajectory_points_;
  }
  ...
  inline void set_short_term_predicted_trajectory_points(
      std::vector<legion::interface::TrajectoryPointInPrediction>*
  ...
  inline void set_short_term_predicted_trajectory_points(
      const std::vector<legion::interface::TrajectoryPointInPrediction>&
          short_term_predicted_trajectory_points) {
    std::lock_guard<std::mutex> lock(
        *short_term_predicted_trajectory_points_mutex_);
  ...
  inline void set_short_term_predicted_trajectory_points(
      const uint32_t index, legion::interface::TrajectoryPointInPrediction&
                                short_term_predicted_trajectory_points) {
    std::lock_guard<std::mutex> lock(
        *short_term_predicted_trajectory_points_mutex_);
  ...
  inline void add_short_term_predicted_trajectory_points(
      const legion::interface::TrajectoryPointInPrediction&
          short_term_predicted_trajectory_points) {
    std::lock_guard<std::mutex> lock(
        *short_term_predicted_trajectory_points_mutex_);
  ...
  inline const legion::interface::TrajectoryPointInPrediction&
  ...
  inline std::vector<legion::interface::TrajectoryPointInPrediction>*
  ...
  inline const std::vector<legion::interface::TrajectoryPointInPrediction>&
  short_term_predicted_trajectory_points() const {
    std::lock_guard<std::mutex> lock(
        *short_term_predicted_trajectory_points_mutex_);
    return short_term_predicted_trajectory_points_;
  ...
  inline void set_predicted_trajectory(
      std::vector<legion::interface::TrajectoryInPrediction>*
  ...
  inline void set_predicted_trajectory(
      const std::vector<legion::interface::TrajectoryInPrediction>&
          predicted_trajectory) {
    std::lock_guard<std::mutex> lock(*predicted_trajectory_mutex_);
  ...
  inline void set_predicted_trajectory(
      const uint32_t index,
      legion::interface::TrajectoryInPrediction& predicted_trajectory) {
    std::lock_guard<std::mutex> lock(*predicted_trajectory_mutex_);
    predicted_trajectory_[index] = predicted_trajectory;
  }

  inline void add_predicted_trajectory(
      const legion::interface::TrajectoryInPrediction& predicted_trajectory) {
    std::lock_guard<std::mutex> lock(*predicted_trajectory_mutex_);
    predicted_trajectory_.emplace_back(predicted_trajectory);
  }

  inline const legion::interface::TrajectoryInPrediction& predicted_trajectory(
      uint32_t index) const {
    std::lock_guard<std::mutex> lock(*predicted_trajectory_mutex_);
    return predicted_trajectory_[index];
  }

  inline std::vector<legion::interface::TrajectoryInPrediction>*
  mutable_predicted_trajectory() {
    std::lock_guard<std::mutex> lock(*predicted_trajectory_mutex_);
    return &predicted_trajectory_;
  }

  inline void predicted_trajectory(
      std::vector<legion::interface::TrajectoryInPrediction>&
  ...
  inline const std::vector<legion::interface::TrajectoryInPrediction>&
  predicted_trajectory() const {
    std::lock_guard<std::mutex> lock(*predicted_trajectory_mutex_);
    return predicted_trajectory_;
  }
  ...
  inline void set_adc_trajectory_point(
      const uint32_t index,
      legion::interface::TrajectoryPointInPrediction& adc_trajectory_point) {
    std::lock_guard<std::mutex> lock(*adc_trajectory_point_mutex_);
    adc_trajectory_point_[index] = adc_trajectory_point;
  }

  inline void add_adc_trajectory_point(
      const legion::interface::TrajectoryPointInPrediction&
          adc_trajectory_point) {
    std::lock_guard<std::mutex> lock(*adc_trajectory_point_mutex_);
 ...
 protected:
  ...
  //障碍物边框点列
  legion::interface::Point3D polygon_point_;
  legion::interface::Point3D* polygon_point_ptr_ = nullptr;
  legion::interface::Point3D position_;
  legion::interface::Point3D* position_ptr_ = nullptr;
  legion::interface::Point3D front_position_;
  legion::interface::Point3D* front_position_ptr_ = nullptr;
  legion::interface::Point3D velocity_;
  legion::interface::Point3D* velocity_ptr_ = nullptr;
  // from perception
  legion::interface::Point3D raw_velocity_;
  legion::interface::Point3D* raw_velocity_ptr_ = nullptr;
  legion::interface::Point3D acceleration_;
  legion::interface::Point3D* acceleration_ptr_ = nullptr;
  ...
  legion::interface::Point3D t_position_;
  legion::interface::Point3D* t_position_ptr_ = nullptr;
  //[deprecated = true]
  legion::interface::Point3D t_velocity_;
  legion::interface::Point3D* t_velocity_ptr_ = nullptr;
  //[deprecated = true]
  ...
  //[deprecated = true]
  legion::interface::Point3D t_acceleration_;
  legion::interface::Point3D* t_acceleration_ptr_ = nullptr;
  //[deprecated = true]
  double t_acc_;
  ...
  legion::interface::ObstaclePriority priority_;
  legion::interface::ObstaclePriority* priority_ptr_ = nullptr;
  ...
  std::vector<legion::interface::TrajectoryInPrediction> predicted_trajectory_;
