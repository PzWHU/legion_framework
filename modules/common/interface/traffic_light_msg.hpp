...
class TrafficLightMsg {
 public:
  TrafficLightMsg() {
    ...
    camera_id_ =
        legion::interface::TrafficLightMsg::CameraID::CAMERA_FRONT_LONG;
    is_valid_ = false;
  }
  ...
  inline void set_traffic_light_debug(
      const legion::interface::TrafficLightDebug& traffic_light_debug) {
    traffic_light_debug_ = traffic_light_debug;
    traffic_light_debug_ptr_ = &traffic_light_debug_;
  }

  inline const legion::interface::TrafficLightDebug& traffic_light_debug()
      const {
    return traffic_light_debug_;
  }

  inline legion::interface::TrafficLightDebug* mutable_traffic_light_debug() {
    return &traffic_light_debug_;
  }
  ...
  inline void set_camera_id(
      const legion::interface::TrafficLightMsg::CameraID& camera_id) {
    camera_id_ = camera_id;
    camera_id_ptr_ = &camera_id_;
  }

  inline const legion::interface::TrafficLightMsg::CameraID& camera_id() const {
    return camera_id_;
  }

  inline legion::interface::TrafficLightMsg::CameraID* mutable_camera_id() {
    return &camera_id_;
  }
 ...
 protected:
  ...
  //交通灯数组调试
  legion::interface::TrafficLightDebug traffic_light_debug_;
  legion::interface::TrafficLightDebug* traffic_light_debug_ptr_ = nullptr;
  //是否包含交通灯
  bool contain_lights_;
  bool* contain_lights_ptr_ = nullptr;
  // CAMERA_FRONT_LONG = 0; CAMERA_FRONT_NARROW = 1; CAMERA_FRONT_SHORT = 2;
  // CAMERA_FRONT_WIDE = 3;
  legion::interface::TrafficLightMsg::CameraID camera_id_;
  legion::interface::TrafficLightMsg::CameraID* camera_id_ptr_ = nullptr;
