...
class PlanningParkingDebug {
 public:
  ...
  inline void set_vehicle_preiew_polygon(
      std::vector<legion::interface::Polygon2D>* vehicle_preiew_polygon) {
  ...
  inline void set_vehicle_preiew_polygon(
      const std::vector<legion::interface::Polygon2D>& vehicle_preiew_polygon) {
    std::lock_guard<std::mutex> lock(*vehicle_preiew_polygon_mutex_);
  ...
  inline void set_vehicle_preiew_polygon(
      ...
      legion::interface::Polygon2D& vehicle_preiew_polygon) {
    std::lock_guard<std::mutex> lock(*vehicle_preiew_polygon_mutex_);
    vehicle_preiew_polygon_[index] = vehicle_preiew_polygon;
  }

  inline void add_vehicle_preiew_polygon(
      const legion::interface::Polygon2D& vehicle_preiew_polygon) {
    std::lock_guard<std::mutex> lock(*vehicle_preiew_polygon_mutex_);
    vehicle_preiew_polygon_.emplace_back(vehicle_preiew_polygon);
  }

  inline const legion::interface::Polygon2D& vehicle_preiew_polygon(
      uint32_t index) const {
    std::lock_guard<std::mutex> lock(*vehicle_preiew_polygon_mutex_);
    return vehicle_preiew_polygon_[index];
  }

  inline std::vector<legion::interface::Polygon2D>*
  ...
  inline void vehicle_preiew_polygon(
      std::vector<legion::interface::Polygon2D>& vehicle_preiew_polygon) const {
    std::lock_guard<std::mutex> lock(*vehicle_preiew_polygon_mutex_);
    vehicle_preiew_polygon.assign(vehicle_preiew_polygon_.begin(),
                                  vehicle_preiew_polygon_.end());
  }

  inline const std::vector<legion::interface::Polygon2D>&
  ...
  inline void set_obstacles_polygon(
      std::vector<legion::interface::Polygon2D>* obstacles_polygon) {
  ...
  inline void set_obstacles_polygon(
      const std::vector<legion::interface::Polygon2D>& obstacles_polygon) {
    std::lock_guard<std::mutex> lock(*obstacles_polygon_mutex_);
    obstacles_polygon_ = obstacles_polygon;
  }

  inline void set_obstacles_polygon(
      const uint32_t index, legion::interface::Polygon2D& obstacles_polygon) {
    std::lock_guard<std::mutex> lock(*obstacles_polygon_mutex_);
    obstacles_polygon_[index] = obstacles_polygon;
  }

  inline void add_obstacles_polygon(
      const legion::interface::Polygon2D& obstacles_polygon) {
    std::lock_guard<std::mutex> lock(*obstacles_polygon_mutex_);
    obstacles_polygon_.emplace_back(obstacles_polygon);
  }

  inline const legion::interface::Polygon2D& obstacles_polygon(
      uint32_t index) const {
    std::lock_guard<std::mutex> lock(*obstacles_polygon_mutex_);
  ...
  inline void obstacles_polygon(
      std::vector<legion::interface::Polygon2D>& obstacles_polygon) const {
    std::lock_guard<std::mutex> lock(*obstacles_polygon_mutex_);
    obstacles_polygon.assign(obstacles_polygon_.begin(),
                             obstacles_polygon_.end());
  }

  inline const std::vector<legion::interface::Polygon2D>& obstacles_polygon()
      const {
    std::lock_guard<std::mutex> lock(*obstacles_polygon_mutex_);
    return obstacles_polygon_;
  }
  ...
  inline void set_warm_start_traj(
      std::vector<legion::interface::TrajectoryPoint>* warm_start_traj) {
    std::lock_guard<std::mutex> lock(*warm_start_traj_mutex_);
    warm_start_traj_.assign(warm_start_traj->begin(), warm_start_traj->end());
  }

  inline void set_warm_start_traj(
      const std::vector<legion::interface::TrajectoryPoint>& warm_start_traj) {
    std::lock_guard<std::mutex> lock(*warm_start_traj_mutex_);
  ...
  inline void set_warm_start_traj(
      const uint32_t index,
      legion::interface::TrajectoryPoint& warm_start_traj) {
    std::lock_guard<std::mutex> lock(*warm_start_traj_mutex_);
    warm_start_traj_[index] = warm_start_traj;
  }

  inline void add_warm_start_traj(
      const legion::interface::TrajectoryPoint& warm_start_traj) {
    std::lock_guard<std::mutex> lock(*warm_start_traj_mutex_);
    warm_start_traj_.emplace_back(warm_start_traj);
  }

  inline const legion::interface::TrajectoryPoint& warm_start_traj(
      uint32_t index) const {
    std::lock_guard<std::mutex> lock(*warm_start_traj_mutex_);
  ...
  inline void warm_start_traj(
      std::vector<legion::interface::TrajectoryPoint>& warm_start_traj) const {
    std::lock_guard<std::mutex> lock(*warm_start_traj_mutex_);
  ...
  inline void set_smoothed_traj_stage1(
      std::vector<legion::interface::TrajectoryPoint>* smoothed_traj_stage1) {
  ...
  inline void set_smoothed_traj_stage1(
      const uint32_t index,
      legion::interface::TrajectoryPoint& smoothed_traj_stage1) {
    std::lock_guard<std::mutex> lock(*smoothed_traj_stage1_mutex_);
    smoothed_traj_stage1_[index] = smoothed_traj_stage1;
  }

  inline void add_smoothed_traj_stage1(
      const legion::interface::TrajectoryPoint& smoothed_traj_stage1) {
    std::lock_guard<std::mutex> lock(*smoothed_traj_stage1_mutex_);
    smoothed_traj_stage1_.emplace_back(smoothed_traj_stage1);
  }

  inline const legion::interface::TrajectoryPoint& smoothed_traj_stage1(
      uint32_t index) const {
    std::lock_guard<std::mutex> lock(*smoothed_traj_stage1_mutex_);
  ...
  inline void set_smoothed_traj_stage2(
      std::vector<legion::interface::TrajectoryPoint>* smoothed_traj_stage2) {
  ...
  inline void set_smoothed_traj_stage2(
      const uint32_t index,
      legion::interface::TrajectoryPoint& smoothed_traj_stage2) {
    std::lock_guard<std::mutex> lock(*smoothed_traj_stage2_mutex_);
    smoothed_traj_stage2_[index] = smoothed_traj_stage2;
  }

  inline void add_smoothed_traj_stage2(
      const legion::interface::TrajectoryPoint& smoothed_traj_stage2) {
    std::lock_guard<std::mutex> lock(*smoothed_traj_stage2_mutex_);
    smoothed_traj_stage2_.emplace_back(smoothed_traj_stage2);
  }

  inline const legion::interface::TrajectoryPoint& smoothed_traj_stage2(
      uint32_t index) const {
    std::lock_guard<std::mutex> lock(*smoothed_traj_stage2_mutex_);
  ...
  inline void set_reference_line(
      const legion::interface::Trajectory& reference_line) {
    reference_line_ = reference_line;
    reference_line_ptr_ = &reference_line_;
  }

  inline const legion::interface::Trajectory& reference_line() const {
    return reference_line_;
  }

  inline legion::interface::Trajectory* mutable_reference_line() {
    return &reference_line_;
  }
  ...
  inline void set_trajectory_array(
      std::vector<legion::interface::Trajectory>* trajectory_array) {
  ...
  inline void set_trajectory_array(
      const std::vector<legion::interface::Trajectory>& trajectory_array) {
    std::lock_guard<std::mutex> lock(*trajectory_array_mutex_);
    trajectory_array_ = trajectory_array;
  }

  inline void set_trajectory_array(
      const uint32_t index, legion::interface::Trajectory& trajectory_array) {
    std::lock_guard<std::mutex> lock(*trajectory_array_mutex_);
    trajectory_array_[index] = trajectory_array;
  }

  inline void add_trajectory_array(
      const legion::interface::Trajectory& trajectory_array) {
    std::lock_guard<std::mutex> lock(*trajectory_array_mutex_);
    trajectory_array_.emplace_back(trajectory_array);
  }

  inline const legion::interface::Trajectory& trajectory_array(
      uint32_t index) const {
    std::lock_guard<std::mutex> lock(*trajectory_array_mutex_);
    return trajectory_array_[index];
  }

  inline std::vector<legion::interface::Trajectory>*
  ...
  inline void trajectory_array(
      std::vector<legion::interface::Trajectory>& trajectory_array) const {
    std::lock_guard<std::mutex> lock(*trajectory_array_mutex_);
    trajectory_array.assign(trajectory_array_.begin(), trajectory_array_.end());
  }

  inline const std::vector<legion::interface::Trajectory>& trajectory_array()
      const {
    std::lock_guard<std::mutex> lock(*trajectory_array_mutex_);
    return trajectory_array_;
  }
  ...
  inline void set_optimal_coarse_trajectory(
      const legion::interface::Trajectory& optimal_coarse_trajectory) {
    optimal_coarse_trajectory_ = optimal_coarse_trajectory;
    optimal_coarse_trajectory_ptr_ = &optimal_coarse_trajectory_;
  }

  inline const legion::interface::Trajectory& optimal_coarse_trajectory()
      const {
    return optimal_coarse_trajectory_;
  }

  inline legion::interface::Trajectory* mutable_optimal_coarse_trajectory() {
    return &optimal_coarse_trajectory_;
  }
  ...
  inline void set_optimal_smooth_trajectory(
      const legion::interface::Trajectory& optimal_smooth_trajectory) {
    optimal_smooth_trajectory_ = optimal_smooth_trajectory;
    optimal_smooth_trajectory_ptr_ = &optimal_smooth_trajectory_;
  }

  inline const legion::interface::Trajectory& optimal_smooth_trajectory()
      const {
    return optimal_smooth_trajectory_;
  }

  inline legion::interface::Trajectory* mutable_optimal_smooth_trajectory() {
    return &optimal_smooth_trajectory_;
  }
  ...
  inline void set_hybrid_a_star_heuristic_time(
      const double& hybrid_a_star_heuristic_time) {
  ...
  inline void set_hybrid_a_star_total_time(
      const double& hybrid_a_star_total_time) {
  ...
  inline void set_ias_collision_avoidance_time(
      const double& ias_collision_avoidance_time) {
  ...
  inline void set_samping_trajectory_time(
      const double& samping_trajectory_time) {
  ...
  inline void set_optimizer_thread_counter(
      const int32_t& optimizer_thread_counter) {
 ...
 protected:
  ...
  //车辆预测多边形
  std::vector<legion::interface::Polygon2D> vehicle_preiew_polygon_;
  //障碍物多边形
  std::vector<legion::interface::Polygon2D> obstacles_polygon_;
  //轨迹点
  ...
  std::vector<legion::interface::TrajectoryPoint> warm_start_traj_;
  std::vector<legion::interface::TrajectoryPoint> smoothed_traj_stage1_;
  std::vector<legion::interface::TrajectoryPoint> smoothed_traj_stage2_;
  legion::interface::Trajectory reference_line_;
  legion::interface::Trajectory* reference_line_ptr_ = nullptr;
  //轨迹簇
  std::vector<legion::interface::Trajectory> trajectory_array_;
  legion::interface::Trajectory optimal_coarse_trajectory_;
  legion::interface::Trajectory* optimal_coarse_trajectory_ptr_ = nullptr;
  legion::interface::Trajectory optimal_smooth_trajectory_;
  legion::interface::Trajectory* optimal_smooth_trajectory_ptr_ = nullptr;
