...
class HMIVehicleMsg {
 public:
  ...
  inline void set_mercator_position(
      const legion::interface::PointENU& mercator_position) {
    mercator_position_ = mercator_position;
    mercator_position_ptr_ = &mercator_position_;
  }

  inline const legion::interface::PointENU& mercator_position() const {
    return mercator_position_;
  }

  inline legion::interface::PointENU* mutable_mercator_position() {
    return &mercator_position_;
  }
 ...
 protected:
  ...
  //转坐标系后的参考点
  legion::interface::PointENU mercator_position_;
  legion::interface::PointENU* mercator_position_ptr_ = nullptr;
};
}  // namespace interface
}  // namespace legion
