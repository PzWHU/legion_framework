...
class UssParkingInfo {
 public:
  UssParkingInfo() {
    uss_parking_type_ = legion::common::UssParkingType::RIGHT_PARALLEL_PARKING;
  }
  ...
  inline void set_uss_parking_type(
      const legion::common::UssParkingType& uss_parking_type) {
    uss_parking_type_ = uss_parking_type;
    uss_parking_type_ptr_ = &uss_parking_type_;
  }

  inline const legion::common::UssParkingType& uss_parking_type() const {
    return uss_parking_type_;
  }

  inline legion::common::UssParkingType* mutable_uss_parking_type() {
    return &uss_parking_type_;
  }
  ...
  inline void set_parking_point0(
      const legion::interface::Point3D& parking_point0) {
    parking_point0_ = parking_point0;
    parking_point0_ptr_ = &parking_point0_;
  }

  inline const legion::interface::Point3D& parking_point0() const {
    return parking_point0_;
  }

  inline legion::interface::Point3D* mutable_parking_point0() {
    return &parking_point0_;
  }

  inline bool has_parking_point0() { return (parking_point0_ptr_ != nullptr); }

  inline void set_parking_point1(
      const legion::interface::Point3D& parking_point1) {
    parking_point1_ = parking_point1;
    parking_point1_ptr_ = &parking_point1_;
  }

  inline const legion::interface::Point3D& parking_point1() const {
    return parking_point1_;
  }

  inline legion::interface::Point3D* mutable_parking_point1() {
    return &parking_point1_;
  }

  inline bool has_parking_point1() { return (parking_point1_ptr_ != nullptr); }

  inline void set_parking_point2(
      const legion::interface::Point3D& parking_point2) {
    parking_point2_ = parking_point2;
    parking_point2_ptr_ = &parking_point2_;
  }

  inline const legion::interface::Point3D& parking_point2() const {
    return parking_point2_;
  }

  inline legion::interface::Point3D* mutable_parking_point2() {
    return &parking_point2_;
  }

  inline bool has_parking_point2() { return (parking_point2_ptr_ != nullptr); }

  inline void set_parking_point3(
      const legion::interface::Point3D& parking_point3) {
    parking_point3_ = parking_point3;
    parking_point3_ptr_ = &parking_point3_;
  }

  inline const legion::interface::Point3D& parking_point3() const {
    return parking_point3_;
  }

  inline legion::interface::Point3D* mutable_parking_point3() {
    return &parking_point3_;
  }
 ...
 protected:
  ...
  legion::common::UssParkingType uss_parking_type_;
  legion::common::UssParkingType* uss_parking_type_ptr_ = nullptr;
  //车体中心坐标系下，超声波车位0点位置
  legion::interface::Point3D parking_point0_;
  legion::interface::Point3D* parking_point0_ptr_ = nullptr;
  //车体中心坐标系下，超声波车位1点位置
  legion::interface::Point3D parking_point1_;
  legion::interface::Point3D* parking_point1_ptr_ = nullptr;
  //车体中心坐标系下，超声波车位2点位置
  legion::interface::Point3D parking_point2_;
  legion::interface::Point3D* parking_point2_ptr_ = nullptr;
  //车体中心坐标系下，超声波车位3点位置
  legion::interface::Point3D parking_point3_;
  legion::interface::Point3D* parking_point3_ptr_ = nullptr;
};
}  // namespace interface
}  // namespace legion
