...
class RadarState {
 public:
  ...
  inline void set_radar_state_error(
      const legion::interface::RadarStateError& radar_state_error) {
    radar_state_error_ = radar_state_error;
    radar_state_error_ptr_ = &radar_state_error_;
  }

  inline const legion::interface::RadarStateError& radar_state_error() const {
    return radar_state_error_;
  }

  inline legion::interface::RadarStateError* mutable_radar_state_error() {
    return &radar_state_error_;
  }
  ...
  inline void set_radar_state_mode(
      const legion::interface::RadarStateMode& radar_state_mode) {
    radar_state_mode_ = radar_state_mode;
    radar_state_mode_ptr_ = &radar_state_mode_;
  }

  inline const legion::interface::RadarStateMode& radar_state_mode() const {
    return radar_state_mode_;
  }

  inline legion::interface::RadarStateMode* mutable_radar_state_mode() {
    return &radar_state_mode_;
  }
 ...
 protected:
  ...
  legion::interface::RadarStateError radar_state_error_;
  legion::interface::RadarStateError* radar_state_error_ptr_ = nullptr;
  legion::interface::RadarStateMode radar_state_mode_;
  legion::interface::RadarStateMode* radar_state_mode_ptr_ = nullptr;
