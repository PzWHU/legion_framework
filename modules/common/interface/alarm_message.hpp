...
class AlarmMessage {
 public:
  AlarmMessage() {
    alarm_proc_.clear();
    alarm_level_ = legion::common::AlarmLevel::ALARM_INFO;
    alarm_type_ = legion::common::AlarmType::ALARM_TYPE_REPORT;
    alarm_id_ = 0;
    alarm_display_ = legion::common::AlarmDisplay::ALARM_DISPLAY_TEXT;
    alarm_data_.clear();
  }
  ...
  inline void set_alarm_level(const legion::common::AlarmLevel& alarm_level) {
    alarm_level_ = alarm_level;
    alarm_level_ptr_ = &alarm_level_;
  }

  inline const legion::common::AlarmLevel& alarm_level() const {
    return alarm_level_;
  }

  inline legion::common::AlarmLevel* mutable_alarm_level() {
    return &alarm_level_;
  }

  inline bool has_alarm_level() { return (alarm_level_ptr_ != nullptr); }

  inline void set_alarm_type(const legion::common::AlarmType& alarm_type) {
    alarm_type_ = alarm_type;
    alarm_type_ptr_ = &alarm_type_;
  }

  inline const legion::common::AlarmType& alarm_type() const {
    return alarm_type_;
  }

  inline legion::common::AlarmType* mutable_alarm_type() {
    return &alarm_type_;
  }
  ...
  inline void set_alarm_display(
      const legion::common::AlarmDisplay& alarm_display) {
    alarm_display_ = alarm_display;
    alarm_display_ptr_ = &alarm_display_;
  }

  inline const legion::common::AlarmDisplay& alarm_display() const {
    return alarm_display_;
  }

  inline legion::common::AlarmDisplay* mutable_alarm_display() {
    return &alarm_display_;
  }
 ...
 protected:
  ...
  //告警等级
  legion::common::AlarmLevel alarm_level_;
  legion::common::AlarmLevel* alarm_level_ptr_ = nullptr;
  //告警类型
  legion::common::AlarmType alarm_type_;
  legion::common::AlarmType* alarm_type_ptr_ = nullptr;
  //告警序列号，用于恢复告警
  int32_t alarm_id_;
  int32_t* alarm_id_ptr_ = nullptr;
  //告警展示类型
  legion::common::AlarmDisplay alarm_display_;
  legion::common::AlarmDisplay* alarm_display_ptr_ = nullptr;
  //告警正文
