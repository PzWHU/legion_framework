...
class Location {
 public:
  Location() {
    ...
    roll_ = 0.0;
    heading_ = 0.0;
    rtk_flag_ = legion::interface::Location::RTKFlag::RTK_NULL;
    odom_type_ = legion::interface::Location::OdomType::GNSS;
    auxiliary_type_ =
        legion::interface::Location::AuxiliaryType::AUXILIARY_TYPE_NULL;
    location_valid_flag_ = legion::common::IsValid::INVALID;
    origin_lat_ = 0.0;
    origin_lon_ = 0.0;
    change_origin_flag_ =
        legion::interface::Location::ChangeOriginFlag::CHANGE_NULL;
  }
  ~Location() = default;
  ...
  inline void set_position(const legion::interface::PointLLH& position) {
    position_ = position;
    position_ptr_ = &position_;
  }

  inline const legion::interface::PointLLH& position() const {
    return position_;
  }

  inline legion::interface::PointLLH* mutable_position() { return &position_; }
  ...
  inline void set_linear_velocity(
      const legion::interface::Point3D& linear_velocity) {
    linear_velocity_ = linear_velocity;
    linear_velocity_ptr_ = &linear_velocity_;
  }

  inline const legion::interface::Point3D& linear_velocity() const {
    return linear_velocity_;
  }

  inline legion::interface::Point3D* mutable_linear_velocity() {
    return &linear_velocity_;
  }
  ...
  inline void set_linear_acceleration(
      const legion::interface::Point3D& linear_acceleration) {
    linear_acceleration_ = linear_acceleration;
    linear_acceleration_ptr_ = &linear_acceleration_;
  }

  inline const legion::interface::Point3D& linear_acceleration() const {
    return linear_acceleration_;
  }

  inline legion::interface::Point3D* mutable_linear_acceleration() {
    return &linear_acceleration_;
  }
  ...
  inline void set_angular_velocity(
      const legion::interface::Point3D& angular_velocity) {
    angular_velocity_ = angular_velocity;
    angular_velocity_ptr_ = &angular_velocity_;
  }

  inline const legion::interface::Point3D& angular_velocity() const {
    return angular_velocity_;
  }

  inline legion::interface::Point3D* mutable_angular_velocity() {
    return &angular_velocity_;
  }
  ...
  inline void set_rtk_flag(
      const legion::interface::Location::RTKFlag& rtk_flag) {
    rtk_flag_ = rtk_flag;
    rtk_flag_ptr_ = &rtk_flag_;
  }

  inline const legion::interface::Location::RTKFlag& rtk_flag() const {
    return rtk_flag_;
  }

  inline legion::interface::Location::RTKFlag* mutable_rtk_flag() {
    return &rtk_flag_;
  }

  inline bool has_rtk_flag() { return (rtk_flag_ptr_ != nullptr); }

  inline void set_odom_type(
      const legion::interface::Location::OdomType& odom_type) {
    odom_type_ = odom_type;
    odom_type_ptr_ = &odom_type_;
  }

  inline const legion::interface::Location::OdomType& odom_type() const {
    return odom_type_;
  }

  inline legion::interface::Location::OdomType* mutable_odom_type() {
    return &odom_type_;
  }
  ...
  inline void set_auxiliary_type(
      const legion::interface::Location::AuxiliaryType& auxiliary_type) {
    auxiliary_type_ = auxiliary_type;
    auxiliary_type_ptr_ = &auxiliary_type_;
  }

  inline const legion::interface::Location::AuxiliaryType& auxiliary_type()
      const {
    return auxiliary_type_;
  }

  inline legion::interface::Location::AuxiliaryType* mutable_auxiliary_type() {
    return &auxiliary_type_;
  }

  inline bool has_auxiliary_type() { return (auxiliary_type_ptr_ != nullptr); }

  inline void set_location_valid_flag(
      const legion::common::IsValid& location_valid_flag) {
    location_valid_flag_ = location_valid_flag;
    location_valid_flag_ptr_ = &location_valid_flag_;
  }

  inline const legion::common::IsValid& location_valid_flag() const {
    return location_valid_flag_;
  }

  inline legion::common::IsValid* mutable_location_valid_flag() {
    return &location_valid_flag_;
  }
  ...
  inline void set_utm_position(
      const legion::interface::PointENU& utm_position) {
    utm_position_ = utm_position;
    utm_position_ptr_ = &utm_position_;
  }

  inline const legion::interface::PointENU& utm_position() const {
    return utm_position_;
  }

  inline legion::interface::PointENU* mutable_utm_position() {
    return &utm_position_;
  }
  ...
  inline void set_change_origin_flag(
      const legion::interface::Location::ChangeOriginFlag& change_origin_flag) {
    change_origin_flag_ = change_origin_flag;
    change_origin_flag_ptr_ = &change_origin_flag_;
  }

  inline const legion::interface::Location::ChangeOriginFlag&
  change_origin_flag() const {
    return change_origin_flag_;
  }

  inline legion::interface::Location::ChangeOriginFlag*
  ...
  inline void set_utm_position_next(
      const legion::interface::PointENU& utm_position_next) {
    utm_position_next_ = utm_position_next;
    utm_position_next_ptr_ = &utm_position_next_;
  }

  inline const legion::interface::PointENU& utm_position_next() const {
    return utm_position_next_;
  }

  inline legion::interface::PointENU* mutable_utm_position_next() {
    return &utm_position_next_;
  }
  ...
  inline void set_position_std_dev(
      const legion::interface::Point3D& position_std_dev) {
    position_std_dev_ = position_std_dev;
    position_std_dev_ptr_ = &position_std_dev_;
  }

  inline const legion::interface::Point3D& position_std_dev() const {
    return position_std_dev_;
  }

  inline legion::interface::Point3D* mutable_position_std_dev() {
    return &position_std_dev_;
  }
  ...
  inline void set_orientation_std_dev(
      const legion::interface::Point3D& orientation_std_dev) {
    orientation_std_dev_ = orientation_std_dev;
    orientation_std_dev_ptr_ = &orientation_std_dev_;
  }

  inline const legion::interface::Point3D& orientation_std_dev() const {
    return orientation_std_dev_;
  }

  inline legion::interface::Point3D* mutable_orientation_std_dev() {
    return &orientation_std_dev_;
  }
  ...
  inline void set_linear_velocity_std_dev(
      const legion::interface::Point3D& linear_velocity_std_dev) {
    linear_velocity_std_dev_ = linear_velocity_std_dev;
    linear_velocity_std_dev_ptr_ = &linear_velocity_std_dev_;
  }

  inline const legion::interface::Point3D& linear_velocity_std_dev() const {
    return linear_velocity_std_dev_;
  }

  inline legion::interface::Point3D* mutable_linear_velocity_std_dev() {
    return &linear_velocity_std_dev_;
  }
  ...
  inline void set_linear_acceleration_std_dev(
      const legion::interface::Point3D& linear_acceleration_std_dev) {
    linear_acceleration_std_dev_ = linear_acceleration_std_dev;
    linear_acceleration_std_dev_ptr_ = &linear_acceleration_std_dev_;
  }

  inline const legion::interface::Point3D& linear_acceleration_std_dev() const {
    return linear_acceleration_std_dev_;
  }

  inline legion::interface::Point3D* mutable_linear_acceleration_std_dev() {
    return &linear_acceleration_std_dev_;
  }
  ...
  inline void set_angular_velocity_std_dev(
      const legion::interface::Point3D& angular_velocity_std_dev) {
    angular_velocity_std_dev_ = angular_velocity_std_dev;
    angular_velocity_std_dev_ptr_ = &angular_velocity_std_dev_;
  }

  inline const legion::interface::Point3D& angular_velocity_std_dev() const {
    return angular_velocity_std_dev_;
  }

  inline legion::interface::Point3D* mutable_angular_velocity_std_dev() {
    return &angular_velocity_std_dev_;
  }
 ...
 protected:
  ...
  //经纬度高程
  legion::interface::PointLLH position_;
  legion::interface::PointLLH* position_ptr_ = nullptr;
  ...
  //线速度（m/s，北东地坐标系）
  legion::interface::Point3D linear_velocity_;
  legion::interface::Point3D* linear_velocity_ptr_ = nullptr;
  //线加速度（m/s2，前右下坐标系）
  legion::interface::Point3D linear_acceleration_;
  legion::interface::Point3D* linear_acceleration_ptr_ = nullptr;
  //角速度（度/s，前右下，满足右手定则）
  legion::interface::Point3D angular_velocity_;
  legion::interface::Point3D* angular_velocity_ptr_ = nullptr;
  // RTK标志值
  legion::interface::Location::RTKFlag rtk_flag_;
  legion::interface::Location::RTKFlag* rtk_flag_ptr_ = nullptr;
  //融合标志:0-(纯ins) 1-(纯轮速) 2-(泊车递推) 3-(无) 4-(orb匹配定位)
  legion::interface::Location::OdomType odom_type_;
  legion::interface::Location::OdomType* odom_type_ptr_ = nullptr;
  //辅助方式:0-NULL(无辅助方式)
  //1-laneliine_map(车道线/标识牌)2-feature_map(lidar)3-feature_map(lidar_camera)
  legion::interface::Location::AuxiliaryType auxiliary_type_;
  legion::interface::Location::AuxiliaryType* auxiliary_type_ptr_ = nullptr;
  // Location有效性标志位0: invalid； 1: valid
  legion::common::IsValid location_valid_flag_;
  legion::common::IsValid* location_valid_flag_ptr_ = nullptr;
  //参考点纬度 GCJ-02格式
  double origin_lat_;
  ...
  //相对参考点xyz坐标
  legion::interface::PointENU utm_position_;
  legion::interface::PointENU* utm_position_ptr_ = nullptr;
  // 0::无坐标系切换 1:坐标系切换成功2:坐标系切换中3:坐标系切换故障
  legion::interface::Location::ChangeOriginFlag change_origin_flag_;
  legion::interface::Location::ChangeOriginFlag* change_origin_flag_ptr_ =
      nullptr;
  //相对参考点坐标(切换状态下，为新的原点坐标系下)
  legion::interface::PointENU utm_position_next_;
  legion::interface::PointENU* utm_position_next_ptr_ = nullptr;
  //位置标准差
  legion::interface::Point3D position_std_dev_;
  legion::interface::Point3D* position_std_dev_ptr_ = nullptr;
  //方向标准差
  legion::interface::Point3D orientation_std_dev_;
  legion::interface::Point3D* orientation_std_dev_ptr_ = nullptr;
  //速度标准差
  legion::interface::Point3D linear_velocity_std_dev_;
  legion::interface::Point3D* linear_velocity_std_dev_ptr_ = nullptr;
  //加速度标准差
  legion::interface::Point3D linear_acceleration_std_dev_;
  legion::interface::Point3D* linear_acceleration_std_dev_ptr_ = nullptr;
  //角速度标准差
  legion::interface::Point3D angular_velocity_std_dev_;
  legion::interface::Point3D* angular_velocity_std_dev_ptr_ = nullptr;
};
}  // namespace interface
}  // namespace legion
