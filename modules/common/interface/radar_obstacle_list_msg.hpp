...
class RadarObstacleListMsg {
 public:
  ...
  inline void set_radar_state(
      const legion::interface::RadarState& radar_state) {
    radar_state_ = radar_state;
    radar_state_ptr_ = &radar_state_;
  }

  inline const legion::interface::RadarState& radar_state() const {
    return radar_state_;
  }

  inline legion::interface::RadarState* mutable_radar_state() {
    return &radar_state_;
  }
 ...
 protected:
  ...
  // radar state.
  legion::interface::RadarState radar_state_;
  legion::interface::RadarState* radar_state_ptr_ = nullptr;
