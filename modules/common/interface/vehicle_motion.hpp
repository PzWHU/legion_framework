...
class VehicleMotion {
 public:
  ...
  inline void set_vehicle_motion_point(
      std::vector<legion::interface::VehicleMotionPoint>*
  ...
  inline void set_vehicle_motion_point(
      const std::vector<legion::interface::VehicleMotionPoint>&
          vehicle_motion_point) {
    std::lock_guard<std::mutex> lock(*vehicle_motion_point_mutex_);
  ...
  inline void set_vehicle_motion_point(
      ...
      legion::interface::VehicleMotionPoint& vehicle_motion_point) {
    std::lock_guard<std::mutex> lock(*vehicle_motion_point_mutex_);
    vehicle_motion_point_[index] = vehicle_motion_point;
  }

  inline void add_vehicle_motion_point(
      const legion::interface::VehicleMotionPoint& vehicle_motion_point) {
    std::lock_guard<std::mutex> lock(*vehicle_motion_point_mutex_);
    vehicle_motion_point_.emplace_back(vehicle_motion_point);
  }

  inline const legion::interface::VehicleMotionPoint& vehicle_motion_point(
      uint32_t index) const {
    std::lock_guard<std::mutex> lock(*vehicle_motion_point_mutex_);
    return vehicle_motion_point_[index];
  }

  inline std::vector<legion::interface::VehicleMotionPoint>*
  ...
  inline void vehicle_motion_point(
      std::vector<legion::interface::VehicleMotionPoint>& vehicle_motion_point)
      const {
    std::lock_guard<std::mutex> lock(*vehicle_motion_point_mutex_);
  ...
  inline const std::vector<legion::interface::VehicleMotionPoint>&
 ...
 protected:
  ...
  std::vector<legion::interface::VehicleMotionPoint> vehicle_motion_point_;
};
}  // namespace interface
}  // namespace legion
