/**
 * @file    hmi_parking_state_display.hpp
 * @author  legion
 * @date    2026-03-23
 * @version 1.0.0
 * @par     Copyright(c)
...
class HMIParkingStateDisplay {
 public:
  HMIParkingStateDisplay() {
    ...
    display_info_ =
        legion::interface::HMIParkingStateDisplay::HMIInfoMessage::HMINORMAL;
    distance_to_leader_obj_ = 0.0;
    state_ = legion::interface::HMIParkingStateDisplay::HMIParkingState::
        HMIPARKING_STATE_NORMAL;
  }
  ~HMIParkingStateDisplay() = default;
  ...
  inline void set_display_info(
      const legion::interface::HMIParkingStateDisplay::HMIInfoMessage&
          display_info) {
    display_info_ = display_info;
    display_info_ptr_ = &display_info_;
  }

  inline const legion::interface::HMIParkingStateDisplay::HMIInfoMessage&
  display_info() const {
    return display_info_;
  }

  inline legion::interface::HMIParkingStateDisplay::HMIInfoMessage*
  ...
  inline void set_state(
      const legion::interface::HMIParkingStateDisplay::HMIParkingState& state) {
    state_ = state;
    state_ptr_ = &state_;
  }

  inline const legion::interface::HMIParkingStateDisplay::HMIParkingState&
  state() const {
    return state_;
  }

  inline legion::interface::HMIParkingStateDisplay::HMIParkingState*
  mutable_state() {
    return &state_;
  }
  ...
  void operator=(const HMIParkingStateDisplay& hmi_parking_state_display) {
    CopyFrom(hmi_parking_state_display);
  }

  void CopyFrom(const HMIParkingStateDisplay& hmi_parking_state_display) {
    header_ = hmi_parking_state_display.header();
    parking_type_ = hmi_parking_state_display.parking_type();
    moves_counter_ = hmi_parking_state_display.moves_counter();
    remian_distance_ = hmi_parking_state_display.remian_distance();
    display_info_ = hmi_parking_state_display.display_info();
    distance_to_leader_obj_ =
        hmi_parking_state_display.distance_to_leader_obj();
    state_ = hmi_parking_state_display.state();
  }
 ...
 protected:
  ...
  //详细信息
  legion::interface::HMIParkingStateDisplay::HMIInfoMessage display_info_;
  legion::interface::HMIParkingStateDisplay::HMIInfoMessage* display_info_ptr_ =
      nullptr;
  //距离最近障碍物距离
  double distance_to_leader_obj_;
  double* distance_to_leader_obj_ptr_ = nullptr;
  legion::interface::HMIParkingStateDisplay::HMIParkingState state_;
  legion::interface::HMIParkingStateDisplay::HMIParkingState* state_ptr_ =
      nullptr;
};
}  // namespace interface
}  // namespace legion
