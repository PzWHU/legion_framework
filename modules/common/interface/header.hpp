...
class Header {
 public:
  ...
  inline void set_stamp(const legion::interface::Time& stamp) {
    stamp_ = stamp;
    stamp_ptr_ = &stamp_;
  }

  inline const legion::interface::Time& stamp() const { return stamp_; }

  inline legion::interface::Time* mutable_stamp() { return &stamp_; }
 ...
 protected:
  ...
  //时间戳
  legion::interface::Time stamp_;
  legion::interface::Time* stamp_ptr_ = nullptr;
  //帧id
