...
class PredictionTrajectoryPoint {
 public:
  ...
  inline void set_predition_path_point(
      const legion::interface::Point3D& predition_path_point) {
    predition_path_point_ = predition_path_point;
    predition_path_point_ptr_ = &predition_path_point_;
  }

  inline const legion::interface::Point3D& predition_path_point() const {
    return predition_path_point_;
  }

  inline legion::interface::Point3D* mutable_predition_path_point() {
    return &predition_path_point_;
  }
 ...
 protected:
  legion::interface::Point3D predition_path_point_;
  legion::interface::Point3D* predition_path_point_ptr_ = nullptr;
  double timestamp_;
