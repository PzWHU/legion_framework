...
class CameraParkingInfo {
 public:
  ...
  inline void set_parking_points_in_image(
      std::vector<legion::interface::ImageKeyPoint>* parking_points_in_image) {
  ...
  inline void set_parking_points_in_image(
      const std::vector<legion::interface::ImageKeyPoint>&
  ...
  inline void set_parking_points_in_image(
      ...
      legion::interface::ImageKeyPoint& parking_points_in_image) {
    std::lock_guard<std::mutex> lock(*parking_points_in_image_mutex_);
    parking_points_in_image_[index] = parking_points_in_image;
  }

  inline void add_parking_points_in_image(
      const legion::interface::ImageKeyPoint& parking_points_in_image) {
    std::lock_guard<std::mutex> lock(*parking_points_in_image_mutex_);
    parking_points_in_image_.emplace_back(parking_points_in_image);
  }

  inline const legion::interface::ImageKeyPoint& parking_points_in_image(
  ...
  inline const std::vector<legion::interface::ImageKeyPoint>&
 ...
 protected:
  ...
  //图像坐标系下停车位关键点，顺时针方向
  std::vector<legion::interface::ImageKeyPoint> parking_points_in_image_;
};
}  // namespace interface
}  // namespace legion
