...
class Ins {
 public:
  ...
  inline void set_utm_position(const legion::interface::Point3D& utm_position) {
    utm_position_ = utm_position;
    utm_position_ptr_ = &utm_position_;
  }

  inline const legion::interface::Point3D& utm_position() const {
    return utm_position_;
  }

  inline legion::interface::Point3D* mutable_utm_position() {
    return &utm_position_;
  }
  ...
  inline void set_attitude(const legion::interface::Point3D& attitude) {
    attitude_ = attitude;
    attitude_ptr_ = &attitude_;
  }

  inline const legion::interface::Point3D& attitude() const {
    return attitude_;
  }

  inline legion::interface::Point3D* mutable_attitude() { return &attitude_; }
  ...
  inline void set_sd_position(const legion::interface::Point3D& sd_position) {
    sd_position_ = sd_position;
    sd_position_ptr_ = &sd_position_;
  }

  inline const legion::interface::Point3D& sd_position() const {
    return sd_position_;
  }

  inline legion::interface::Point3D* mutable_sd_position() {
    return &sd_position_;
  }

  inline bool has_sd_position() { return (sd_position_ptr_ != nullptr); }

  inline void set_sd_attitude(const legion::interface::Point3D& sd_attitude) {
    sd_attitude_ = sd_attitude;
    sd_attitude_ptr_ = &sd_attitude_;
  }

  inline const legion::interface::Point3D& sd_attitude() const {
    return sd_attitude_;
  }

  inline legion::interface::Point3D* mutable_sd_attitude() {
    return &sd_attitude_;
  }

  inline bool has_sd_attitude() { return (sd_attitude_ptr_ != nullptr); }

  inline void set_sd_velocity(const legion::interface::Point3D& sd_velocity) {
    sd_velocity_ = sd_velocity;
    sd_velocity_ptr_ = &sd_velocity_;
  }

  inline const legion::interface::Point3D& sd_velocity() const {
    return sd_velocity_;
  }

  inline legion::interface::Point3D* mutable_sd_velocity() {
    return &sd_velocity_;
  }
  ...
  inline void set_attitude_dual(
      const legion::interface::Point3D& attitude_dual) {
    attitude_dual_ = attitude_dual;
    attitude_dual_ptr_ = &attitude_dual_;
  }

  inline const legion::interface::Point3D& attitude_dual() const {
    return attitude_dual_;
  }

  inline legion::interface::Point3D* mutable_attitude_dual() {
    return &attitude_dual_;
  }

  inline bool has_attitude_dual() { return (attitude_dual_ptr_ != nullptr); }

  inline void set_sd_angle_dual(
      const legion::interface::Point3D& sd_angle_dual) {
    sd_angle_dual_ = sd_angle_dual;
    sd_angle_dual_ptr_ = &sd_angle_dual_;
  }

  inline const legion::interface::Point3D& sd_angle_dual() const {
    return sd_angle_dual_;
  }

  inline legion::interface::Point3D* mutable_sd_angle_dual() {
    return &sd_angle_dual_;
  }
  ...
  void operator=(const Ins& ins) { CopyFrom(ins); }

  void CopyFrom(const Ins& ins) {
    header_ = ins.header();
    is_valid_ = ins.is_valid();
    latitude_ = ins.latitude();
    longitude_ = ins.longitude();
    elevation_ = ins.elevation();
    utm_position_ = ins.utm_position();
    utm_zone_mumber_ = ins.utm_zone_mumber();
    utm_zone_char_ = ins.utm_zone_char();
    attitude_ = ins.attitude();
    linear_velocity_ = ins.linear_velocity();
    sd_position_ = ins.sd_position();
    sd_attitude_ = ins.sd_attitude();
    sd_velocity_ = ins.sd_velocity();
    cep68_ = ins.cep68();
    cep95_ = ins.cep95();
    second_ = ins.second();
    sat_use_num_ = ins.sat_use_num();
    sat_in_view_num_ = ins.sat_in_view_num();
    solution_status_ = ins.solution_status();
    position_type_ = ins.position_type();
    p_dop_ = ins.p_dop();
    h_dop_ = ins.h_dop();
    v_dop_ = ins.v_dop();
    attitude_dual_ = ins.attitude_dual();
    sd_angle_dual_ = ins.sd_angle_dual();
    base_line_length_dual_ = ins.base_line_length_dual();
    solution_status_dual_ = ins.solution_status_dual();
    position_type_dual_ = ins.position_type_dual();
    solution_source_dual_ = ins.solution_source_dual();
    aoc_ = ins.aoc();
    rtk_baseline_ = ins.rtk_baseline();
    angular_velocity_ = ins.angular_velocity();
    acceleration_ = ins.acceleration();
  }
 ...
 protected:
  ...
  // UTM坐标位置
  legion::interface::Point3D utm_position_;
  legion::interface::Point3D* utm_position_ptr_ = nullptr;
  // UTM区号
  ...
  //三轴姿态
  legion::interface::Point3D attitude_;
  legion::interface::Point3D* attitude_ptr_ = nullptr;
  //线速度信息
  legion::interface::Point3D linear_velocity_;
  legion::interface::Point3D* linear_velocity_ptr_ = nullptr;
  //位置标准差
  legion::interface::Point3D sd_position_;
  legion::interface::Point3D* sd_position_ptr_ = nullptr;
  //姿态标准差
  legion::interface::Point3D sd_attitude_;
  legion::interface::Point3D* sd_attitude_ptr_ = nullptr;
  //速度标准差
  legion::interface::Point3D sd_velocity_;
  legion::interface::Point3D* sd_velocity_ptr_ = nullptr;
  // cep68数据位
  double cep68_;
  ...
  //双天线姿态
  legion::interface::Point3D attitude_dual_;
  legion::interface::Point3D* attitude_dual_ptr_ = nullptr;
  //双天线角度标准差
  legion::interface::Point3D sd_angle_dual_;
  legion::interface::Point3D* sd_angle_dual_ptr_ = nullptr;
  //双天线距离
