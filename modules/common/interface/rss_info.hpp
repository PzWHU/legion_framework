...
class RSSInfo {
 public:
  ...
  inline void set_acc_lat_left_range_minimum(
      const double& acc_lat_left_range_minimum) {
  ...
  inline void set_acc_lat_left_range_maximum(
      const double& acc_lat_left_range_maximum) {
  ...
  inline void set_acc_lat_right_range_minimum(
      const double& acc_lat_right_range_minimum) {
  ...
  inline void set_acc_lat_right_range_maximum(
      const double& acc_lat_right_range_maximum) {
