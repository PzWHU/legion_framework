...
class Gnss {
 public:
  ...
  inline void set_utm_zone_num(const int32_t& utm_zone_num) {
    utm_zone_num_ = utm_zone_num;
    utm_zone_num_ptr_ = &utm_zone_num_;
  }

  inline const int32_t& utm_zone_num() const { return utm_zone_num_; }

  inline int32_t* mutable_utm_zone_num() { return &utm_zone_num_; }

  inline bool has_utm_zone_num() { return (utm_zone_num_ptr_ != nullptr); }
  ...
  void operator=(const Gnss& gnss) { CopyFrom(gnss); }

  void CopyFrom(const Gnss& gnss) {
    is_valid_ = gnss.is_valid();
    header_ = gnss.header();
    latitude_ = gnss.latitude();
    longitude_ = gnss.longitude();
    elevation_ = gnss.elevation();
    utm_position_ = gnss.utm_position();
    utm_zone_num_ = gnss.utm_zone_num();
    utm_zone_char_ = gnss.utm_zone_char();
    attitude_ = gnss.attitude();
    sd_position_ = gnss.sd_position();
    sd_velocity_ = gnss.sd_velocity();
    sd_attitude_ = gnss.sd_attitude();
    second_ = gnss.second();
    sat_use_num_ = gnss.sat_use_num();
    sat_in_view_num_ = gnss.sat_in_view_num();
    solution_status_ = gnss.solution_status();
    position_type_ = gnss.position_type();
    linear_velocity_ = gnss.linear_velocity();
    attitude_dual_ = gnss.attitude_dual();
    sd_angle_dual_ = gnss.sd_angle_dual();
    base_line_length_dual_ = gnss.base_line_length_dual();
    solution_status_dual_ = gnss.solution_status_dual();
    position_type_dual_ = gnss.position_type_dual();
    solution_source_dual_ = gnss.solution_source_dual();
    cep68_ = gnss.cep68();
    cep95_ = gnss.cep95();
    p_dop_ = gnss.p_dop();
    h_dop_ = gnss.h_dop();
 ...
 protected:
  ...
  // UTM区号
  int32_t utm_zone_num_;
  int32_t* utm_zone_num_ptr_ = nullptr;
  // UTM区号
