...
class ObstacleIntent {
 public:
  ObstacleIntent() {
    type_ = legion::interface::ObstacleIntent::Type::INTENT_UNKNOWN_STATE;
  }
  ...
  inline void set_type(const legion::interface::ObstacleIntent::Type& type) {
    type_ = type;
    type_ptr_ = &type_;
  }

  inline const legion::interface::ObstacleIntent::Type& type() const {
    return type_;
  }

  inline legion::interface::ObstacleIntent::Type* mutable_type() {
    return &type_;
  }
 ...
 protected:
  ...
  //8-HIGH_DECELERATION,
  legion::interface::ObstacleIntent::Type type_;
  legion::interface::ObstacleIntent::Type* type_ptr_ = nullptr;
};
}  // namespace interface
}  // namespace legion
