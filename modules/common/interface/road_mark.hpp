...
class RoadMark {
 public:
  RoadMark() {
    ...
    z_ = 0.0;
    confidence_ = 0.0;
    type_ = legion::common::RoadMarkType::STOP_LINE;
  }
  ~RoadMark() = default;
  ...
  inline void set_type(const legion::common::RoadMarkType& type) {
    type_ = type;
    type_ptr_ = &type_;
  }

  inline const legion::common::RoadMarkType& type() const { return type_; }

  inline legion::common::RoadMarkType* mutable_type() { return &type_; }
 ...
 protected:
  ...
  legion::common::RoadMarkType type_;
  legion::common::RoadMarkType* type_ptr_ = nullptr;
};
}  // namespace interface
}  // namespace legion
