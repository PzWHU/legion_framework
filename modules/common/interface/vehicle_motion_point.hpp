...
class VehicleMotionPoint {
 public:
  ...
  inline void set_trajectory_point(
      const legion::interface::TrajectoryPoint& trajectory_point) {
    trajectory_point_ = trajectory_point;
    trajectory_point_ptr_ = &trajectory_point_;
  }

  inline const legion::interface::TrajectoryPoint& trajectory_point() const {
    return trajectory_point_;
  }

  inline legion::interface::TrajectoryPoint* mutable_trajectory_point() {
    return &trajectory_point_;
  }
 ...
 protected:
  // trajectory point
  legion::interface::TrajectoryPoint trajectory_point_;
  legion::interface::TrajectoryPoint* trajectory_point_ptr_ = nullptr;
