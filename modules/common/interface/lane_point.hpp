...
class LanePoint {
 public:
  ...
  inline void set_left_line_type(
      const legion::common::LaneLineType& left_line_type) {
  ...
  inline void set_right_line_type(
      const legion::common::LaneLineType& right_line_type) {
 ...
 protected:
  ...
  legion::common::LaneLineType* left_line_type_ptr_ = nullptr;
  //右边车线线型
  legion::common::LaneLineType right_line_type_;
  legion::common::LaneLineType* right_line_type_ptr_ = nullptr;
};
}  // namespace interface
}  // namespace legion
