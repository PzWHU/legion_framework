...
class VehicleConfig {
 public:
  ...
  inline void set_vehicle_param(
      const legion::interface::VehicleParam& vehicle_param) {
    vehicle_param_ = vehicle_param;
    vehicle_param_ptr_ = &vehicle_param_;
  }

  inline const legion::interface::VehicleParam& vehicle_param() const {
    return vehicle_param_;
  }

  inline legion::interface::VehicleParam* mutable_vehicle_param() {
    return &vehicle_param_;
  }
 ...
 protected:
  ...
  legion::interface::VehicleParam* vehicle_param_ptr_ = nullptr;
};
}  // namespace interface
}  // namespace legion
