...
class Pose {
 public:
  ...
  inline void set_position(const legion::interface::PointENU& position) {
    position_ = position;
    position_ptr_ = &position_;
  }

  inline const legion::interface::PointENU& position() const {
    return position_;
  }

  inline legion::interface::PointENU* mutable_position() { return &position_; }

  inline bool has_position() { return (position_ptr_ != nullptr); }

  inline void set_orientation(
      const legion::interface::Quaternion& orientation) {
    orientation_ = orientation;
    orientation_ptr_ = &orientation_;
  }

  inline const legion::interface::Quaternion& orientation() const {
    return orientation_;
  }

  inline legion::interface::Quaternion* mutable_orientation() {
    return &orientation_;
  }
  ...
  inline void set_linear_acceleration_vrf(
      const legion::interface::Point3D& linear_acceleration_vrf) {
    linear_acceleration_vrf_ = linear_acceleration_vrf;
    linear_acceleration_vrf_ptr_ = &linear_acceleration_vrf_;
  }

  inline const legion::interface::Point3D& linear_acceleration_vrf() const {
    return linear_acceleration_vrf_;
  }

  inline legion::interface::Point3D* mutable_linear_acceleration_vrf() {
    return &linear_acceleration_vrf_;
  }
  ...
  inline void set_angular_velocity_vrf(
      const legion::interface::Point3D& angular_velocity_vrf) {
    angular_velocity_vrf_ = angular_velocity_vrf;
    angular_velocity_vrf_ptr_ = &angular_velocity_vrf_;
  }

  inline const legion::interface::Point3D& angular_velocity_vrf() const {
    return angular_velocity_vrf_;
  }

  inline legion::interface::Point3D* mutable_angular_velocity_vrf() {
    return &angular_velocity_vrf_;
  }
  ...
  inline void set_euler_angles(const legion::interface::Point3D& euler_angles) {
    euler_angles_ = euler_angles;
    euler_angles_ptr_ = &euler_angles_;
  }

  inline const legion::interface::Point3D& euler_angles() const {
    return euler_angles_;
  }

  inline legion::interface::Point3D* mutable_euler_angles() {
    return &euler_angles_;
  }
 ...
 protected:
  ...
  legion::interface::PointENU position_;
  legion::interface::PointENU* position_ptr_ = nullptr;
  // A quaternion that represents the rotation from the IMU coordinate
  // (Right/Forward/Up) to the world coordinate (East/North/Up).
  legion::interface::Quaternion orientation_;
  legion::interface::Quaternion* orientation_ptr_ = nullptr;
  ...
  legion::interface::Point3D linear_acceleration_vrf_;
  legion::interface::Point3D* linear_acceleration_vrf_ptr_ = nullptr;
  // Angular velocity of the VRP in the vehicle reference frame. Around
  // right/forward/up axes in radians per second.
  legion::interface::Point3D angular_velocity_vrf_;
  legion::interface::Point3D* angular_velocity_vrf_ptr_ = nullptr;
  ...
  legion::interface::Point3D euler_angles_;
  legion::interface::Point3D* euler_angles_ptr_ = nullptr;
};
}  // namespace interface
}  // namespace legion
