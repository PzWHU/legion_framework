...
class VehicleParam {
 public:
  VehicleParam() {
    brand_.clear();
    steer_mode_ = legion::common::SteerMode::STEER_MODE_2WS;
    length_ = 0.0;
    width_ = 0.0;
    height_ = 0.0;
    mass_fl_ = 0.0;
  ...
  inline void set_steer_mode(const legion::common::SteerMode& steer_mode) {
    steer_mode_ = steer_mode;
    steer_mode_ptr_ = &steer_mode_;
  }

  inline const legion::common::SteerMode& steer_mode() const {
    return steer_mode_;
  }

  inline legion::common::SteerMode* mutable_steer_mode() {
    return &steer_mode_;
  }
  ...
  inline void set_air_damping_coefficient(
      const double& air_damping_coefficient) {
  ...
  inline void set_standstill_acceleration(
      const double& standstill_acceleration) {
  ...
  inline void set_max_front_steer_angle_rate(
      const double& max_front_steer_angle_rate) {
  ...
  inline void set_max_rear_steer_angle_rate(
      const double& max_rear_steer_angle_rate) {
  ...
  inline void set_max_abs_speed_when_stopped(
 ...
 protected:
  ...
  legion::common::SteerMode steer_mode_;
  legion::common::SteerMode* steer_mode_ptr_ = nullptr;
  double length_;
