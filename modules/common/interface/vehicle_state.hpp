...
class VehicleState {
 public:
  ...
  inline void set_pose(const legion::interface::Pose& pose) {
    pose_ = pose;
    pose_ptr_ = &pose_;
  }

  inline const legion::interface::Pose& pose() const { return pose_; }

  inline legion::interface::Pose* mutable_pose() { return &pose_; }
 ...
 protected:
  ...
  legion::interface::Pose pose_;
  legion::interface::Pose* pose_ptr_ = nullptr;
