...
using legion::interface::Chassis;
using legion::interface::Location;
...
public:
   ...
   */
  Status Update(const Location &localization, const Chassis &chassis);
...
private:
  bool ConstructExceptLinearVelocity(const Location &localization);

  VehicleState vehicle_state_;
  Location original_localization_;
};
