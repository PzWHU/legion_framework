...
/**
 * @brief 计算从点(x1,y1)到点(x2,y2)的方向角（legion2.0）。
 * @param x1 输入量：起点的x坐标。
 * @param y1 输入量：起点的y坐标。
 * @param x2 输入量：终点的x坐标。
 * @param y2 输入量：终点的y坐标。
...
public:
   ...
   */
  bool TransferL2G(legion::interface::PathPoint p_local,
                   legion::interface::PathPoint& p_global);
   ...
   */
  bool TransferG2L(legion::interface::PathPoint point_global,
                   legion::interface::PathPoint& point_local);
