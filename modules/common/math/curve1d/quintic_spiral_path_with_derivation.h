...
public:
  ...
  double ComputeCartesianDeviationX(const double s) const {
    ...
    return math::IntegrateByGaussLegendre<N>(cos_theta, 0.0, s);
  }
  ...
  double ComputeCartesianDeviationY(const double s) const {
    ...
    return math::IntegrateByGaussLegendre<N>(sin_theta, 0.0, s);
  }
...
QuinticSpiralPathWithDerivation<N>::QuinticSpiralPathWithDerivation(
  ...
  auto gauss_points = math::GetGaussLegendrePoints<N>();
...
template <size_t N>
double
QuinticSpiralPathWithDerivation<N>::DeriveCosTheta(const size_t param_index,
...
template <size_t N>
double
QuinticSpiralPathWithDerivation<N>::DeriveSinTheta(const size_t param_index,
                                                   const double r) const {
  double g = param_ * r;
  double theta = Evaluate(0, g);
