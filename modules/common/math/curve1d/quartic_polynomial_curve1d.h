...
#include "modules/common/math/curve1d/polynomial_curve1d.h"
...
public:
  ...
  FitWithEndPointFirstOrder(const double x0, const double dx0,
   ...
   */
  QuarticPolynomialCurve1d&
  FitWithEndPointSecondOrder(const double x0, const double dx0, const double x1,
                             const double dx1, const double ddx1,
                             const double param);
   ...
   */
  QuarticPolynomialCurve1d&
  IntegratedFromCubicCurve(const PolynomialCurve1d& other,
   ...
   */
  QuarticPolynomialCurve1d&
  DerivedFromQuinticCurve(const PolynomialCurve1d& other);
