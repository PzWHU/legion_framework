...
private:
  ...
  double default_active_set_eps_num_ = -1e-7;
  double default_active_set_eps_den_ = -1e-7;
  double default_active_set_eps_iter_ref_ = 1e-7;
  bool default_enable_active_set_debug_info_ = false;
};
