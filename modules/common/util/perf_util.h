...
private:
  legion::cyber::Time start_time_;
  legion::cyber::Time end_time_;
...
#define PERF_FUNCTION()                                                        \
  legion::common::util::TimerWrapper _timer_wrapper_(                          \
      legion::common::util::function_signature(AFUNC))
#define PERF_FUNCTION_WITH_NAME(func_name)                                     \
  legion::common::util::TimerWrapper _timer_wrapper_(func_name)
#define PERF_FUNCTION_WITH_INDICATOR(indicator)                                \
  legion::common::util::TimerWrapper _timer_wrapper_(                          \
      legion::common::util::function_signature(AFUNC, indicator))
#define PERF_BLOCK_START()                                                     \
  legion::common::util::Timer _timer_;                                         \
  _timer_.Start()
