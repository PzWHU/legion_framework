...
class Mcutorquefeedback10report : public ::legion::driver::drivers::ProtocolData<
                    ::legion::drivers::ChassisDetail> {
 public:
  static const int32_t ID;
  Mcutorquefeedback10report();
 ...
 private:
  ...
  long long mcu_errorcode(const std::uint8_t* bytes, const int32_t length) const;
  ...
  long long mcu_motortemp(const std::uint8_t* bytes, const int32_t length) const;
  ...
  long long mcu_current(const std::uint8_t* bytes, const int32_t length) const;
  ...
  long long mcu_speed(const std::uint8_t* bytes, const int32_t length) const;
  ...
  long long mcu_shift(const std::uint8_t* bytes, const int32_t length) const;
};
