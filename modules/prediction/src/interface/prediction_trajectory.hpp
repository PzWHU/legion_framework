...
class PredictionTrajectory {
 public:
  ...
  inline const legion::interface::TrajectoryInPrediction trajectory_in_prediction()  const { return trajectory_in_prediction_; }

  inline legion::interface::TrajectoryInPrediction *mutable_trajectory_in_prediction() { return &trajectory_in_prediction_; }

  inline void set_trajectory_in_prediction(legion::interface::TrajectoryInPrediction trajectory_in_prediction) { 
 ...
 private:
  ...
  legion::interface::TrajectoryInPrediction trajectory_in_prediction_;
