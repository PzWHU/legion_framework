...
protected:
  ...
  //控制逻辑设置
  std::shared_ptr<legion::prediction::PredictionConf> prediction_conf_;
  //消息控制器
...
public:
   ...
   * @return    void.
   */
  void HandleADCTrajectory(legion::interface::ADCTrajectory adc_trajectory);
   ...
   * @return    void.
   */
  void HandleOdometry(legion::interface::Odometry odometry);
   ...
   */
  void
  HandleRoutingResponse(legion::interface::RoutingResponse routing_response);
...
protected:
  ...
  //消息状态
  std::map<std::string, legion::common::Status> message_status_;
  // task线程
