...
class Mat3 {
 ...
 public:
  ...
  Mat3(legion::interface::PointBasic rotation_center) {
  ...
  legion::interface::PointBasic operator*(legion::interface::PointBasic v) {
    legion::interface::PointBasic point_basic = v;
    ...
    Mat3(legion::interface::PathPoint rotationCenter) {
  ...
  legion::interface::PathPoint operator*(legion::interface::PathPoint v) {
    legion::interface::PathPoint point_basic = v;
    point_basic.set_x(m[0][0] * point_basic.x() + m[0][1] * point_basic.y() +
                      m[0][2] * 1);
    point_basic.set_y(m[1][0] * point_basic.x() + m[1][1] * point_basic.y() +
                      m[1][2] * 1);
