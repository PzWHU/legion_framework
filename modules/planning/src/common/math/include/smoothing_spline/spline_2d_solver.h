...
#include "modules/common/math/qp_problem/qpOASES.hpp"
#include "modules/planning/src/common/math/include/smoothing_spline/spline_2d.h"
  ...
  namespace planning
  {
    namespace math
    {
      ...
      private:
        ...
        std::unique_ptr<::qpOASES::SQProblem> sqp_solver_ = nullptr;
