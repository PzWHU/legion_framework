...
#include "modules/planning/src/common/math/include/smoothing_spline/spline_2d_seg.h"
  ...
  namespace planning
  {
    namespace math
    {
      ...
      public:
        ...
        //**********************
        int set_spline2d(const std::vector<double> &t_knots, const uint32_t order);
        //**********************
        int set_(const std::vector<double> &t_knots, const uint32_t order);
