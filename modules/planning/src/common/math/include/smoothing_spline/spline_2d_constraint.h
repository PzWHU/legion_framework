...
#include "modules/planning/src/common/math/include/smoothing_spline/affine_constraint.h"
...
namespace legion
{
   ...
   **/
                bool Add2dBoundary(const std::vector<double> &t_coord,
                                   ...
                                   const std::vector<legion::common::math::Vec2d> &ref_point,
   ...
   **/
            ...
            private:
                ...
                double SignDistance(const legion::common::math::Vec2d &xy_point,
