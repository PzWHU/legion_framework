...
//#include "modules/planning/modules/planning/src/common/math/include/math/smoothing_spline/spline_2d.h"
    ...
    namespace math
    {
      ...
      public:
        ...
        bool AddReferenceLineKernelMatrix(
            ...
            const std::vector<legion::common::math::Vec2d> &ref_points,
            const double weight);
