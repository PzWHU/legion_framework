/******************************************************************************
 * Copyright 2020 The legion Authors. All Rights Reserved.
 *
...
// #include "modules/planning/src/common/history.h"
...
class DependencyInjector {
 public:
  ...
  legion::common::VehicleStateProvider* vehicle_state() {
 ...
 protected:
  ...
  // History history_;
  legion::common::VehicleStateProvider vehicle_state_;
};
