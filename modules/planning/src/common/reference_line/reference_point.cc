...
ReferencePoint::ReferencePoint(const legion::interface::PathPoint& map_point,
                               const double longitudinal_bound,
                               const double lateral_bound, const bool enforced)
    : legion::interface::PathPoint(map_point),
      longitudinal_bound_(longitudinal_bound),
      lateral_bound_(lateral_bound),
      enforced_(enforced) {}

ReferencePoint::ReferencePoint(const legion::interface::LanePoint& map_point, const double longitudinal_bound,
                  const double lateral_bound, const bool enforced):
                  longitudinal_bound_(longitudinal_bound), 
                  lateral_bound_(lateral_bound), 
                  enforced_(enforced),
...
ReferencePoint::ReferencePoint(const legion::planning::LanePointInner& map_point, const double longitudinal_bound,
                  const double lateral_bound, const bool enforced):
                  longitudinal_bound_(longitudinal_bound), 
                  lateral_bound_(lateral_bound), 
                  enforced_(enforced),
