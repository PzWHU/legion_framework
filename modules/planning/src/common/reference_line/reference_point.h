...
/**
 * @namespace legion::reference_line
 * @brief legion::reference_line
 */
namespace legion {
namespace reference_line {

class ReferencePoint : public legion::interface::PathPoint {
 public:
  ReferencePoint() = default;

  ReferencePoint(const legion::interface::PathPoint& map_point,
                 const double longitudinal_bound, const double lateral_bound,
                 const bool enforced);
  ReferencePoint(const legion::interface::LanePoint& map_point,
                 const double longitudinal_bound, const double lateral_bound,
                 const bool enforced);
  ReferencePoint(const legion::planning::LanePointInner& map_point,
                 const double longitudinal_bound, const double lateral_bound,
                 const bool enforced);
  ...
  legion::common::LaneLineType left_line_type() const { return left_line_type_; }
  legion::common::LaneLineType right_line_type() const { return right_line_type_; }
  ...
  void set_left_line_type(const legion::common::LaneLineType left_line_type) {
    left_line_type_ = left_line_type;
  }
  void set_right_line_type(const legion::common::LaneLineType right_line_type) {
