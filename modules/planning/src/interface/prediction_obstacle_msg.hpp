...
class PredictionObstacleMsg {
 public:
  PredictionObstacleMsg() {
    ...
    clear_trajectory();
    clear_polygon_lists();
    // intent_ = legion::interface::ObstacleIntent::Type::INTENT_UNKNOWN_STATE;
    is_static_ = false;
    id_ = "";
  }
  ...
  inline void set_perception_obstacle(
      const legion::planning::ObstacleMsg &perception_obstacle) {
    perception_obstacle_ = perception_obstacle;
  }

  inline const legion::planning::ObstacleMsg &perception_obstacle() const {
    return perception_obstacle_;
  }

  inline legion::planning::ObstacleMsg *mutable_perception_obstacle() {
    return &perception_obstacle_;
  }
 ...
 protected:
  ...
  legion::planning::ObstacleMsg perception_obstacle_;
  // GPS time in seconds
  double timestamp_;
