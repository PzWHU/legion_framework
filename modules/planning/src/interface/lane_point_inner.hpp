...
public:
  LanePointInner() {
    ...
    left_line_type_ = legion::common::LaneLineType::LANE_LINE_TYPE_UNKNOWN;
    right_line_type_ = legion::common::LaneLineType::LANE_LINE_TYPE_UNKNOWN;
    lane_type_ = LaneInfoType::LANE_TYPE_UNKNOWN;
  }
  ...
  inline void
  set_left_line_type(const legion::common::LaneLineType &left_line_type) {
    left_line_type_ = left_line_type;
  }

  inline const legion::common::LaneLineType &left_line_type() const {
    return left_line_type_;
  }

  inline legion::common::LaneLineType *mutable_left_line_type() {
    return &left_line_type_;
  }

  inline void
  set_right_line_type(const legion::common::LaneLineType &right_line_type) {
    right_line_type_ = right_line_type;
  }

  inline const legion::common::LaneLineType &right_line_type() const {
    return right_line_type_;
  }

  inline legion::common::LaneLineType *mutable_right_line_type() {
    return &right_line_type_;
  }

  inline void set_lane_type(const LaneInfoType &lane_type) {
    lane_type_ = lane_type;
  }

  inline const LaneInfoType &lane_type() const {
    return lane_type_;
  }

  inline LaneInfoType *mutable_lane_type() {
    return &lane_type_;
  }
...
protected:
  ...
  legion::common::LaneLineType left_line_type_;
  legion::common::LaneLineType right_line_type_;
  LaneInfoType lane_type_;
};
} // namespace planning
} // namespace legion
