...
class ObstacleMsg {
 public:
  ObstacleMsg() {
    ...
    timestamp_ = 0.0;
    confidence_type_ = 0;
    lane_position_ = legion::common::LanePosition::LANE_POSITION_UNKNOWN;
  ...
  inline void set_lane_position(const legion::common::LanePosition &lane_position) {
  ...
  inline legion::common::ObstacleSubType *mutable_sub_type() { return &sub_type_; }
