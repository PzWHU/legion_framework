...
struct TrajectoryCost {
 public:
  ...
  legion::planning::DynamicObjectsPose dynamic_objects_pose;
  std::string id = "";
 ...
 * @brief 消息的描述.
 */
class PlanningTrajectory : public legion::interface::Trajectory {
 public:
  ...
  inline void set_dynamic_objects_pose(const legion::planning::DynamicObjectsPose &dynamic_objects_pose_) {
