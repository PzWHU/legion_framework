...
class Planning {
 public:
   ...
   * @return std::shared_ptr<legion::planning::PlanningConf>
   */
  std::shared_ptr<legion::planning::PlanningConf> GetConf() const;
 ...
 protected:
  ...
  std::shared_ptr<legion::planning::PlanningConf> planning_conf_;
  ...
  */
   ...
   */
  void PublishADCTrajectory(legion::interface::ADCTrajectory adc_trajectory);

  /**
   * @brief
   * @param  planning_cmd
   */
  void PublishPlanningCmd(legion::interface::PlanningCmd planning_cmd);
   ...
   * @param  events
   */
  void PublishEvents(legion::interface::Events events);
 ...
 public:
   ...
   * @return    void.
   */    
  void HandleTrafficEvents(legion::interface::TrafficEvents traffic_events);
   ...
   * @return    void.
   */
  void HandleGuideInfo(legion::interface::GuideInfo guide_info);
   ...
   * @return    void.
   */
  void HandleParkingInfo(legion::interface::ParkingInfo parking_info);
   ...
   * @return    void.
   */
  void HandleStopInfo(legion::interface::StopInfo stop_info);
   ...
   * @return    void.
   */
  void HandleLaneList(legion::interface::LaneList lane_list);
   ...
   * @return    void.
   */
  void HandleDrivableRegion(legion::interface::DrivableRegion drivable_region);
   ...
   * @return    void.
   */
  void HandleParkingOutInfo(legion::interface::ParkingOutInfo parking_out_info);
...
protected:
  ...
  legion::interface::ADCTrajectory last_adc_trajectory_;
  legion::interface::PlanningCmd planning_cmd_;
  legion::interface::PlanningAnalysis planning_analysis_;
  legion::interface::TrajectoryArray trajectory_array_;
  ...
  //
  // std::map<std::string, legion::common::MessageStatus> message_status_;  //消息状态
  ...
  legion::common::Status plan_status_;
