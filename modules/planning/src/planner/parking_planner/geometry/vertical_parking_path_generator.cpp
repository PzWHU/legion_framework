...
void VerticalParkingPathGenerator::SetParkingSpot(const legion::interface::ParkingInfo &parking_spot)
{
...
Status VerticalParkingPathGenerator::ComputeForwardPathInStage1(
    const legion::interface::PathPoint &cur_pose)
{
  ...
  std::vector<legion::interface::PathPoint> forward_path1, forward_path2;
  // 使用3次螺旋曲线插值生成最终曲线
  ...
  if (vertical_parking_conf_.vertical_forward_extend_distance_keep() > 0.0) {
    ...
    ExtendPath(stage1_f_a0_, extend_length, vertical_parking_conf_.vertical_path_interval(),
               legion::common::GearPosition::GEAR_DRIVE, forward_path2);
    ...
    const legion::interface::PathPoint &cur_pose)
{
  ...
  // 圆弧
  std::vector<legion::interface::PathPoint> backward_path2;
  ...
  std::vector<legion::interface::PathPoint> backward_path1;
  if (vertical_parking_conf_.vertical_parking_order() == 3) {
  ...
  num = (int)(math::Norm(backward_path2.back().x() - stage1_b_a3_.x(),
              ...
              vertical_parking_conf_.vertical_path_interval());
  std::vector<legion::interface::PathPoint> backward_path3;
  if (vertical_parking_conf_.vertical_parking_order() == 3) {
    ...
    const legion::interface::PathPoint &cur_pose)
{
  ...
  d3 = local_vehicle_current_pose_.y() -
       ...
       (R - R * cos(t_theta1));
  // move2 圆弧 y方向距离
  std::cout << "d3+(R-R*cos(t_theta1)) :" << d3 + (R - R * cos(t_theta1)) << std::endl;
  // if ((d - d3) < d2) {
  //   AERROR << "CalculatePath() failed.";
  //   return Status(Status::ErrorCode::PLANNING_ERROR, "CalculatePath()
  //   failed.");
  ...
  std::vector<legion::interface::PathPoint> forward_path1;
  // 使用3次螺旋曲线插值生成最终曲线
    ...
    const legion::interface::PathPoint &cur_pose)
{
  ...
  std::cout << "d2: " << d2 << endl;
  std::cout << "d3: " << d3 << endl;
  std::cout << "theta_1: " << legion::common::math::R2D(theta_1) << endl;
  std::cout << "theta_t1: " << legion::common::math::R2D(theta_t) << endl;
    ...
    const legion::interface::PathPoint &cur_pose)
{
  ...
  std::cout << "theta_2: " << legion::common::math::R2D(theta_2) << endl;
  // 圆弧
  ...
  theta_2 = legion::common::math::NormalizeAngle(theta_2);
  double start_theta = M_PI_2;
    ...
    const legion::interface::PathPoint &cur_pose)
{
  ...
  std::vector<legion::interface::PathPoint> backward_path1, backward_path2, backward_path3;
  // double ox = parking_position_ * (l_r1-fabs(stage1_m1_a1_.x()));
  double ox = local_vehicle_current_pose_.x() + parking_position_ * R * cos(theta_2 + theta_t);
  double oy = local_vehicle_current_pose_.y() - R * sin(theta_2 + theta_t);
  ...
  ExtendPath(stage1_m2_a2_, extend_length, vertical_parking_conf_.vertical_path_interval(),
             legion::common::GearPosition::GEAR_REVERSE, backward_path3);
    ...
    const legion::interface::PathPoint &cur_pose)
{
  ...
  ExtendPath(local_vehicle_current_pose_, extend_length,
             vertical_parking_conf_.vertical_path_interval(),
             legion::common::GearPosition::GEAR_DRIVE, forward_path1);
    ...
    const legion::interface::PathPoint &cur_pose)
{
  ...
  double t_theta = legion::common::math::NormalizeAngle(local_vehicle_current_pose_.theta());
    ...
    const legion::interface::PathPoint &cur_pose)
{
  local_vehicle_current_pose_ = cur_pose;
  backward_path_.clear();
  double temptheta = legion::common::math::NormalizeAngle(local_vehicle_current_pose_.theta());
  ...
  std::cout << "theta3: " << legion::common::math::R2D(theta_3) << endl;
  std::cout << "theta4: " << legion::common::math::R2D(theta_4) << endl;
  if (temp_R < vehicle_param_.min_turning_radius()) {
    stage1_m4_a2_.set_y(
  ...
  CalculateCirclePath(ox, oy, start_theta, end_theta,
                      vertical_parking_conf_.vertical_path_interval(), temp_R, backward_path1);
  legion::interface::PathPoint t_stage1_m4_a2;
    ...
    const legion::interface::PathPoint &cur_pose)
{
  ...
  ExtendPath(stage3_m2_a0_, extend_length, vertical_parking_conf_.vertical_path_interval(),
             legion::common::GearPosition::GEAR_REVERSE, backward_path1);
...
Status VerticalParkingPathGenerator::ComputePathInStage3Move3(
    const legion::interface::PathPoint &cur_pose, int director_pose)
{
  local_vehicle_current_pose_ = cur_pose;
    ...
    const legion::interface::PathPoint &cur_pose)
{
  ...
  backward_path_.clear();
  t_theta =
      legion::common::math::NormalizeAngle(M_PI_2 - parking_position_ * M_PI_2 +
...
void VerticalParkingPathGenerator::UpdateStage1Move2_2ControlPoints(int parking_position_)
{
  ...
  std::cout << "theta_t2: " << legion::common::math::R2D(theta_t) << endl;
...
void VerticalParkingPathGenerator::UpdateStage1Move3ControlPoints(int parking_position_)
{
  ...
  temp_theta_2 = legion::common::math::NormalizeAngle(temp_theta_2);
...
{
  double temp_theta_3 = legion::common::math::NormalizeAngle(local_vehicle_current_pose_.theta());
  temp_theta_3 = parking_position_ * M_PI_2 - parking_position_ * temp_theta_3;
  // temp_theta_3 = legion::common::math::NormalizeAngle(temp_theta_3);
