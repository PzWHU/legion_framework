...
{
  behaviour_lat_state_ = legion::interface::ADCTrajectory::BehaviourLatState::PARKING_INITIAL_STATE;
...
{
  behaviour_lat_state_ = legion::interface::ADCTrajectory::BehaviourLatState::PARKING_FINISH_STATE;
