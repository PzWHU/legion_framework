...
legion::common::Status ParkingPlanner::Init(const legion::planning::PlanningConf *planning_conf)
{
...
legion::common::Status ParkingPlanner::IsParkingOk(Frame *frame)
{
  return parking_manager_.IsGeometryOK(frame);
}

legion::common::Status ParkingPlanner::Plan(Frame *frame,
