...
// using legion::planning::Planning;
/**
...
class LatticePlanner : public Planner {
 public:
  ...
  common::Status Init(const legion::planning::PlanningConf *planning_conf) override;
   ...
   */
  common::Status Plan(Frame *frame, legion::interface::ADCTrajectory *ptr_adc_trajectory,
