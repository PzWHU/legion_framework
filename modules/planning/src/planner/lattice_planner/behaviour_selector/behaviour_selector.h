...
class BehaviourSelector {
 ...
 private:
   ...
   * @return void.
   */
  void BehaviourParamsInit(const legion::planning::PlanningConf *planning_conf);
 ...
 public:
  ...
  legion::interface::PlanningCmd PlanningCommand() { return planning_cmd_; }
  //
  const legion::planning::PlanningConf *common_params() const { return planning_params_; }
 ...
 private:
  ...
  const legion::planning::PlanningConf *planning_params_;                  // planning 参数类
