...
class TrajectoryEvaluator {
 public:
   ...
   * @brief        参数初始化函数
   */
  void EvaluatorParamsInit(const legion::planning::PlanningConf *planning_conf);
   ...
   * @param[in]
   */
  int CalculateJunctionCloseCosts(const legion::interface::JunctionInfo &junction_info);
 ...
 private:
  const legion::planning::PlanningConf *params_;
