...
public:
  ...
  virtual void PublishADCTrajectory(legion::interface::ADCTrajectory msg) = 0;
  virtual void PublishPlanningCmd(legion::interface::PlanningCmd msg) = 0;
  virtual void
  PublishPlanningAnalysis(legion::interface::PlanningAnalysis msg) = 0;
  virtual void
  PublishParkingStateDisplay(legion::interface::ParkingStateDisplay msg) = 0;
  virtual void
  PublishTrajectoryArray(legion::interface::TrajectoryArray msg) = 0;
