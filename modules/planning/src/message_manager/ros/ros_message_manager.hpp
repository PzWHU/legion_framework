...
template <typename T> void RosMessageManager<T>::Init(T* t) {
  ...
  planning_analysis_pub_ = nh_.advertise<::ros_interface::PlanningAnalysis>(
      "/planning/PlanningAnalysis", 10);

  parking_state_display_pub_ =
      nh_.advertise<::ros_interface::ParkingStateDisplay>(
          "/planning/ParkingStateDisplay", 10);

  trajectory_array_pub_ = nh_.advertise<::ros_interface::TrajectoryArray>(
      "/planning/TrajectoryArray", 10);

  faults_pub_ =
      nh_.advertise<::ros_interface::Faults>("/planning/Faults", 10);

  events_pub_ =
      nh_.advertise<::ros_interface::Events>("/planning/Events", 10);
...
template <typename T> void RosMessageManager<T>::TaskStart() {
  ...
  routing_response_sub_ =
      nh_.subscribe("/routing/RoutingResponse", 30,
                    &RosMessageManager::HandleRoutingResponseMessage, this);

  local_routing_response_sub_ = nh_.subscribe(
      "/local_map/LocalRoutingResponse", 30,
      &RosMessageManager::HandleLocalRoutingResponseMessage, this);

  parking_info_sub_ =
      nh_.subscribe("/routing/ParkingInfo", 30,
                    &RosMessageManager::HandleParkingInfoMessage, this);

  stop_info_sub_ =
      nh_.subscribe("/routing/StopInfo", 30,
                    &RosMessageManager::HandleStopInfoMessage, this);

  traffic_light_msg_sub_ =
      nh_.subscribe("TrafficLightMsg", 30,
                    &RosMessageManager::HandleTrafficLightMsgMessage, this);
  ...
  prediction_obstacles_sub_ =
      nh_.subscribe("/prediction/PredictionObstacles", 30,
                    &RosMessageManager::HandlePredictionObstaclesMessage, this);

  lane_list_sub_ = nh_.subscribe(
      "LaneList", 30, &RosMessageManager::HandleLaneListMessage, this);

  chassis_sub_ = nh_.subscribe("/drivers/canbus/Chassis", 30,
                               &RosMessageManager::HandleChassisMessage, this);

  sotif_monitor_result_sub_ =
      nh_.subscribe("/safety/sotif_monitor/SotifMonitorResult", 30,
                    &RosMessageManager::HandleSotifMonitorResultMessage, this);

  drivable_region_sub_ =
      nh_.subscribe("/perception/fusion/traffic_sign_fusion/DrivableRegion", 30,
                    &RosMessageManager::HandleDrivableRegionMessage, this);

  parking_out_info_sub_ =
      nh_.subscribe("/avp/parking_out/ParkingOutInfo", 30,
                    &RosMessageManager::HandleParkingOutInfoMessage, this);

  traffic_events_sub_ =
      nh_.subscribe("/routing/TrafficEvents", 30,
                    &RosMessageManager::HandleTrafficEventsMessage, this);
...
template <typename T> void RosMessageManager<T>::TaskStop() {
  ...
  std::lock_guard<std::mutex> lock(mutex_);
  routing_response_sub_.shutdown();

  local_routing_response_sub_.shutdown();

  parking_info_sub_.shutdown();

  stop_info_sub_.shutdown();

  traffic_light_msg_sub_.shutdown();

  location_sub_.shutdown();

  prediction_obstacles_sub_.shutdown();

  lane_list_sub_.shutdown();

  chassis_sub_.shutdown();

  sotif_monitor_result_sub_.shutdown();

  drivable_region_sub_.shutdown();

  parking_out_info_sub_.shutdown();

  traffic_events_sub_.shutdown();
...
void RosMessageManager<T>::PublishADCTrajectory(
  ...
  for (auto it_trajectory_points : legion_trajectory_points) {
    ::ros_interface::TrajectoryPoint adc_trajectory_trajectory_point;
    ::ros_interface::PathPoint adc_trajectory_trajectory_point_path_point;
  ...
  ::ros_interface::EStop adc_trajectory_estop;
  ...
  ::ros_interface::RSSInfo adc_trajectory_rss_info;
...
template <typename T>
void RosMessageManager<T>::PublishPlanningCmd(
    legion::interface::PlanningCmd msg) {
  if (is_init_ == false)
    return;
  ::ros_interface::PlanningCmd planning_cmd;
  MESSAGE_HEADER_ASSIGN(std_msgs, planning_cmd)
...
template <typename T>
void RosMessageManager<T>::PublishPlanningAnalysis(
    legion::interface::PlanningAnalysis msg) {
  if (is_init_ == false)
    return;
  ::ros_interface::PlanningAnalysis planning_analysis;
  MESSAGE_HEADER_ASSIGN(std_msgs, planning_analysis)
  planning_analysis.frame_update_time = msg.frame_update_time();
  planning_analysis.generator_time = msg.generator_time();
  std::vector<ros_interface::TimeConsume> ros_evaluator_time;
  ...
  for (auto it_evaluator_time : legion_evaluator_time) {
    ::ros_interface::TimeConsume planning_analysis_time_consume;
  ...
  std::vector<ros_interface::Polygon2D> ros_vehicle_preiew_polygon;
  ...
  std::vector<ros_interface::Polygon2D> ros_obstacles_polygon;
  ...
  for (auto it_obstacles_polygon : legion_obstacles_polygon) {
    ...
    std::vector<ros_interface::Point2D> ros_points_1;
  ...
  std::vector<ros_interface::PathPoint> ros_path_points;
  ...
  std::vector<ros_interface::Point2dList> ros_obstacles_vec;
  ...
  for (auto it_obstacles_vec : legion_obstacles_vec) {
    ...
    std::vector<ros_interface::Point2D> ros_point2d_list;
  ...
  std::vector<ros_interface::TrajectoryPoint> ros_warm_start_traj;
  ...
  planning_analysis_planning_parking_debug.warm_start_traj =
      ros_warm_start_traj;
  std::vector<ros_interface::TrajectoryPoint> ros_smoothed_traj_stage1;
  ...
  std::vector<ros_interface::TrajectoryPoint> ros_smoothed_traj_stage2;
  ...
  planning_analysis_planning_parking_debug.reference_line =
      planning_analysis_planning_parking_debug_reference_line;
  std::vector<ros_interface::Trajectory> ros_trajectory_array;
  ...
  for (auto it_trajectory_array : legion_trajectory_array) {
    ...
    std::vector<ros_interface::TrajectoryPoint> ros_trajectory_points_1;
  ...
  std::vector<ros_interface::TrajectoryPoint> ros_trajectory_points_2;
  ...
  std::vector<ros_interface::TrajectoryPoint> ros_trajectory_points_3;
...
template <typename T>
void RosMessageManager<T>::PublishParkingStateDisplay(
    legion::interface::ParkingStateDisplay msg) {
  if (is_init_ == false)
    return;
  ::ros_interface::ParkingStateDisplay parking_state_display;
  MESSAGE_HEADER_ASSIGN(std_msgs, parking_state_display)
...
template <typename T>
void RosMessageManager<T>::PublishTrajectoryArray(
    legion::interface::TrajectoryArray msg) {
  if (is_init_ == false)
    return;
  ::ros_interface::TrajectoryArray trajectory_array;
  MESSAGE_HEADER_ASSIGN(std_msgs, trajectory_array)
  std::vector<ros_interface::Path> ros_spline_s;
  std::vector<legion::interface::Path> legion_spline_s;
  msg.spline_s(legion_spline_s);
  for (auto it_spline_s : legion_spline_s) {
    ::ros_interface::Path trajectory_array_path;
    trajectory_array_path.name = it_spline_s.name();
    std::vector<ros_interface::PathPoint> ros_path_points;
    std::vector<legion::interface::PathPoint> legion_path_points;
    it_spline_s.path_points(legion_path_points);
    for (auto it_path_points : legion_path_points) {
      ::ros_interface::PathPoint trajectory_array_path_path_point;
  ...
  std::vector<ros_interface::Path> ros_qp_smooth;
  ...
  for (auto it_qp_smooth : legion_qp_smooth) {
    ...
    std::vector<ros_interface::PathPoint> ros_path_points_1;
  ...
  std::vector<ros_interface::Trajectory> ros_trajectory_list;
  ...
  for (auto it_trajectory_list : legion_trajectory_list) {
    ::ros_interface::Trajectory trajectory_array_trajectory;
...
template <typename T>
void RosMessageManager<T>::PublishEvents(legion::interface::Events msg) {
  if (is_init_ == false)
    return;
  ::ros_interface::Events events;
  MESSAGE_HEADER_ASSIGN(std_msgs, events)
  events.version = msg.version();
  std::vector<ros_interface::Event> ros_events_vector;
  ...
  for (auto it_events_vector : legion_events_vector) {
    ::ros_interface::Event events_event;
    ::ros_interface::Time events_event_timestamp;
...
template <typename T>
void RosMessageManager<T>::HandleRoutingResponseMessage(
    const ros_interface::RoutingResponse& msg_obj) {
  if (is_active_ == false)
    return;
  const ros_interface::RoutingResponse* msg_obj_ptr = &msg_obj;
  ros_interface::RoutingResponse* msg =
      const_cast<ros_interface::RoutingResponse*>(msg_obj_ptr);
...
template <typename T>
void RosMessageManager<T>::HandleLocalRoutingResponseMessage(
    const ros_interface::RoutingResponse& msg_obj) {
  if (is_active_ == false)
    return;
  const ros_interface::RoutingResponse* msg_obj_ptr = &msg_obj;
...
template <typename T>
void RosMessageManager<T>::HandleParkingInfoMessage(
    const ros_interface::ParkingInfo& msg_obj) {
  if (is_active_ == false)
    return;
  const ros_interface::ParkingInfo* msg_obj_ptr = &msg_obj;
  ros_interface::ParkingInfo* msg =
      const_cast<ros_interface::ParkingInfo*>(msg_obj_ptr);
...
template <typename T>
void RosMessageManager<T>::HandleStopInfoMessage(
    const ros_interface::StopInfo& msg_obj) {
  if (is_active_ == false)
    return;
  const ros_interface::StopInfo* msg_obj_ptr = &msg_obj;
  ros_interface::StopInfo* msg =
      const_cast<ros_interface::StopInfo*>(msg_obj_ptr);
...
template <typename T>
void RosMessageManager<T>::HandlePredictionObstaclesMessage(
    const ros_interface::PredictionObstacles& msg_obj) {
  if (is_active_ == false)
    return;
  const ros_interface::PredictionObstacles* msg_obj_ptr = &msg_obj;
  ros_interface::PredictionObstacles* msg =
      const_cast<ros_interface::PredictionObstacles*>(msg_obj_ptr);
...
template <typename T>
void RosMessageManager<T>::HandleLaneListMessage(
    const ros_interface::LaneList& msg_obj) {
  if (is_active_ == false)
    return;
  const ros_interface::LaneList* msg_obj_ptr = &msg_obj;
  ros_interface::LaneList* msg =
      const_cast<ros_interface::LaneList*>(msg_obj_ptr);
...
template <typename T>
void RosMessageManager<T>::HandleSotifMonitorResultMessage(
    const ros_interface::SotifMonitorResult& msg_obj) {
  if (is_active_ == false)
    return;
  const ros_interface::SotifMonitorResult* msg_obj_ptr = &msg_obj;
  ros_interface::SotifMonitorResult* msg =
      const_cast<ros_interface::SotifMonitorResult*>(msg_obj_ptr);
...
template <typename T>
void RosMessageManager<T>::HandleDrivableRegionMessage(
    const ros_interface::DrivableRegion& msg_obj) {
  if (is_active_ == false)
    return;
  const ros_interface::DrivableRegion* msg_obj_ptr = &msg_obj;
  ros_interface::DrivableRegion* msg =
      const_cast<ros_interface::DrivableRegion*>(msg_obj_ptr);
...
template <typename T>
void RosMessageManager<T>::HandleParkingOutInfoMessage(
    const ros_interface::ParkingOutInfo& msg_obj) {
  if (is_active_ == false)
    return;
  const ros_interface::ParkingOutInfo* msg_obj_ptr = &msg_obj;
  ros_interface::ParkingOutInfo* msg =
      const_cast<ros_interface::ParkingOutInfo*>(msg_obj_ptr);
...
template <typename T>
void RosMessageManager<T>::HandleTrafficEventsMessage(
