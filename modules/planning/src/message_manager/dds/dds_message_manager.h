...
public:
   ...
   * @return    void.
   */
  void PublishADCTrajectory(legion::interface::ADCTrajectory msg) override;
   ...
   * @return    void.
   */
  void PublishPlanningCmd(legion::interface::PlanningCmd msg) override;
   ...
   * @return    void.
   */
  void PublishPlanningAnalysis(legion::interface::PlanningAnalysis msg) override;
  ...
  void PublishParkingStateDisplay(
      legion::interface::ParkingStateDisplay msg) override;
   ...
   * @return    void.
   */
  void PublishTrajectoryArray(legion::interface::TrajectoryArray msg) override;
   ...
   * @return    void.
   */
  void PublishEvents(legion::interface::Events msg) override;
