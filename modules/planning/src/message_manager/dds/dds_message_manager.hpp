...
template <typename T> void DdsMessageManager<T>::Init(T *t) {
  ...
  adc_trajectory_topic_ = participant_->create_topic(
      "rt/planning/ADCTrajectory", adc_trajectory_type_->get_type_name(),
      TOPIC_QOS_DEFAULT);
  adc_trajectory_writer_ =
      publisher_->create_datawriter(adc_trajectory_topic_, wqos, nullptr);
  ...
  publisher_ = participant_->create_publisher(PUBLISHER_QOS_DEFAULT, nullptr);
  planning_cmd_topic_ = participant_->create_topic(
      "rt/planning/PlanningCmd", planning_cmd_type_->get_type_name(),
      TOPIC_QOS_DEFAULT);
  planning_cmd_writer_ =
      publisher_->create_datawriter(planning_cmd_topic_, wqos, nullptr);

  // PlanningAnalysis
  planning_analysis_type_.reset(new eprosima::fastdds::dds::TypeSupport(
      new ros2_interface::msg::PlanningAnalysisPubSubType()));
  planning_analysis_type_->register_type(participant_);
  publisher_ = participant_->create_publisher(PUBLISHER_QOS_DEFAULT, nullptr);
  planning_analysis_topic_ = participant_->create_topic(
      "rt/planning/PlanningAnalysis", planning_analysis_type_->get_type_name(),
      TOPIC_QOS_DEFAULT);
  planning_analysis_writer_ =
      publisher_->create_datawriter(planning_analysis_topic_, wqos, nullptr);

  // ParkingStateDisplay
  parking_state_display_type_.reset(new eprosima::fastdds::dds::TypeSupport(
      new ros2_interface::msg::ParkingStateDisplayPubSubType()));
  parking_state_display_type_->register_type(participant_);
  publisher_ = participant_->create_publisher(PUBLISHER_QOS_DEFAULT, nullptr);
  parking_state_display_topic_ = participant_->create_topic(
      "rt/planning/ParkingStateDisplay",
      parking_state_display_type_->get_type_name(), TOPIC_QOS_DEFAULT);
  parking_state_display_writer_ = publisher_->create_datawriter(
      parking_state_display_topic_, wqos, nullptr);

  // TrajectoryArray
  trajectory_array_type_.reset(new eprosima::fastdds::dds::TypeSupport(
      new ros2_interface::msg::TrajectoryArrayPubSubType()));
  trajectory_array_type_->register_type(participant_);
  publisher_ = participant_->create_publisher(PUBLISHER_QOS_DEFAULT, nullptr);
  trajectory_array_topic_ = participant_->create_topic(
      "rt/planning/TrajectoryArray", trajectory_array_type_->get_type_name(),
      TOPIC_QOS_DEFAULT);
  trajectory_array_writer_ =
      publisher_->create_datawriter(trajectory_array_topic_, wqos, nullptr);
  ...
  faults_topic_ = participant_->create_topic(
      "rt/planning/Faults", faults_type_->get_type_name(), TOPIC_QOS_DEFAULT);
  ...
  events_topic_ = participant_->create_topic(
      "rt/planning/Events", events_type_->get_type_name(), TOPIC_QOS_DEFAULT);
  ...
  local_routing_response_type_.reset(new eprosima::fastdds::dds::TypeSupport(
      new ros2_interface::msg::RoutingResponsePubSubType()));
  local_routing_response_type_->register_type(participant_);
  local_routing_response_topic_ = participant_->create_topic(
      "rt/local_map/LocalRoutingResponse",
      local_routing_response_type_->get_type_name(), TOPIC_QOS_DEFAULT);
  ...
  prediction_obstacles_type_.reset(new eprosima::fastdds::dds::TypeSupport(
      new ros2_interface::msg::PredictionObstaclesPubSubType()));
  prediction_obstacles_type_->register_type(participant_);
  prediction_obstacles_topic_ = participant_->create_topic(
      "rt/prediction/PredictionObstacles",
      prediction_obstacles_type_->get_type_name(), TOPIC_QOS_DEFAULT);

  lane_list_type_.reset(new eprosima::fastdds::dds::TypeSupport(
      new ros2_interface::msg::LaneListPubSubType()));
  lane_list_type_->register_type(participant_);
  lane_list_topic_ = participant_->create_topic(
      "rt/LaneList", lane_list_type_->get_type_name(), TOPIC_QOS_DEFAULT);
  ...
  sotif_monitor_result_type_.reset(new eprosima::fastdds::dds::TypeSupport(
      new ros2_interface::msg::SotifMonitorResultPubSubType()));
  sotif_monitor_result_type_->register_type(participant_);
  sotif_monitor_result_topic_ = participant_->create_topic(
      "rt/safety/sotif_monitor/SotifMonitorResult",
      sotif_monitor_result_type_->get_type_name(), TOPIC_QOS_DEFAULT);
  ...
  drivable_region_type_.reset(new eprosima::fastdds::dds::TypeSupport(
      new ros2_interface::msg::DrivableRegionPubSubType()));
  drivable_region_type_->register_type(participant_);
  drivable_region_topic_ = participant_->create_topic(
      "rt/perception/fusion/traffic_sign_fusion/DrivableRegion",
      drivable_region_type_->get_type_name(), TOPIC_QOS_DEFAULT);

  parking_out_info_type_.reset(new eprosima::fastdds::dds::TypeSupport(
      new ros2_interface::msg::ParkingOutInfoPubSubType()));
  parking_out_info_type_->register_type(participant_);
  parking_out_info_topic_ = participant_->create_topic(
      "rt/avp/parking_out/ParkingOutInfo",
      parking_out_info_type_->get_type_name(), TOPIC_QOS_DEFAULT);

  guide_info_type_.reset(new eprosima::fastdds::dds::TypeSupport(
      new ros2_interface::msg::GuideInfoPubSubType()));
  guide_info_type_->register_type(participant_);
  guide_info_topic_ = participant_->create_topic(
      "rt/routing/GuideInfo", guide_info_type_->get_type_name(),
      TOPIC_QOS_DEFAULT);
...
template <typename T> void DdsMessageManager<T>::TaskStart() {
  ...
  routing_response_reader_ =
      subscriber_->create_datareader(routing_response_topic_, rqos, this);
  local_routing_response_reader_ =
      subscriber_->create_datareader(local_routing_response_topic_, rqos, this);
  parking_info_reader_ =
      subscriber_->create_datareader(parking_info_topic_, rqos, this);
  stop_info_reader_ =
      subscriber_->create_datareader(stop_info_topic_, rqos, this);
  ...
  prediction_obstacles_reader_ =
      subscriber_->create_datareader(prediction_obstacles_topic_, rqos, this);
  lane_list_reader_ =
      subscriber_->create_datareader(lane_list_topic_, rqos, this);
  chassis_reader_ = subscriber_->create_datareader(chassis_topic_, rqos, this);
  sotif_monitor_result_reader_ =
      subscriber_->create_datareader(sotif_monitor_result_topic_, rqos, this);
  drivable_region_reader_ =
      subscriber_->create_datareader(drivable_region_topic_, rqos, this);
  parking_out_info_reader_ =
      subscriber_->create_datareader(parking_out_info_topic_, rqos, this);
  guide_info_reader_ =
      subscriber_->create_datareader(guide_info_topic_, rqos, this);
  traffic_events_reader_ =
      subscriber_->create_datareader(traffic_events_topic_, rqos, this);
...
template <typename T>
void DdsMessageManager<T>::PublishADCTrajectory(
    legion::interface::ADCTrajectory msg) {
  if (is_init_ == false)
    return;
  ros2_interface::msg::ADCTrajectory adc_trajectory;
  MESSAGE_DDS_HEADER_ASSIGN(ros2_interface::msg, adc_trajectory)
  adc_trajectory.total_path_length() = msg.total_path_length();
  adc_trajectory.total_path_time() = msg.total_path_time();
  std::vector<ros2_interface::msg::TrajectoryPoint> dds_trajectory_points;
  std::vector<legion::interface::TrajectoryPoint> legion_trajectory_points;
  msg.trajectory_points(legion_trajectory_points);
  for (auto it_trajectory_points : legion_trajectory_points) {
    ros2_interface::msg::TrajectoryPoint adc_trajectory_trajectory_point;
    ros2_interface::msg::PathPoint adc_trajectory_trajectory_point_path_point;
    ...
    dds_trajectory_points.emplace_back(adc_trajectory_trajectory_point);
  }
  adc_trajectory.trajectory_points() = dds_trajectory_points;
  ...
  ros2_interface::msg::EStop adc_trajectory_estop;
  ...
  ros2_interface::msg::RSSInfo adc_trajectory_rss_info;
  ...
  adc_trajectory_writer_->write(&adc_trajectory);
}

template <typename T>
void DdsMessageManager<T>::PublishPlanningCmd(
    legion::interface::PlanningCmd msg) {
  if (is_init_ == false)
    return;
  ros2_interface::msg::PlanningCmd planning_cmd;
  MESSAGE_DDS_HEADER_ASSIGN(ros2_interface::msg, planning_cmd)
  ...
  planning_cmd_writer_->write(&planning_cmd);
}

template <typename T>
void DdsMessageManager<T>::PublishPlanningAnalysis(
    legion::interface::PlanningAnalysis msg) {
  if (is_init_ == false)
    return;
  ros2_interface::msg::PlanningAnalysis planning_analysis;
  MESSAGE_DDS_HEADER_ASSIGN(ros2_interface::msg, planning_analysis)
  planning_analysis.frame_update_time() = msg.frame_update_time();
  planning_analysis.generator_time() = msg.generator_time();
  std::vector<ros2_interface::msg::TimeConsume> dds_evaluator_time;
  std::vector<legion::interface::TimeConsume> legion_evaluator_time;
  msg.evaluator_time(legion_evaluator_time);
  for (auto it_evaluator_time : legion_evaluator_time) {
    ros2_interface::msg::TimeConsume planning_analysis_time_consume;
    ...
    dds_evaluator_time.emplace_back(planning_analysis_time_consume);
  }
  planning_analysis.evaluator_time() = dds_evaluator_time;
  ...
  std::vector<ros2_interface::msg::Polygon2D> dds_vehicle_preiew_polygon;
  std::vector<legion::interface::Polygon2D> legion_vehicle_preiew_polygon;
  ...
  for (auto it_vehicle_preiew_polygon : legion_vehicle_preiew_polygon) {
    ...
    std::vector<legion::interface::Point2D> legion_points;
    ...
    planning_analysis_planning_parking_debug_polygon_2d.points() = dds_points;
    dds_vehicle_preiew_polygon.emplace_back(
        planning_analysis_planning_parking_debug_polygon_2d);
  }
  planning_analysis_planning_parking_debug.vehicle_preiew_polygon() =
      dds_vehicle_preiew_polygon;
  std::vector<ros2_interface::msg::Polygon2D> dds_obstacles_polygon;
  std::vector<legion::interface::Polygon2D> legion_obstacles_polygon;
  ...
  for (auto it_obstacles_polygon : legion_obstacles_polygon) {
    ...
    std::vector<ros2_interface::msg::Point2D> dds_points_1;
    std::vector<legion::interface::Point2D> legion_points_1;
    ...
    for (auto it_points_1 : legion_points_1) {
      ...
      planning_analysis_planning_parking_debug_polygon_2d_point_2d.y() =
          it_points_1.y();
      dds_points_1.emplace_back(
          planning_analysis_planning_parking_debug_polygon_2d_point_2d);
    }
    planning_analysis_planning_parking_debug_polygon_2d.points() = dds_points_1;
    dds_obstacles_polygon.emplace_back(
        planning_analysis_planning_parking_debug_polygon_2d);
  }
  planning_analysis_planning_parking_debug.obstacles_polygon() =
      dds_obstacles_polygon;
  std::vector<ros2_interface::msg::PathPoint> dds_path_points;
  std::vector<legion::interface::PathPoint> legion_path_points;
  ...
  for (auto it_path_points : legion_path_points) {
    ...
    planning_analysis_planning_parking_debug_path_point.x() =
        it_path_points.x();
    planning_analysis_planning_parking_debug_path_point.y() =
        it_path_points.y();
    planning_analysis_planning_parking_debug_path_point.z() =
        it_path_points.z();
    ...
    planning_analysis_planning_parking_debug_path_point.s() =
        it_path_points.s();
    ...
    dds_path_points.emplace_back(
        planning_analysis_planning_parking_debug_path_point);
  }
  planning_analysis_planning_parking_debug.path_points() = dds_path_points;
  ...
  std::vector<ros2_interface::msg::Point2dList> dds_obstacles_vec;
  std::vector<legion::interface::Point2dList> legion_obstacles_vec;
  ...
  for (auto it_obstacles_vec : legion_obstacles_vec) {
    ...
    std::vector<ros2_interface::msg::Point2D> dds_point2d_list;
    std::vector<legion::interface::Point2D> legion_point2d_list;
    ...
    for (auto it_point2d_list : legion_point2d_list) {
      ...
      planning_analysis_planning_parking_debug_point_2d_list_point_2d.y() =
          it_point2d_list.y();
      dds_point2d_list.emplace_back(
          planning_analysis_planning_parking_debug_point_2d_list_point_2d);
    }
    planning_analysis_planning_parking_debug_point_2d_list.point2d_list() =
        dds_point2d_list;
    dds_obstacles_vec.emplace_back(
        planning_analysis_planning_parking_debug_point_2d_list);
  }
  planning_analysis_planning_parking_debug.obstacles_vec() = dds_obstacles_vec;
  std::vector<ros2_interface::msg::TrajectoryPoint> dds_warm_start_traj;
  std::vector<legion::interface::TrajectoryPoint> legion_warm_start_traj;
  ...
  for (auto it_warm_start_traj : legion_warm_start_traj) {
    ...
    planning_analysis_planning_parking_debug_trajectory_point_path_point
        .theta() = it_warm_start_traj.path_point().theta();
    planning_analysis_planning_parking_debug_trajectory_point_path_point
        .kappa() = it_warm_start_traj.path_point().kappa();
    ...
    dds_warm_start_traj.emplace_back(
        planning_analysis_planning_parking_debug_trajectory_point);
  }
  planning_analysis_planning_parking_debug.warm_start_traj() =
      dds_warm_start_traj;
  std::vector<ros2_interface::msg::TrajectoryPoint> dds_smoothed_traj_stage1;
  std::vector<legion::interface::TrajectoryPoint> legion_smoothed_traj_stage1;
  msg.planning_parking_debug().smoothed_traj_stage1(legion_smoothed_traj_stage1);
  for (auto it_smoothed_traj_stage1 : legion_smoothed_traj_stage1) {
    ...
    planning_analysis_planning_parking_debug_trajectory_point_path_point
        .theta() = it_smoothed_traj_stage1.path_point().theta();
    planning_analysis_planning_parking_debug_trajectory_point_path_point
        .kappa() = it_smoothed_traj_stage1.path_point().kappa();
    planning_analysis_planning_parking_debug_trajectory_point_path_point.s() =
    ...
    dds_smoothed_traj_stage1.emplace_back(
        planning_analysis_planning_parking_debug_trajectory_point);
  }
  planning_analysis_planning_parking_debug.smoothed_traj_stage1() =
      dds_smoothed_traj_stage1;
  std::vector<ros2_interface::msg::TrajectoryPoint> dds_smoothed_traj_stage2;
  std::vector<legion::interface::TrajectoryPoint> legion_smoothed_traj_stage2;
  msg.planning_parking_debug().smoothed_traj_stage2(legion_smoothed_traj_stage2);
  for (auto it_smoothed_traj_stage2 : legion_smoothed_traj_stage2) {
    ...
    planning_analysis_planning_parking_debug_trajectory_point_path_point
        .theta() = it_smoothed_traj_stage2.path_point().theta();
    planning_analysis_planning_parking_debug_trajectory_point_path_point
        .kappa() = it_smoothed_traj_stage2.path_point().kappa();
    planning_analysis_planning_parking_debug_trajectory_point_path_point.s() =
    ...
    dds_smoothed_traj_stage2.emplace_back(
        planning_analysis_planning_parking_debug_trajectory_point);
  }
  planning_analysis_planning_parking_debug.smoothed_traj_stage2() =
      dds_smoothed_traj_stage2;
  ...
  for (auto it_trajectory_points : legion_trajectory_points) {
    ...
    dds_trajectory_points.emplace_back(
        planning_analysis_planning_parking_debug_reference_line_trajectory_point);
  }
  planning_analysis_planning_parking_debug_reference_line.trajectory_points() =
      dds_trajectory_points;
  planning_analysis_planning_parking_debug.reference_line() =
      planning_analysis_planning_parking_debug_reference_line;
  std::vector<ros2_interface::msg::Trajectory> dds_trajectory_array;
  std::vector<legion::interface::Trajectory> legion_trajectory_array;
  ...
  for (auto it_trajectory_array : legion_trajectory_array) {
    ...
    std::vector<ros2_interface::msg::TrajectoryPoint> dds_trajectory_points_1;
    std::vector<legion::interface::TrajectoryPoint> legion_trajectory_points_1;
  ...
  std::vector<ros2_interface::msg::TrajectoryPoint> dds_trajectory_points_2;
  std::vector<legion::interface::TrajectoryPoint> legion_trajectory_points_2;
  ...
  for (auto it_trajectory_points_2 : legion_trajectory_points_2) {
    ...
    dds_trajectory_points_2.emplace_back(
        planning_analysis_planning_parking_debug_optimal_coarse_trajectory_trajectory_point);
  }
  planning_analysis_planning_parking_debug_optimal_coarse_trajectory
      .trajectory_points() = dds_trajectory_points_2;
  ...
  std::vector<ros2_interface::msg::TrajectoryPoint> dds_trajectory_points_3;
  std::vector<legion::interface::TrajectoryPoint> legion_trajectory_points_3;
  ...
  for (auto it_trajectory_points_3 : legion_trajectory_points_3) {
    ...
    dds_trajectory_points_3.emplace_back(
        planning_analysis_planning_parking_debug_optimal_smooth_trajectory_trajectory_point);
  }
  planning_analysis_planning_parking_debug_optimal_smooth_trajectory
      .trajectory_points() = dds_trajectory_points_3;
  ...
  planning_analysis_writer_->write(&planning_analysis);
}

template <typename T>
void DdsMessageManager<T>::PublishParkingStateDisplay(
    legion::interface::ParkingStateDisplay msg) {
  if (is_init_ == false)
    return;
  ros2_interface::msg::ParkingStateDisplay parking_state_display;
  MESSAGE_DDS_HEADER_ASSIGN(ros2_interface::msg, parking_state_display)
  ...
  parking_state_display_writer_->write(&parking_state_display);
}

template <typename T>
void DdsMessageManager<T>::PublishTrajectoryArray(
    legion::interface::TrajectoryArray msg) {
  if (is_init_ == false)
    return;
  ros2_interface::msg::TrajectoryArray trajectory_array;
  MESSAGE_DDS_HEADER_ASSIGN(ros2_interface::msg, trajectory_array)
  std::vector<ros2_interface::msg::Path> dds_spline_s;
  std::vector<legion::interface::Path> legion_spline_s;
  msg.spline_s(legion_spline_s);
  for (auto it_spline_s : legion_spline_s) {
    ros2_interface::msg::Path trajectory_array_path;
    trajectory_array_path.name() = it_spline_s.name();
    std::vector<ros2_interface::msg::PathPoint> dds_path_points;
    std::vector<legion::interface::PathPoint> legion_path_points;
    it_spline_s.path_points(legion_path_points);
    for (auto it_path_points : legion_path_points) {
      ros2_interface::msg::PathPoint trajectory_array_path_path_point;
      ...
      trajectory_array_path_path_point.y_derivative() =
          it_path_points.y_derivative();
      dds_path_points.emplace_back(trajectory_array_path_path_point);
    }
    trajectory_array_path.path_points() = dds_path_points;
    dds_spline_s.emplace_back(trajectory_array_path);
  }
  trajectory_array.spline_s() = dds_spline_s;
  std::vector<ros2_interface::msg::Path> dds_qp_smooth;
  std::vector<legion::interface::Path> legion_qp_smooth;
  msg.qp_smooth(legion_qp_smooth);
  for (auto it_qp_smooth : legion_qp_smooth) {
    ros2_interface::msg::Path trajectory_array_path;
    trajectory_array_path.name() = it_qp_smooth.name();
    std::vector<ros2_interface::msg::PathPoint> dds_path_points_1;
    std::vector<legion::interface::PathPoint> legion_path_points_1;
    ...
    for (auto it_path_points_1 : legion_path_points_1) {
      ...
      dds_path_points_1.emplace_back(trajectory_array_path_path_point);
    }
    trajectory_array_path.path_points() = dds_path_points_1;
    dds_qp_smooth.emplace_back(trajectory_array_path);
  }
  trajectory_array.qp_smooth() = dds_qp_smooth;
  std::vector<ros2_interface::msg::Trajectory> dds_trajectory_list;
  std::vector<legion::interface::Trajectory> legion_trajectory_list;
  msg.trajectory_list(legion_trajectory_list);
  for (auto it_trajectory_list : legion_trajectory_list) {
    ros2_interface::msg::Trajectory trajectory_array_trajectory;
    ...
    for (auto it_trajectory_points : legion_trajectory_points) {
      ...
      trajectory_array_trajectory_trajectory_point.path_point() =
          trajectory_array_trajectory_trajectory_point_path_point;
      trajectory_array_trajectory_trajectory_point.v() =
          it_trajectory_points.v();
      trajectory_array_trajectory_trajectory_point.a() =
    ...
    trajectory_array_trajectory.trajectory_points() = dds_trajectory_points;
    dds_trajectory_list.emplace_back(trajectory_array_trajectory);
  }
  trajectory_array.trajectory_list() = dds_trajectory_list;

  trajectory_array_writer_->write(&trajectory_array);
}
...
template <typename T>
void DdsMessageManager<T>::PublishEvents(legion::interface::Events msg) {
  if (is_init_ == false)
    return;
  ...
  std::vector<legion::interface::Event> legion_events_vector;
...
template <typename T>
void DdsMessageManager<T>::HandleRoutingResponseMessage(
    const ros2_interface::msg::RoutingResponse *msg) {
  legion::interface::RoutingResponse routing_response;
  MESSAGE_DDS_HEADER_PARSER(routing_response)
  routing_response.set_plan_status(
      (legion::interface::RoutingResponse::PlanStatus)msg->plan_status());
  routing_response.set_replan_flag(
      (legion::interface::RoutingResponse::ReplanFlag)msg->replan_flag());
  routing_response.set_route_reason(
      (legion::interface::RoutingResponse::RouteReason)msg->route_reason());
  std::vector<legion::interface::LaneInfo> lane_list;
  for (auto it_lane_list : msg->lane_list()) {
    legion::interface::LaneInfo routing_response_lane_info;
    ...
    routing_response_lane_info.set_predecessor_id(
        it_lane_list.predecessor_id());
    routing_response_lane_info.set_successor_id(it_lane_list.successor_id());
    routing_response_lane_info.set_left_neighbor_id(
        it_lane_list.left_neighbor_id());
    routing_response_lane_info.set_right_neighbor_id(
        it_lane_list.right_neighbor_id());
    routing_response_lane_info.set_type(it_lane_list.type());
    std::vector<legion::interface::LanePoint> lane_points;
    for (auto it_lane_points : it_lane_list.lane_points()) {
      legion::interface::LanePoint routing_response_lane_info_lane_point;
      legion::interface::Point3D routing_response_lane_info_lane_point_point;
      routing_response_lane_info_lane_point_point.set_x(
          it_lane_points.point().x());
      routing_response_lane_info_lane_point_point.set_y(
          it_lane_points.point().y());
      routing_response_lane_info_lane_point_point.set_z(
      ...
      routing_response_lane_info_lane_point.set_mileage(
      ...
      routing_response_lane_info_lane_point.set_left_line_type(
          (legion::common::LaneLineType)it_lane_points.left_line_type());
      routing_response_lane_info_lane_point.set_right_line_type(
          (legion::common::LaneLineType)it_lane_points.right_line_type());
...
template <typename T>
void DdsMessageManager<T>::HandleLocalRoutingResponseMessage(
    const ros2_interface::msg::RoutingResponse *msg) {
  legion::interface::RoutingResponse routing_response;
  MESSAGE_DDS_HEADER_PARSER(routing_response)
  routing_response.set_plan_status(
...
template <typename T>
void DdsMessageManager<T>::HandleParkingInfoMessage(
    const ros2_interface::msg::ParkingInfo *msg) {
  legion::interface::ParkingInfo parking_info;
  MESSAGE_DDS_HEADER_PARSER(parking_info)
  parking_info.set_parking_space_id(msg->parking_space_id());
  parking_info.set_parking_type(
      (legion::common::ParkingType)msg->parking_type());
  parking_info.set_parking_status(
      (legion::common::ParkingStatus)msg->parking_status());
  parking_info.set_confidence(msg->confidence());
  legion::interface::Point3D parking_info_center_point_of_parking;
  parking_info_center_point_of_parking.set_x(
      msg->center_point_of_parking().x());
  parking_info_center_point_of_parking.set_y(
      msg->center_point_of_parking().y());
  parking_info_center_point_of_parking.set_z(
      msg->center_point_of_parking().z());
  ...
  legion::interface::Polygon3D parking_info_polygon;
  parking_info_polygon.set_coordinate_system(
      (legion::common::CoordinateSystem)msg->polygon().coordinate_system());
  std::vector<legion::interface::Point3D> points;
  for (auto it_points : msg->polygon().points()) {
    legion::interface::Point3D parking_info_polygon_point_3d;
  ...
  parking_info.set_sensor_id((legion::common::SensorID)msg->sensor_id());
  parking_info.set_is_lane_width_valid(msg->is_lane_width_valid());
  parking_info.set_lane_width(msg->lane_width());
  std::vector<legion::interface::ParkingStopper> parking_stoppers;
  for (auto it_parking_stoppers : msg->parking_stoppers()) {
    legion::interface::ParkingStopper parking_info_parking_stopper;
    MESSAGE_DDS_HEADER_PARSER(parking_info_parking_stopper)
    legion::interface::Point3D parking_info_parking_stopper_center_point_vehicle;
    ...
    legion::interface::Point3D parking_info_parking_stopper_center_point_abs;
    ...
    for (auto it_stopper_points_vehicle :
      ...
      legion::interface::Point3D parking_info_parking_stopper_point_3d;
      parking_info_parking_stopper_point_3d.set_x(
          it_stopper_points_vehicle.x());
      parking_info_parking_stopper_point_3d.set_y(
          it_stopper_points_vehicle.y());
      parking_info_parking_stopper_point_3d.set_z(
          it_stopper_points_vehicle.z());
    ...
    for (auto it_stopper_points_abs :
         it_parking_stoppers.stopper_points_abs()) {
      legion::interface::Point3D parking_info_parking_stopper_point_3d;
  ...
  parking_info.set_parking_direction_type(
      (legion::common::Direction)msg->parking_direction_type());
  parking_info.set_left_occupied_status(
      (legion::common::OccupiedStatus)msg->left_occupied_status());
  parking_info.set_right_occupied_status(
      (legion::common::OccupiedStatus)msg->right_occupied_status());
  parking_info.set_parking_source_type(
      (legion::common::ParkingSourceType)msg->parking_source_type());

  instance_->HandleParkingInfo(parking_info);
}

template <typename T>
void DdsMessageManager<T>::HandleStopInfoMessage(
    const ros2_interface::msg::StopInfo *msg) {
  legion::interface::StopInfo stop_info;
  MESSAGE_DDS_HEADER_PARSER(stop_info)
  std::vector<legion::interface::StopPoint> stop_points;
  for (auto it_stop_points : msg->stop_points()) {
    legion::interface::StopPoint stop_info_stop_point;
    legion::interface::Point3D stop_info_stop_point_point;
...
void DdsMessageManager<T>::HandleTrafficLightMsgMessage(
  ...
  legion::interface::TrafficLightMsg traffic_light_msg;
  ...
  for (auto it_traffic_light : msg->traffic_light()) {
    legion::interface::TrafficLight traffic_light_msg_traffic_light;
    traffic_light_msg_traffic_light.set_color(
        (legion::common::TrafficLightColor)it_traffic_light.color());
    traffic_light_msg_traffic_light.set_id(it_traffic_light.id());
    traffic_light_msg_traffic_light.set_type(
        (legion::common::TrafficLightType)it_traffic_light.type());
    traffic_light_msg_traffic_light.set_confidence(
        it_traffic_light.confidence());
    legion::interface::ImageRect traffic_light_msg_traffic_light_light_rect;
    ...
    legion::interface::Point3D traffic_light_msg_traffic_light_position;
    ...
    legion::interface::Time traffic_light_msg_traffic_light_create_time;
  ...
  legion::interface::TrafficLightDebug traffic_light_msg_traffic_light_debug;
  legion::interface::TrafficLightBox
  ...
  traffic_light_msg_traffic_light_debug_cropbox.set_color(
      (legion::common::TrafficLightColor)msg->traffic_light_debug()
          .cropbox()
          .color());
  ...
  traffic_light_msg_traffic_light_debug.set_cropbox(
      traffic_light_msg_traffic_light_debug_cropbox);
  std::vector<legion::interface::TrafficLightBox> box;
  for (auto it_box : msg->traffic_light_debug().box()) {
    ...
    traffic_light_msg_traffic_light_debug_traffic_light_box.set_color(
        (legion::common::TrafficLightColor)it_box.color());
  ...
  std::vector<legion::interface::TrafficLightBox> crop_roi;
  for (auto it_crop_roi : msg->traffic_light_debug().crop_roi()) {
    ...
    traffic_light_msg_traffic_light_debug_traffic_light_box.set_height(
        it_crop_roi.height());
    traffic_light_msg_traffic_light_debug_traffic_light_box.set_color(
        (legion::common::TrafficLightColor)it_crop_roi.color());
    traffic_light_msg_traffic_light_debug_traffic_light_box.set_selected(
  ...
  std::vector<legion::interface::TrafficLightBox> projected_roi;
  for (auto it_projected_roi : msg->traffic_light_debug().projected_roi()) {
    ...
    traffic_light_msg_traffic_light_debug_traffic_light_box.set_color(
        (legion::common::TrafficLightColor)it_projected_roi.color());
    traffic_light_msg_traffic_light_debug_traffic_light_box.set_selected(
  ...
  std::vector<legion::interface::TrafficLightBox> rectified_roi;
  for (auto it_rectified_roi : msg->traffic_light_debug().rectified_roi()) {
    ...
    traffic_light_msg_traffic_light_debug_traffic_light_box.set_color(
        (legion::common::TrafficLightColor)it_rectified_roi.color());
    traffic_light_msg_traffic_light_debug_traffic_light_box.set_selected(
  ...
  std::vector<legion::interface::TrafficLightBox> debug_roi;
  for (auto it_debug_roi : msg->traffic_light_debug().debug_roi()) {
    ...
    traffic_light_msg_traffic_light_debug_traffic_light_box.set_height(
        it_debug_roi.height());
    traffic_light_msg_traffic_light_debug_traffic_light_box.set_color(
        (legion::common::TrafficLightColor)it_debug_roi.color());
    traffic_light_msg_traffic_light_debug_traffic_light_box.set_selected(
  ...
  traffic_light_msg.set_camera_id(
      (legion::interface::TrafficLightMsg::CameraID)msg->camera_id());
...
void DdsMessageManager<T>::HandleLocationMessage(
  ...
  location.set_odom_type(
      (legion::interface::Location::OdomType)msg->odom_type());
...
template <typename T>
void DdsMessageManager<T>::HandlePredictionObstaclesMessage(
    const ros2_interface::msg::PredictionObstacles *msg) {
  legion::interface::PredictionObstacles prediction_obstacles;
  MESSAGE_DDS_HEADER_PARSER(prediction_obstacles)
  std::vector<legion::interface::PredictionObstacle> prediction_obstacles_vector;
  for (auto it_prediction_obstacles_vector : msg->prediction_obstacles()) {
    legion::interface::PredictionObstacle
        prediction_obstacles_prediction_obstacle;
    legion::interface::PerceptionObstacle
    ...
    std::vector<legion::interface::Point3D> polygon_point;
    ...
    prediction_obstacles_prediction_obstacle_perception_obstacle
        .set_tracking_time(it_prediction_obstacles_vector.perception_obstacle()
                               .tracking_time());
    prediction_obstacles_prediction_obstacle_perception_obstacle.set_type(
        (legion::common::ObstacleType)it_prediction_obstacles_vector
            .perception_obstacle()
            .type());
    prediction_obstacles_prediction_obstacle_perception_obstacle
        .set_lane_position(
            (legion::common::LanePosition)it_prediction_obstacles_vector
                .perception_obstacle()
                .lane_position());
    ...
    prediction_obstacles_prediction_obstacle_perception_obstacle_acceleration
        .set_x(it_prediction_obstacles_vector.perception_obstacle()
                   .acceleration()
                   .x());
    prediction_obstacles_prediction_obstacle_perception_obstacle_acceleration
        .set_y(it_prediction_obstacles_vector.perception_obstacle()
                   .acceleration()
                   .y());
    prediction_obstacles_prediction_obstacle_perception_obstacle_acceleration
        .set_z(it_prediction_obstacles_vector.perception_obstacle()
                   .acceleration()
                   .z());
    ...
    prediction_obstacles_prediction_obstacle_perception_obstacle.set_anchor_point(
        prediction_obstacles_prediction_obstacle_perception_obstacle_anchor_point);
    std::vector<legion::interface::Point3D> bounding_box;
    ...
    prediction_obstacles_prediction_obstacle_perception_obstacle.set_sub_type(
        (legion::common::ObstacleSubType)it_prediction_obstacles_vector
            .perception_obstacle()
            .sub_type());
    prediction_obstacles_prediction_obstacle_perception_obstacle
        .set_height_above_ground(
            it_prediction_obstacles_vector.perception_obstacle()
                .height_above_ground());
    ...
    prediction_obstacles_prediction_obstacle_perception_obstacle
        .set_light_status(it_prediction_obstacles_vector.perception_obstacle()
                              .light_status());
    ...
    std::vector<legion::interface::TrajectoryInPrediction> trajectory;
    for (auto it_trajectory : it_prediction_obstacles_vector.trajectory()) {
      legion::interface::TrajectoryInPrediction
      ...
      for (auto it_trajectory_points : it_trajectory.trajectory_points()) {
        legion::interface::TrajectoryPoint
        ...
        prediction_obstacles_prediction_obstacle_trajectory_in_prediction_trajectory_point
            .set_gear((legion::common::GearPosition)it_trajectory_points.gear());
  ...
  prediction_obstacles.set_self_intent(
      (legion::interface::PredictionObstacles::SelfIntent)msg->self_intent());
  prediction_obstacles.set_scenario(
      (legion::interface::ADCTrajectory::Scenario)msg->scenario());

  instance_->HandlePredictionObstacles(prediction_obstacles);
}

template <typename T>
void DdsMessageManager<T>::HandleLaneListMessage(
    const ros2_interface::msg::LaneList *msg) {
  legion::interface::LaneList lane_list;
  MESSAGE_DDS_HEADER_PARSER(lane_list)
  lane_list.set_sensor_id((legion::common::SensorID)msg->sensor_id());
  ...
  legion::interface::SensorCalibrator lane_list_sensor_calibrator;
  legion::interface::Point3D lane_list_sensor_calibrator_pose;
  ...
  legion::interface::Point3D lane_list_sensor_calibrator_angle;
  ...
  std::vector<legion::interface::LaneLine> camera_laneline;
  for (auto it_camera_laneline : msg->camera_laneline()) {
    legion::interface::LaneLine lane_list_lane_line;
    lane_list_lane_line.set_lane_type(
        (legion::interface::LaneLine::LaneType)it_camera_laneline.lane_type());
    lane_list_lane_line.set_lane_color(
        (legion::interface::LaneLine::LaneColor)it_camera_laneline.lane_color());
    lane_list_lane_line.set_pos_type(
        (legion::interface::LaneLine::PosType)it_camera_laneline.pos_type());
    legion::interface::LaneLineCubicCurve lane_list_lane_line_curve_vehicle;
    ...
    lane_list_lane_line_curve_vehicle.set_a(
        it_camera_laneline.curve_vehicle().a());
    lane_list_lane_line_curve_vehicle.set_b(
        it_camera_laneline.curve_vehicle().b());
    lane_list_lane_line_curve_vehicle.set_c(
        it_camera_laneline.curve_vehicle().c());
    lane_list_lane_line_curve_vehicle.set_d(
        it_camera_laneline.curve_vehicle().d());
    lane_list_lane_line.set_curve_vehicle(lane_list_lane_line_curve_vehicle);
    legion::interface::LaneLineCubicCurve lane_list_lane_line_curve_image;
    ...
    legion::interface::LaneLineCubicCurve lane_list_lane_line_curve_abs;
    lane_list_lane_line_curve_abs.set_start_x(
        it_camera_laneline.curve_abs().start_x());
    lane_list_lane_line_curve_abs.set_end_x(
        it_camera_laneline.curve_abs().end_x());
    ...
    std::vector<legion::interface::Point3D> pts_vehicle;
    for (auto it_pts_vehicle : it_camera_laneline.pts_vehicle()) {
      legion::interface::Point3D lane_list_lane_line_point_3d;
    ...
    std::vector<legion::interface::Point2D> pts_image;
    for (auto it_pts_image : it_camera_laneline.pts_image()) {
      legion::interface::Point2D lane_list_lane_line_point_2d;
    ...
    std::vector<legion::interface::Point3D> pts_abs;
    ...
    legion::interface::EndPoints lane_list_lane_line_image_end_point;
    legion::interface::Point2D lane_list_lane_line_image_end_point_start;
    ...
    legion::interface::Point2D lane_list_lane_line_image_end_point_end;
    ...
    std::vector<legion::interface::Point2D> pts_key;
    ...
    lane_list_lane_line.set_lane_quality(
        (legion::interface::LaneLine::LaneQuality)
            it_camera_laneline.lane_quality());
    lane_list_lane_line.set_fused_lane_type(
        (legion::interface::LaneLine::FusedLaneType)
    ...
    lane_list_lane_line.set_lane_coordinate_type(
        (legion::interface::LaneLine::LaneCoordinateType)
            it_camera_laneline.lane_coordinate_type());
    lane_list_lane_line.set_use_type(
        (legion::interface::LaneLine::UseType)it_camera_laneline.use_type());
    legion::interface::Time lane_list_lane_line_create_time;
    lane_list_lane_line_create_time.set_sec(
        it_camera_laneline.create_time().sec());
  ...
  legion::interface::HolisticPathPrediction lane_list_hpp;
  legion::interface::LaneLineCubicCurve lane_list_hpp_hpp;
  ...
  lane_list_hpp.set_planning_source(
      (legion::interface::HolisticPathPrediction::PlanningSource)msg->hpp()
          .planning_source());
  ...
  std::vector<legion::interface::RoadMark> road_marks;
  for (auto it_road_marks : msg->road_marks()) {
    legion::interface::RoadMark lane_list_road_mark;
    ...
    lane_list_road_mark.set_type(
        (legion::common::RoadMarkType)it_road_marks.type());
...
void DdsMessageManager<T>::HandleChassisMessage(
  ...
  std::vector<legion::interface::Chassis::ErrorCode> chassis_error_code;
  for (auto it_chassis_error_code : msg->chassis_error_code()) {
    legion::interface::Chassis::ErrorCode error_code;
    error_code = (legion::interface::Chassis::ErrorCode)it_chassis_error_code;
...
template <typename T>
void DdsMessageManager<T>::HandleSotifMonitorResultMessage(
    const ros2_interface::msg::SotifMonitorResult *msg) {
  legion::interface::SotifMonitorResult sotif_monitor_result;
  MESSAGE_DDS_HEADER_PARSER(sotif_monitor_result)
  std::vector<legion::interface::Region> region_value;
  for (auto it_region_value : msg->region_value()) {
    legion::interface::Region sotif_monitor_result_region;
    sotif_monitor_result_region.set_name_region(
        (legion::interface::Region::RegionID)it_region_value.name_region());
    sotif_monitor_result_region.set_score(it_region_value.score());
    sotif_monitor_result_region.set_rank_risk(
        (legion::interface::Region::RankRisk)it_region_value.rank_risk());
    std::vector<legion::interface::Point3D> region_polygon;
    for (auto it_region_polygon : it_region_value.region_polygon()) {
      legion::interface::Point3D sotif_monitor_result_region_point_3d;
  ...
  std::vector<legion::interface::Grid> grid_map;
  for (auto it_grid_map : msg->grid_map()) {
    legion::interface::Grid sotif_monitor_result_grid;
    sotif_monitor_result_grid.set_x(it_grid_map.x());
    sotif_monitor_result_grid.set_y(it_grid_map.y());
    legion::interface::SLPoint sotif_monitor_result_grid_sl_point;
    ...
    sotif_monitor_result_grid.set_region_id(
        (legion::interface::Region::RegionID)it_grid_map.region_id());
...
template <typename T>
void DdsMessageManager<T>::HandleDrivableRegionMessage(
    const ros2_interface::msg::DrivableRegion *msg) {
  legion::interface::DrivableRegion drivable_region;
  MESSAGE_DDS_HEADER_PARSER(drivable_region)
  std::vector<legion::interface::Polygon3D> drivable_region_vector;
  for (auto it_drivable_region_vector : msg->drivable_region()) {
    legion::interface::Polygon3D drivable_region_polygon_3d;
    drivable_region_polygon_3d.set_coordinate_system(
        (legion::common::CoordinateSystem)
            it_drivable_region_vector.coordinate_system());
    std::vector<legion::interface::Point3D> points;
    for (auto it_points : it_drivable_region_vector.points()) {
      legion::interface::Point3D drivable_region_polygon_3d_point_3d;
...
template <typename T>
void DdsMessageManager<T>::HandleParkingOutInfoMessage(
    const ros2_interface::msg::ParkingOutInfo *msg) {
  legion::interface::ParkingOutInfo parking_out_info;
  MESSAGE_DDS_HEADER_PARSER(parking_out_info)
  ...
  legion::interface::Point3D parking_out_info_parking_out_point;
...
template <typename T>
void DdsMessageManager<T>::HandleGuideInfoMessage(
    const ros2_interface::msg::GuideInfo *msg) {
  legion::interface::GuideInfo guide_info;
  MESSAGE_DDS_HEADER_PARSER(guide_info)
  guide_info.set_next_dis(msg->next_dis());
  legion::interface::GuideRoad guide_info_current_road;
  ...
  guide_info_current_road.set_avg_curvature(
      msg->current_road().avg_curvature());
//   guide_info_current_road.set_curvature_size(
//       msg->current_road().curvature_size());
  std::vector<legion::interface::CurvatureInfo> curvature;
  for (auto it_curvature : msg->current_road().curvature()) {
    legion::interface::CurvatureInfo guide_info_current_road_curvature_info;
  ...
  legion::interface::GuideRoad guide_info_next_road;
...
//   guide_info_next_road.set_curvature_size(msg->next_road().curvature_size());
  std::vector<legion::interface::CurvatureInfo> curvature_1;
  for (auto it_curvature_1 : msg->next_road().curvature()) {
    legion::interface::CurvatureInfo guide_info_next_road_curvature_info;
...
template <typename T>
void DdsMessageManager<T>::HandleTrafficEventsMessage(
    const ros2_interface::msg::TrafficEvents *msg) {
  legion::interface::TrafficEvents traffic_events;
  MESSAGE_DDS_HEADER_PARSER(traffic_events)
  legion::interface::RouteFusionInfo traffic_events_route_fusion_info;
  traffic_events_route_fusion_info.set_fusion_flag(
      (legion::common::IsValid)msg->route_fusion_info().fusion_flag());
  ...
  legion::interface::JunctionInfo traffic_events_junction_info;
  traffic_events_junction_info.set_id(msg->junction_info().id());
  traffic_events_junction_info.set_light_flag(
      (legion::common::IsValid)msg->junction_info().light_flag());
  traffic_events_junction_info.set_light_color(
      (legion::common::TrafficLightColor)msg->junction_info().light_color());
  ...
  traffic_events_junction_info.set_direction_flag(
      (legion::common::IsValid)msg->junction_info().direction_flag());
  traffic_events_junction_info.set_direction(
      (legion::common::Direction)msg->junction_info().direction());
  traffic_events_junction_info.set_distance_to_junction(
      msg->junction_info().distance_to_junction());
  std::vector<legion::interface::Point3D> stop_line;
  for (auto it_stop_line : msg->junction_info().stop_line()) {
    legion::interface::Point3D traffic_events_junction_info_point_3d;
  ...
  legion::interface::LimitSpeedInfo traffic_events_limit_speed_info;
  traffic_events_limit_speed_info.set_limitspeed_valid_flag(
      (legion::common::IsValid)msg->limit_speed_info().limitspeed_valid_flag());
...
void DdsMessageManager<T>::on_data_available(
  ...
  if (!reader->get_topicdescription()->get_name().compare(
          "rt/routing/RoutingResponse")) {

    ros2_interface::msg::RoutingResponse msg;
    eprosima::fastdds::dds::SampleInfo info;
    if (routing_response_reader_->take_next_sample(&msg, &info) ==
        ReturnCode_t::RETCODE_OK) {
    ...
    ros2_interface::msg::RoutingResponse msg;
    eprosima::fastdds::dds::SampleInfo info;
    if (local_routing_response_reader_->take_next_sample(&msg, &info) ==
        ReturnCode_t::RETCODE_OK) {
      HandleLocalRoutingResponseMessage(&msg);
    }
  } else if (!reader->get_topicdescription()->get_name().compare(
                 "rt/routing/ParkingInfo")) {

    ros2_interface::msg::ParkingInfo msg;
    eprosima::fastdds::dds::SampleInfo info;
    if (parking_info_reader_->take_next_sample(&msg, &info) ==
        ReturnCode_t::RETCODE_OK) {
      HandleParkingInfoMessage(&msg);
    }
  } else if (!reader->get_topicdescription()->get_name().compare(
                 "rt/routing/StopInfo")) {

    ros2_interface::msg::StopInfo msg;
    eprosima::fastdds::dds::SampleInfo info;
    if (stop_info_reader_->take_next_sample(&msg, &info) ==
        ReturnCode_t::RETCODE_OK) {
      HandleStopInfoMessage(&msg);
    }
  } else if (!reader->get_topicdescription()->get_name().compare(
                 "rt/perception/fusion/traffic_sign_fusion/TrafficLightMsg")) {
    ...
    ros2_interface::msg::PredictionObstacles msg;
    eprosima::fastdds::dds::SampleInfo info;
    if (prediction_obstacles_reader_->take_next_sample(&msg, &info) ==
        ReturnCode_t::RETCODE_OK) {
    ...
    ros2_interface::msg::LaneList msg;
    eprosima::fastdds::dds::SampleInfo info;
    if (lane_list_reader_->take_next_sample(&msg, &info) ==
        ReturnCode_t::RETCODE_OK) {
      HandleLaneListMessage(&msg);
    }
  } else if (!reader->get_topicdescription()->get_name().compare(
    ...
    ros2_interface::msg::SotifMonitorResult msg;
    eprosima::fastdds::dds::SampleInfo info;
    if (sotif_monitor_result_reader_->take_next_sample(&msg, &info) ==
        ReturnCode_t::RETCODE_OK) {
      HandleSotifMonitorResultMessage(&msg);
    }
  } else if (!reader->get_topicdescription()->get_name().compare(
                 "rt/perception/fusion/traffic_sign_fusion/DrivableRegion")) {

    ros2_interface::msg::DrivableRegion msg;
    eprosima::fastdds::dds::SampleInfo info;
    if (drivable_region_reader_->take_next_sample(&msg, &info) ==
        ReturnCode_t::RETCODE_OK) {
      HandleDrivableRegionMessage(&msg);
    }
  } else if (!reader->get_topicdescription()->get_name().compare(
                 "rt/avp/parking_out/ParkingOutInfo")) {

    ros2_interface::msg::ParkingOutInfo msg;
    eprosima::fastdds::dds::SampleInfo info;
    if (parking_out_info_reader_->take_next_sample(&msg, &info) ==
        ReturnCode_t::RETCODE_OK) {
      HandleParkingOutInfoMessage(&msg);
    }
  } else if (!reader->get_topicdescription()->get_name().compare(
                 "rt/routing/GuideInfo")) {

    ros2_interface::msg::GuideInfo msg;
    eprosima::fastdds::dds::SampleInfo info;
    if (guide_info_reader_->take_next_sample(&msg, &info) ==
        ReturnCode_t::RETCODE_OK) {
      HandleGuideInfoMessage(&msg);
    }
  } else if (!reader->get_topicdescription()->get_name().compare(
                 "rt/routing/TrafficEvents")) {

    ros2_interface::msg::TrafficEvents msg;
    eprosima::fastdds::dds::SampleInfo info;
    if (traffic_events_reader_->take_next_sample(&msg, &info) ==
        ReturnCode_t::RETCODE_OK) {
      HandleTrafficEventsMessage(&msg);
    }
  }
  return;
}
