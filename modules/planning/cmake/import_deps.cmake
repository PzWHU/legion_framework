...
SET(PROPERTY_FILE "${CMAKE_CURRENT_SOURCE_DIR}/cmake/build.properties.local")
SET(DEBUG_POSTFIX "d")
...
MACRO(INIT_DEPENDENCY_INFO)
  ...
  set(lines "")
  set(THIRD_PARTY_DIR "/usr/local/legion/third_party/pallas")
  GETLINES(lines ${dep_file})
  set(DEPENDENCIES_PATH ${lines})
  foreach (line ${lines})
    set(INCLUDE_SEARCH_PATH "${THIRD_PARTY_DIR}/include/${line}")
    set(LINK_SEARCH_PATH "${THIRD_PARTY_DIR}/lib/${line}")
...
FUNCTION(INSTALL_DEPENDENCY _NAME)
  foreach(line ${DEPENDENCIES_PATH})
    if (${line} MATCHES ${_NAME})
      if (MSVC)
        install(DIRECTORY ${THIRD_PARTY_DIR}/lib/${line}/ DESTINATION bin)
      else()
        install(DIRECTORY ${THIRD_PARTY_DIR}/lib/${line}/ DESTINATION lib)
      endif()
