...
{
  new (message_memory) ros2_interface::msg::Message(_init);
}

void Message_fini_function(void * message_memory)
{
  auto typed_message = static_cast<ros2_interface::msg::Message *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Message_message_member_array[2] = {
  {
    ...
    offsetof(ros2_interface::msg::Message, code),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(ros2_interface::msg::Message, value),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers Message_message_members = {
  ...
  2,  // number of fields
  sizeof(ros2_interface::msg::Message),
...
get_message_type_support_handle<ros2_interface::msg::Message>()
{
  return &::ros2_interface::msg::rosidl_typesupport_introspection_cpp::Message_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, ros2_interface, msg, Message)() {
  return &::ros2_interface::msg::rosidl_typesupport_introspection_cpp::Message_message_type_support_handle;
}
