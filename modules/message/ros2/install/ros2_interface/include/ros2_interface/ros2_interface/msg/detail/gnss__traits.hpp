...
#ifndef ROS2_INTERFACE__MSG__DETAIL__GNSS__TRAITS_HPP_
#define ROS2_INTERFACE__MSG__DETAIL__GNSS__TRAITS_HPP_
  ...
  std::ostream & out)
{
  ...
  {
    out << "utm_zone_num: ";
    rosidl_generator_traits::value_to_yaml(msg.utm_zone_num, out);
    out << ", ";
  }
...
inline void to_yaml(
  const ros2_interface::msg::Gnss & msg,
  std::ostream & out, size_t indentation = 0)
{
...
inline std::string to_yaml(const ros2_interface::msg::Gnss & msg)
{
  return ros2_interface::msg::to_yaml(msg);
}

template<>
inline const char * data_type<ros2_interface::msg::Gnss>()
{
  return "ros2_interface::msg::Gnss";
}

template<>
inline const char * name<ros2_interface::msg::Gnss>()
{
  return "ros2_interface/msg/Gnss";
}

template<>
struct has_fixed_size<ros2_interface::msg::Gnss>
  : std::integral_constant<bool, has_fixed_size<ros2_interface::msg::Point3D>::value && has_fixed_size<std_msgs::msg::Header>::value> {};

template<>
struct has_bounded_size<ros2_interface::msg::Gnss>
  : std::integral_constant<bool, has_bounded_size<ros2_interface::msg::Point3D>::value && has_bounded_size<std_msgs::msg::Header>::value> {};

template<>
struct is_message<ros2_interface::msg::Gnss>
  : std::true_type {};

}  // namespace rosidl_generator_traits

#endif  // ROS2_INTERFACE__MSG__DETAIL__GNSS__TRAITS_HPP_
