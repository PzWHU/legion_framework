...
{
  new (message_memory) ros2_interface::msg::Twist(_init);
}

void Twist_fini_function(void * message_memory)
{
  auto typed_message = static_cast<ros2_interface::msg::Twist *>(message_memory);
  typed_message->~Twist();
}

static const ::rosidl_typesupport_introspection_cpp::MessageMember Twist_message_member_array[3] = {
  {
    "header",  // name
    ...
    offsetof(ros2_interface::msg::Twist, header),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(ros2_interface::msg::Twist, linear),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(ros2_interface::msg::Twist, angular),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers Twist_message_members = {
  ...
  "Twist",  // message name
  3,  // number of fields
  sizeof(ros2_interface::msg::Twist),
...
get_message_type_support_handle<ros2_interface::msg::Twist>()
{
  return &::ros2_interface::msg::rosidl_typesupport_introspection_cpp::Twist_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, ros2_interface, msg, Twist)() {
  return &::ros2_interface::msg::rosidl_typesupport_introspection_cpp::Twist_message_type_support_handle;
}
