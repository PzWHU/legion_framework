...
ros2_interface__msg__ObuCmd__create()
{
  ...
  ros2_interface__msg__ObuCmd * msg = (ros2_interface__msg__ObuCmd *)allocator.allocate(sizeof(ros2_interface__msg__ObuCmd), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(ros2_interface__msg__ObuCmd));
  bool success = ros2_interface__msg__ObuCmd__init(msg);
  if (!success) {
...
ros2_interface__msg__ObuCmd__destroy(ros2_interface__msg__ObuCmd * msg)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (msg) {
    ros2_interface__msg__ObuCmd__fini(msg);
  }
  allocator.deallocate(msg, allocator.state);
}
...
ros2_interface__msg__ObuCmd__Sequence__init(ros2_interface__msg__ObuCmd__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  ros2_interface__msg__ObuCmd * data = NULL;

  if (size) {
    data = (ros2_interface__msg__ObuCmd *)allocator.zero_allocate(size, sizeof(ros2_interface__msg__ObuCmd), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = ros2_interface__msg__ObuCmd__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        ros2_interface__msg__ObuCmd__fini(&data[i - 1]);
      }
...
ros2_interface__msg__ObuCmd__Sequence__fini(ros2_interface__msg__ObuCmd__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      ros2_interface__msg__ObuCmd__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  ros2_interface__msg__ObuCmd__Sequence * array = (ros2_interface__msg__ObuCmd__Sequence *)allocator.allocate(sizeof(ros2_interface__msg__ObuCmd__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = ros2_interface__msg__ObuCmd__Sequence__init(array, size);
  if (!success) {
...
ros2_interface__msg__ObuCmd__Sequence__destroy(ros2_interface__msg__ObuCmd__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    ros2_interface__msg__ObuCmd__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
ros2_interface__msg__ObuCmd__Sequence__are_equal(const ros2_interface__msg__ObuCmd__Sequence * lhs, const ros2_interface__msg__ObuCmd__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!ros2_interface__msg__ObuCmd__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  ros2_interface__msg__ObuCmd__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(ros2_interface__msg__ObuCmd);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    ros2_interface__msg__ObuCmd * data =
      (ros2_interface__msg__ObuCmd *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!ros2_interface__msg__ObuCmd__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          ros2_interface__msg__ObuCmd__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!ros2_interface__msg__ObuCmd__copy(
