...
#ifndef ROS2_INTERFACE__MSG__DETAIL__GNSS__STRUCT_HPP_
#define ROS2_INTERFACE__MSG__DETAIL__GNSS__STRUCT_HPP_
...
#ifndef _WIN32
# define DEPRECATED__ros2_interface__msg__Gnss __attribute__((deprecated))
#else
# define DEPRECATED__ros2_interface__msg__Gnss __declspec(deprecated)
#endif
...
struct Gnss_
{
  ...
  Type & set__utm_zone_num(
    const int32_t & _arg)
  {
    this->utm_zone_num = _arg;
    return *this;
  }
  ...
  // pointer types
  using RawPtr =
    ros2_interface::msg::Gnss_<ContainerAllocator> *;
  using ConstRawPtr =
    const ros2_interface::msg::Gnss_<ContainerAllocator> *;
  using SharedPtr =
    std::shared_ptr<ros2_interface::msg::Gnss_<ContainerAllocator>>;
  using ConstSharedPtr =
    std::shared_ptr<ros2_interface::msg::Gnss_<ContainerAllocator> const>;

  template<typename Deleter = std::default_delete<
      ros2_interface::msg::Gnss_<ContainerAllocator>>>
  using UniquePtrWithDeleter =
    std::unique_ptr<ros2_interface::msg::Gnss_<ContainerAllocator>, Deleter>;
  ...
  using ConstUniquePtrWithDeleter =
    std::unique_ptr<ros2_interface::msg::Gnss_<ContainerAllocator> const, Deleter>;
  using ConstUniquePtr = ConstUniquePtrWithDeleter<>;

  using WeakPtr =
    std::weak_ptr<ros2_interface::msg::Gnss_<ContainerAllocator>>;
  using ConstWeakPtr =
    std::weak_ptr<ros2_interface::msg::Gnss_<ContainerAllocator> const>;

  // pointer types similar to ROS 1, use SharedPtr / ConstSharedPtr instead
  // NOTE: Can't use 'using' here because GNU C++ can't parse attributes properly
  typedef DEPRECATED__ros2_interface__msg__Gnss
    std::shared_ptr<ros2_interface::msg::Gnss_<ContainerAllocator>>
    Ptr;
  typedef DEPRECATED__ros2_interface__msg__Gnss
    std::shared_ptr<ros2_interface::msg::Gnss_<ContainerAllocator> const>
  ...
  bool operator==(const Gnss_ & other) const
  {
    ...
    if (this->utm_zone_num != other.utm_zone_num) {
      return false;
    }
...
using Gnss =
  ros2_interface::msg::Gnss_<std::allocator<void>>;
...
#endif  // ROS2_INTERFACE__MSG__DETAIL__GNSS__STRUCT_HPP_
