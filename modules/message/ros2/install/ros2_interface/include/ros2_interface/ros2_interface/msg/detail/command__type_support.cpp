...
{
  new (message_memory) ros2_interface::msg::Command(_init);
}

void Command_fini_function(void * message_memory)
{
  auto typed_message = static_cast<ros2_interface::msg::Command *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Command_message_member_array[3] = {
  {
    ...
    offsetof(ros2_interface::msg::Command, target_module),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(ros2_interface::msg::Command, target_id),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(ros2_interface::msg::Command, target_switch),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers Command_message_members = {
  ...
  3,  // number of fields
  sizeof(ros2_interface::msg::Command),
...
{
  return &::ros2_interface::msg::rosidl_typesupport_introspection_cpp::Command_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, ros2_interface, msg, Command)() {
  return &::ros2_interface::msg::rosidl_typesupport_introspection_cpp::Command_message_type_support_handle;
}
