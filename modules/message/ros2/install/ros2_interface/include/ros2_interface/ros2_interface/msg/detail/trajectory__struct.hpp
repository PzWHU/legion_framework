...
#ifndef ROS2_INTERFACE__MSG__DETAIL__TRAJECTORY__STRUCT_HPP_
#define ROS2_INTERFACE__MSG__DETAIL__TRAJECTORY__STRUCT_HPP_
...
#ifndef _WIN32
# define DEPRECATED__ros2_interface__msg__Trajectory __attribute__((deprecated))
#else
# define DEPRECATED__ros2_interface__msg__Trajectory __declspec(deprecated)
#endif
...
struct Trajectory_
{
  ...
  using ConstRawPtr =
    const ros2_interface::msg::Trajectory_<ContainerAllocator> *;
  using SharedPtr =
    std::shared_ptr<ros2_interface::msg::Trajectory_<ContainerAllocator>>;
  using ConstSharedPtr =
    std::shared_ptr<ros2_interface::msg::Trajectory_<ContainerAllocator> const>;

  template<typename Deleter = std::default_delete<
      ros2_interface::msg::Trajectory_<ContainerAllocator>>>
  using UniquePtrWithDeleter =
    std::unique_ptr<ros2_interface::msg::Trajectory_<ContainerAllocator>, Deleter>;
  ...
  using ConstUniquePtrWithDeleter =
    std::unique_ptr<ros2_interface::msg::Trajectory_<ContainerAllocator> const, Deleter>;
  using ConstUniquePtr = ConstUniquePtrWithDeleter<>;

  using WeakPtr =
    std::weak_ptr<ros2_interface::msg::Trajectory_<ContainerAllocator>>;
  using ConstWeakPtr =
    std::weak_ptr<ros2_interface::msg::Trajectory_<ContainerAllocator> const>;

  // pointer types similar to ROS 1, use SharedPtr / ConstSharedPtr instead
  // NOTE: Can't use 'using' here because GNU C++ can't parse attributes properly
  typedef DEPRECATED__ros2_interface__msg__Trajectory
    std::shared_ptr<ros2_interface::msg::Trajectory_<ContainerAllocator>>
    Ptr;
  typedef DEPRECATED__ros2_interface__msg__Trajectory
    std::shared_ptr<ros2_interface::msg::Trajectory_<ContainerAllocator> const>
...
using Trajectory =
  ros2_interface::msg::Trajectory_<std::allocator<void>>;
...
#endif  // ROS2_INTERFACE__MSG__DETAIL__TRAJECTORY__STRUCT_HPP_
