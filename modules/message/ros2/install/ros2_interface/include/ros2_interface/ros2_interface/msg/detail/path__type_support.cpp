...
{
  new (message_memory) ros2_interface::msg::Path(_init);
}

void Path_fini_function(void * message_memory)
{
  auto typed_message = static_cast<ros2_interface::msg::Path *>(message_memory);
  typed_message->~Path();
}
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Path_message_member_array[2] = {
  {
    ...
    offsetof(ros2_interface::msg::Path, name),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(ros2_interface::msg::Path, path_points),  // bytes offset in struct
    nullptr,  // default value
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers Path_message_members = {
  ...
  "Path",  // message name
  2,  // number of fields
  sizeof(ros2_interface::msg::Path),
...
get_message_type_support_handle<ros2_interface::msg::Path>()
{
  return &::ros2_interface::msg::rosidl_typesupport_introspection_cpp::Path_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, ros2_interface, msg, Path)() {
  return &::ros2_interface::msg::rosidl_typesupport_introspection_cpp::Path_message_type_support_handle;
}
