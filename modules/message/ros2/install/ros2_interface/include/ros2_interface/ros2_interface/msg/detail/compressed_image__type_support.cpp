...
{
  new (message_memory) ros2_interface::msg::CompressedImage(_init);
}

void CompressedImage_fini_function(void * message_memory)
{
  auto typed_message = static_cast<ros2_interface::msg::CompressedImage *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember CompressedImage_message_member_array[6] = {
  {
    "header",  // name
    ...
    offsetof(ros2_interface::msg::CompressedImage, header),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(ros2_interface::msg::CompressedImage, frame_id),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(ros2_interface::msg::CompressedImage, format),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(ros2_interface::msg::CompressedImage, data),  // bytes offset in struct
    nullptr,  // default value
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(ros2_interface::msg::CompressedImage, measurement_time),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(ros2_interface::msg::CompressedImage, frame_type),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers CompressedImage_message_members = {
  ...
  6,  // number of fields
  sizeof(ros2_interface::msg::CompressedImage),
...
get_message_type_support_handle<ros2_interface::msg::CompressedImage>()
{
  return &::ros2_interface::msg::rosidl_typesupport_introspection_cpp::CompressedImage_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, ros2_interface, msg, CompressedImage)() {
  return &::ros2_interface::msg::rosidl_typesupport_introspection_cpp::CompressedImage_message_type_support_handle;
}
