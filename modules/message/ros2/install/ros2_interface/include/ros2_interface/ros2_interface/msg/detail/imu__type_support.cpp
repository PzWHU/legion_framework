...
{
  new (message_memory) ros2_interface::msg::Imu(_init);
}

void Imu_fini_function(void * message_memory)
{
  auto typed_message = static_cast<ros2_interface::msg::Imu *>(message_memory);
  typed_message->~Imu();
}
...
void resize_function__Imu__orientation_covariance(void * untyped_member, size_t size)
{
  auto * member =
    reinterpret_cast<std::vector<double> *>(untyped_member);
  member->resize(size);
...
void resize_function__Imu__angular_velocity_covariance(void * untyped_member, size_t size)
{
  auto * member =
    reinterpret_cast<std::vector<double> *>(untyped_member);
  member->resize(size);
...
void resize_function__Imu__linear_acceleration_covariance(void * untyped_member, size_t size)
{
  auto * member =
    reinterpret_cast<std::vector<double> *>(untyped_member);
  member->resize(size);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Imu_message_member_array[8] = {
  {
    "header",  // name
    ...
    offsetof(ros2_interface::msg::Imu, header),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(ros2_interface::msg::Imu, is_valid),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(ros2_interface::msg::Imu, orientation),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(ros2_interface::msg::Imu, orientation_covariance),  // bytes offset in struct
    nullptr,  // default value
    ...
    resize_function__Imu__orientation_covariance  // resize(index) function pointer
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(ros2_interface::msg::Imu, angular_velocity),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(ros2_interface::msg::Imu, angular_velocity_covariance),  // bytes offset in struct
    nullptr,  // default value
    ...
    resize_function__Imu__angular_velocity_covariance  // resize(index) function pointer
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(ros2_interface::msg::Imu, linear_acceleration),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(ros2_interface::msg::Imu, linear_acceleration_covariance),  // bytes offset in struct
    nullptr,  // default value
    ...
    resize_function__Imu__linear_acceleration_covariance  // resize(index) function pointer
  }
};
...
get_message_type_support_handle<ros2_interface::msg::Imu>()
{
  return &::ros2_interface::msg::rosidl_typesupport_introspection_cpp::Imu_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, ros2_interface, msg, Imu)() {
  return &::ros2_interface::msg::rosidl_typesupport_introspection_cpp::Imu_message_type_support_handle;
}
