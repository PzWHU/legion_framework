...
bool ros2_interface__msg__compressed_image__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("ros2_interface.msg._compressed_image.CompressedImage", full_classname_dest, 52) == 0);
  }
  ros2_interface__msg__CompressedImage * ros_message = _ros_message;
  {  // header
  ...
  {  // frame_type
    PyObject * field = PyObject_GetAttrString(_pymsg, "frame_type");
    if (!field) {
      return false;
    }
    assert(PyLong_Check(field));
    ros_message->frame_type = PyLong_AsUnsignedLong(field);
    Py_DECREF(field);
  }
...
PyObject * ros2_interface__msg__compressed_image__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("ros2_interface.msg._compressed_image");
  ...
  {  // frame_type
    PyObject * field = NULL;
    field = PyLong_FromUnsignedLong(ros_message->frame_type);
    {
      int rc = PyObject_SetAttrString(_pymessage, "frame_type", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
