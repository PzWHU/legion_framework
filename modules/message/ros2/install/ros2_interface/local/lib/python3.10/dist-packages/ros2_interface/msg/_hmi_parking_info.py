...
class Metaclass_HMIParkingInfo(type):
    """Metaclass of message 'HMIParkingInfo'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__msg__hmi_parking_info
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__msg__hmi_parking_info
            cls._CONVERT_TO_PY = module.convert_to_py_msg__msg__hmi_parking_info
            cls._TYPE_SUPPORT = module.type_support_msg__msg__hmi_parking_info
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__msg__hmi_parking_info
...
class HMIParkingInfo(metaclass=Metaclass_HMIParkingInfo):
    """Message class 'HMIParkingInfo'."""
    ...
    def __init__(self, **kwargs):
        ...
        self.is_custom_parking = kwargs.get('is_custom_parking', bool())
        from ros2_interface.msg import Polygon3D
    ...
    def __eq__(self, other):
        ...
        if self.length != other.length:
            return False
        if self.is_custom_parking != other.is_custom_parking:
            return False
    ...
    @builtins.property
    def is_custom_parking(self):
        """Message field 'is_custom_parking'."""
        return self._is_custom_parking

    @is_custom_parking.setter
    def is_custom_parking(self, value):
        if __debug__:
            assert \
                isinstance(value, bool), \
                "The 'is_custom_parking' field must be of type 'bool'"
        self._is_custom_parking = value
