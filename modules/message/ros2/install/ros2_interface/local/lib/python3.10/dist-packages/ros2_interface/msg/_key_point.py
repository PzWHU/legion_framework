...
class KeyPoint(metaclass=Metaclass_KeyPoint):
    ...
    def ele(self, value):
        if __debug__:
            assert \
                isinstance(value, float), \
                "The 'ele' field must be of type 'float'"
            assert not (value < -1.7976931348623157e+308 or value > 1.7976931348623157e+308) or math.isinf(value), \
                "The 'ele' field must be a double in [-1.7976931348623157e+308, 1.7976931348623157e+308]"
        self._ele = value
