...
class Metaclass_DiagnosticStatus(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from ros2_interface.msg import KeyValues
            if KeyValues.__class__._TYPE_SUPPORT is None:
                KeyValues.__class__.__import_type_support__()
...
class DiagnosticStatus(metaclass=Metaclass_DiagnosticStatus):
    ...
    _fields_and_field_types = {
        ...
        'message': 'string',
        'hardware_id': 'string',
        'values': 'sequence<ros2_interface/KeyValues>',
    }
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.UnboundedString(),  # noqa: E501
        rosidl_parser.definition.UnboundedString(),  # noqa: E501
        rosidl_parser.definition.UnboundedSequence(rosidl_parser.definition.NamespacedType(['ros2_interface', 'msg'], 'KeyValues')),  # noqa: E501
    )
        ...
        if __debug__:
            ...
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 all(isinstance(v, KeyValues) for v in value) and
                 True), \
                "The 'values' field must be a set or sequence and each value of type 'KeyValues'"
        self._values = value
