...
bool ros2_interface__msg__hmi_trajectory_point__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("ros2_interface.msg._hmi_trajectory_point.HMITrajectoryPoint", full_classname_dest, 59) == 0);
  }
  ros2_interface__msg__HMITrajectoryPoint * ros_message = _ros_message;
  {  // point
...
{
  /* NOTE(esteve): Call constructor of HMITrajectoryPoint */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("ros2_interface.msg._hmi_trajectory_point");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "HMITrajectoryPoint");
