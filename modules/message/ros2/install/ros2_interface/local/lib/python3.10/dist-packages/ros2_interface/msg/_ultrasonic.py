...
class Metaclass_Ultrasonic(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from ros2_interface.msg import UltrasonicObstacle
            if UltrasonicObstacle.__class__._TYPE_SUPPORT is None:
                UltrasonicObstacle.__class__.__import_type_support__()
...
class Ultrasonic(metaclass=Metaclass_Ultrasonic):
    ...
    _fields_and_field_types = {
        ...
        'ranges': 'sequence<ros2_interface/UltrasonicObstacle>',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.NamespacedType(['std_msgs', 'msg'], 'Header'),  # noqa: E501
        rosidl_parser.definition.UnboundedSequence(rosidl_parser.definition.NamespacedType(['ros2_interface', 'msg'], 'UltrasonicObstacle')),  # noqa: E501
    )
        ...
        if __debug__:
            ...
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 all(isinstance(v, UltrasonicObstacle) for v in value) and
                 True), \
                "The 'ranges' field must be a set or sequence and each value of type 'UltrasonicObstacle'"
        self._ranges = value
