...
bool ros2_interface__msg__hmi_parking_state_display__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("ros2_interface.msg._hmi_parking_state_display.HMIParkingStateDisplay", full_classname_dest, 68) == 0);
  }
  ros2_interface__msg__HMIParkingStateDisplay * ros_message = _ros_message;
  {  // header
...
{
  /* NOTE(esteve): Call constructor of HMIParkingStateDisplay */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("ros2_interface.msg._hmi_parking_state_display");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "HMIParkingStateDisplay");
