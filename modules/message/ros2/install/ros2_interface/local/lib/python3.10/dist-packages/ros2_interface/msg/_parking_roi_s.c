...
bool ros2_interface__msg__parking_roi__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("ros2_interface.msg._parking_roi.ParkingRoi", full_classname_dest, 42) == 0);
  }
  ros2_interface__msg__ParkingRoi * ros_message = _ros_message;
  {  // header
...
{
  /* NOTE(esteve): Call constructor of ParkingRoi */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("ros2_interface.msg._parking_roi");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "ParkingRoi");
