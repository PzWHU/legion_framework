    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger(
                'ros2_interface.msg.ModuleStatus')
            logger.debug(
            ...
            from ros2_interface.msg import Message
...
class ModuleStatus(metaclass=Metaclass_ModuleStatus):
    ...
    _fields_and_field_types = {
        ...
        'self_id': 'int8',
        'status': 'int32',
        'messages': 'sequence<ros2_interface/Message>',
    }
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.UnboundedSequence(rosidl_parser.definition.NamespacedType(['ros2_interface', 'msg'], 'Message')),  # noqa: E501
    )
