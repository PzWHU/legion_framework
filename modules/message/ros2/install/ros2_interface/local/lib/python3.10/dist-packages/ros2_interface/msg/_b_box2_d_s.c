...
bool ros2_interface__msg__b_box2_d__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("ros2_interface.msg._b_box2_d.BBox2D", full_classname_dest, 35) == 0);
  }
  ros2_interface__msg__BBox2D * ros_message = _ros_message;
  {  // xmin
...
{
  /* NOTE(esteve): Call constructor of BBox2D */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("ros2_interface.msg._b_box2_d");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "BBox2D");
