    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger(
                'ros2_interface.msg.VehicleState')
            logger.debug(
            ...
            from ros2_interface.msg import Pose
...
class VehicleState(metaclass=Metaclass_VehicleState):
    ...
    _fields_and_field_types = {
        ...
        'linear_acceleration': 'double',
        'gear': 'int32',
        'driving_mode': 'int32',
        'pose': 'ros2_interface/Pose',
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.BasicType('int32'),  # noqa: E501
        rosidl_parser.definition.NamespacedType(['ros2_interface', 'msg'], 'Pose'),  # noqa: E501
        rosidl_parser.definition.BasicType('double'),  # noqa: E501
        rosidl_parser.definition.BasicType('double'),  # noqa: E501
    )
    ...
    def __init__(self, **kwargs):
        ...
        self.linear_acceleration = kwargs.get('linear_acceleration', float())
    ...
    def linear_acceleration(self, value):
        if __debug__:
            assert \
                isinstance(value, float), \
                "The 'linear_acceleration' field must be of type 'float'"
            assert not (value < -1.7976931348623157e+308 or value > 1.7976931348623157e+308) or math.isinf(value), \
                "The 'linear_acceleration' field must be a double in [-1.7976931348623157e+308, 1.7976931348623157e+308]"
