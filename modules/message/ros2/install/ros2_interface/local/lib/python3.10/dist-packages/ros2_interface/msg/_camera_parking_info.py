...
class Metaclass_CameraParkingInfo(type):
    """Metaclass of message 'CameraParkingInfo'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__msg__camera_parking_info
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__msg__camera_parking_info
            cls._CONVERT_TO_PY = module.convert_to_py_msg__msg__camera_parking_info
            cls._TYPE_SUPPORT = module.type_support_msg__msg__camera_parking_info
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__msg__camera_parking_info
...
class CameraParkingInfo(metaclass=Metaclass_CameraParkingInfo):
    """Message class 'CameraParkingInfo'."""
    ...
    _fields_and_field_types = {
        ...
        'length': 'double',
        'yaw_offset': 'double',
        'parking_points_in_image': 'sequence<ros2_interface/ImageKeyPoint>',
    }
    ...
    def __init__(self, **kwargs):
        ...
        self.is_parking_enable = kwargs.get('is_parking_enable', bool())
        ...
        self.parking_points_in_image = kwargs.get('parking_points_in_image', [])
    ...
    def __eq__(self, other):
        ...
        if self.parking_type != other.parking_type:
            return False
        if self.is_parking_enable != other.is_parking_enable:
            return False
        ...
        if self.yaw_offset != other.yaw_offset:
            return False
        if self.parking_points_in_image != other.parking_points_in_image:
            return False
        return True
    ...
    @builtins.property
    def is_parking_enable(self):
        """Message field 'is_parking_enable'."""
        return self._is_parking_enable

    @is_parking_enable.setter
    def is_parking_enable(self, value):
        if __debug__:
            assert \
                isinstance(value, bool), \
                "The 'is_parking_enable' field must be of type 'bool'"
        self._is_parking_enable = value
    ...
    @builtins.property
    def parking_points_in_image(self):
        """Message field 'parking_points_in_image'."""
        return self._parking_points_in_image

    @parking_points_in_image.setter
    def parking_points_in_image(self, value):
        if __debug__:
            from ros2_interface.msg import ImageKeyPoint
            ...
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 True), \
                "The 'parking_points_in_image' field must be a set or sequence and each value of type 'ImageKeyPoint'"
        self._parking_points_in_image = value
