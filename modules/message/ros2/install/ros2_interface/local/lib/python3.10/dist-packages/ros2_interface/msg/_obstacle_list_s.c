...
bool ros2_interface__msg__obstacle_list__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("ros2_interface.msg._obstacle_list.ObstacleList", full_classname_dest, 46) == 0);
  }
  ros2_interface__msg__ObstacleList * ros_message = _ros_message;
  {  // header
  ...
  {  // obstacle
    ...
    if (!ros2_interface__msg__Obstacle__Sequence__init(&(ros_message->obstacle), size)) {
      PyErr_SetString(PyExc_RuntimeError, "unable to create ros2_interface__msg__Obstacle__Sequence ros_message");
      Py_DECREF(seq_field);
      Py_DECREF(field);
      return false;
    }
    ros2_interface__msg__Obstacle * dest = ros_message->obstacle.data;
    for (Py_ssize_t i = 0; i < size; ++i) {
      if (!ros2_interface__msg__obstacle__convert_from_py(PySequence_Fast_GET_ITEM(seq_field, i), &dest[i])) {
        Py_DECREF(seq_field);
        Py_DECREF(field);
        return false;
      }
...
{
  /* NOTE(esteve): Call constructor of ObstacleList */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("ros2_interface.msg._obstacle_list");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "ObstacleList");
  ...
  {  // obstacle
    ...
    for (size_t i = 0; i < size; ++i) {
      ...
      PyObject * pyitem = ros2_interface__msg__obstacle__convert_to_py(item);
      if (!pyitem) {
        Py_DECREF(field);
        return NULL;
      }
