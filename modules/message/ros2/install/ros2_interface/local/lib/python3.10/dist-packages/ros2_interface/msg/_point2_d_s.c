...
bool ros2_interface__msg__point2_d__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("ros2_interface.msg._point2_d.Point2D", full_classname_dest, 36) == 0);
  }
  ros2_interface__msg__Point2D * ros_message = _ros_message;
  {  // x
...
PyObject * ros2_interface__msg__point2_d__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("ros2_interface.msg._point2_d");
