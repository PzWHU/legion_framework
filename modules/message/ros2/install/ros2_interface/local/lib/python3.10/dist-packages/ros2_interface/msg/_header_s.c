...
bool ros2_interface__msg__header__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("ros2_interface.msg._header.Header", full_classname_dest, 33) == 0);
  }
  ros2_interface__msg__Header * ros_message = _ros_message;
  {  // seq
...
PyObject * ros2_interface__msg__header__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("ros2_interface.msg._header");
