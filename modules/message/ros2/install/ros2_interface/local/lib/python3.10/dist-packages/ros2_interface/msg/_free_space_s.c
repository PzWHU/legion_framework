...
bool ros2_interface__msg__free_space__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("ros2_interface.msg._free_space.FreeSpace", full_classname_dest, 40) == 0);
  }
  ros2_interface__msg__FreeSpace * ros_message = _ros_message;
  {  // header
  ...
  {  // freespace_region
    PyObject * field = PyObject_GetAttrString(_pymsg, "freespace_region");
    if (!field) {
      return false;
    }
    PyObject * seq_field = PySequence_Fast(field, "expected a sequence in 'freespace_region'");
    if (!seq_field) {
      Py_DECREF(field);
      return false;
    }
    ...
    ros2_interface__msg__Polygon2D * dest = ros_message->freespace_region.data;
...
{
  /* NOTE(esteve): Call constructor of FreeSpace */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("ros2_interface.msg._free_space");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "FreeSpace");
  ...
  {  // freespace_region
    ...
    for (size_t i = 0; i < size; ++i) {
      item = &(ros_message->freespace_region.data[i]);
    ...
    {
      int rc = PyObject_SetAttrString(_pymessage, "freespace_region", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
