...
bool ros2_interface__msg__key_point__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("ros2_interface.msg._key_point.KeyPoint", full_classname_dest, 38) == 0);
  }
  ros2_interface__msg__KeyPoint * ros_message = _ros_message;
  {  // id
  ...
  {  // ele
    PyObject * field = PyObject_GetAttrString(_pymsg, "ele");
    if (!field) {
      return false;
    }
    assert(PyFloat_Check(field));
    ros_message->ele = PyFloat_AS_DOUBLE(field);
    Py_DECREF(field);
  }
  {  // heading
...
PyObject * ros2_interface__msg__key_point__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("ros2_interface.msg._key_point");
  ...
  {  // ele
    PyObject * field = NULL;
    field = PyFloat_FromDouble(ros_message->ele);
    {
      int rc = PyObject_SetAttrString(_pymessage, "ele", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
