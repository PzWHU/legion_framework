...
class LaneInfo(metaclass=Metaclass_LaneInfo):
    ...
    _fields_and_field_types = {
        ...
        'predecessor_id': 'int8',
        'successor_id': 'int8',
        'left_neighbor_id': 'int8',
        'right_neighbor_id': 'int8',
        'type': 'int8',
    ...
    def __init__(self, **kwargs):
        ...
        self.predecessor_id = kwargs.get('predecessor_id', int())
        self.successor_id = kwargs.get('successor_id', int())
    ...
    def __eq__(self, other):
        ...
        if self.global_id != other.global_id:
            return False
        if self.predecessor_id != other.predecessor_id:
            return False
        if self.successor_id != other.successor_id:
            return False
    ...
    def global_id(self, value):
        if __debug__:
            ...
            assert value >= -128 and value < 128, \
                "The 'global_id' field must be an integer in [-128, 127]"
        self._global_id = value

    @builtins.property
    def predecessor_id(self):
        """Message field 'predecessor_id'."""
    ...
    def predecessor_id(self, value):
        if __debug__:
            assert \
                isinstance(value, int), \
                "The 'predecessor_id' field must be of type 'int'"
            assert value >= -128 and value < 128, \
                "The 'predecessor_id' field must be an integer in [-128, 127]"
        self._predecessor_id = value

    @builtins.property
    def successor_id(self):
        """Message field 'successor_id'."""
    ...
    def successor_id(self, value):
        if __debug__:
            assert \
                isinstance(value, int), \
                "The 'successor_id' field must be of type 'int'"
            assert value >= -128 and value < 128, \
                "The 'successor_id' field must be an integer in [-128, 127]"
    ...
    def left_neighbor_id(self, value):
        if __debug__:
            ...
            assert value >= -128 and value < 128, \
                "The 'left_neighbor_id' field must be an integer in [-128, 127]"
    ...
    def right_neighbor_id(self, value):
        if __debug__:
            ...
            assert value >= -128 and value < 128, \
                "The 'right_neighbor_id' field must be an integer in [-128, 127]"
