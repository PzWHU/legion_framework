...
class Metaclass_Polygon3D(type):
    """Metaclass of message 'Polygon3D'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__msg__polygon3_d
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__msg__polygon3_d
            cls._CONVERT_TO_PY = module.convert_to_py_msg__msg__polygon3_d
            cls._TYPE_SUPPORT = module.type_support_msg__msg__polygon3_d
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__msg__polygon3_d
...
class Polygon3D(metaclass=Metaclass_Polygon3D):
    """Message class 'Polygon3D'."""
    ...
    def coordinate_system(self, value):
        if __debug__:
            ...
            assert value >= -2147483648 and value < 2147483648, \
                "The 'coordinate_system' field must be an integer in [-2147483648, 2147483647]"
