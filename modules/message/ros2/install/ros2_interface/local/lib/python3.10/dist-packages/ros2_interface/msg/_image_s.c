...
bool ros2_interface__msg__image__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("ros2_interface.msg._image.Image", full_classname_dest, 31) == 0);
  }
  ros2_interface__msg__Image * ros_message = _ros_message;
  {  // header
...
PyObject * ros2_interface__msg__image__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("ros2_interface.msg._image");
