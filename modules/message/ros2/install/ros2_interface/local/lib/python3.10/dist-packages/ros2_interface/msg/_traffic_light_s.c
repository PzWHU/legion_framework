...
bool ros2_interface__msg__image_rect__convert_from_py(PyObject * _pymsg, void * _ros_message);
...
bool ros2_interface__msg__traffic_light__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("ros2_interface.msg._traffic_light.TrafficLight", full_classname_dest, 46) == 0);
  }
  ros2_interface__msg__TrafficLight * ros_message = _ros_message;
  {  // color
  ...
  {  // light_rect
    PyObject * field = PyObject_GetAttrString(_pymsg, "light_rect");
    if (!field) {
      return false;
    }
    if (!ros2_interface__msg__image_rect__convert_from_py(field, &ros_message->light_rect)) {
      Py_DECREF(field);
      return false;
    }
    Py_DECREF(field);
  ...
  {  // light_lanes
    PyObject * field = PyObject_GetAttrString(_pymsg, "light_lanes");
    if (!field) {
      return false;
    }
    if (PyObject_CheckBuffer(field)) {
      ...
      int32_t * dest = ros_message->light_lanes.data;
      ...
      PyObject * seq_field = PySequence_Fast(field, "expected a sequence in 'light_lanes'");
      if (!seq_field) {
        Py_DECREF(field);
        return false;
      }
  ...
  {  // blinking_time
    PyObject * field = PyObject_GetAttrString(_pymsg, "blinking_time");
    if (!field) {
      return false;
    }
    assert(PyFloat_Check(field));
    ros_message->blinking_time = PyFloat_AS_DOUBLE(field);
    Py_DECREF(field);
  }
  {  // remaining_time
...
PyObject * ros2_interface__msg__traffic_light__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("ros2_interface.msg._traffic_light");
  ...
  {  // light_rect
    PyObject * field = NULL;
    field = ros2_interface__msg__image_rect__convert_to_py(&ros_message->light_rect);
    if (!field) {
      return NULL;
    }
    {
      int rc = PyObject_SetAttrString(_pymessage, "light_rect", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
  ...
  {  // light_lanes
    PyObject * field = NULL;
    field = PyObject_GetAttrString(_pymessage, "light_lanes");
    if (!field) {
      return NULL;
    }
    ...
    if (ros_message->light_lanes.size > 0) {
      // populating the array.array using the frombytes method
      PyObject * frombytes = PyObject_GetAttrString(field, "frombytes");
      assert(frombytes != NULL);
      int32_t * src = &(ros_message->light_lanes.data[0]);
      PyObject * data = PyBytes_FromStringAndSize((const char *)src, ros_message->light_lanes.size * sizeof(int32_t));
      assert(data != NULL);
  ...
  {  // blinking_time
    PyObject * field = NULL;
    field = PyFloat_FromDouble(ros_message->blinking_time);
    {
      int rc = PyObject_SetAttrString(_pymessage, "blinking_time", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
