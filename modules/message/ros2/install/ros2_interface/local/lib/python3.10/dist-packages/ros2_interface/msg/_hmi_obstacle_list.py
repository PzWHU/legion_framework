...
class Metaclass_HMIObstacleList(type):
    """Metaclass of message 'HMIObstacleList'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger(
                'ros2_interface.msg.HMIObstacleList')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__msg__hmi_obstacle_list
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__msg__hmi_obstacle_list
            cls._CONVERT_TO_PY = module.convert_to_py_msg__msg__hmi_obstacle_list
            cls._TYPE_SUPPORT = module.type_support_msg__msg__hmi_obstacle_list
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__msg__hmi_obstacle_list

            from ros2_interface.msg import HMIObstacle
            if HMIObstacle.__class__._TYPE_SUPPORT is None:
                HMIObstacle.__class__.__import_type_support__()
...
class HMIObstacleList(metaclass=Metaclass_HMIObstacleList):
    """Message class 'HMIObstacleList'."""
    ...
    _fields_and_field_types = {
        ...
        'sensor_id': 'int32',
        'obstacle': 'sequence<ros2_interface/HMIObstacle>',
        'error_code': 'int32',
        'is_valid': 'boolean',
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.UnboundedSequence(rosidl_parser.definition.NamespacedType(['ros2_interface', 'msg'], 'HMIObstacle')),  # noqa: E501
        rosidl_parser.definition.BasicType('int32'),  # noqa: E501
        ...
        if __debug__:
            ...
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 all(isinstance(v, HMIObstacle) for v in value) and
                 True), \
                "The 'obstacle' field must be a set or sequence and each value of type 'HMIObstacle'"
