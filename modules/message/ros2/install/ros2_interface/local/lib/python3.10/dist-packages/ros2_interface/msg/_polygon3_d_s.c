...
bool ros2_interface__msg__polygon3_d__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("ros2_interface.msg._polygon3_d.Polygon3D", full_classname_dest, 40) == 0);
  }
  ros2_interface__msg__Polygon3D * ros_message = _ros_message;
  {  // coordinate_system
...
{
  /* NOTE(esteve): Call constructor of Polygon3D */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("ros2_interface.msg._polygon3_d");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "Polygon3D");
