...
bool ros2_interface__msg__traffic_light_list__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("ros2_interface.msg._traffic_light_list.TrafficLightList", full_classname_dest, 55) == 0);
  }
  ros2_interface__msg__TrafficLightList * ros_message = _ros_message;
  {  // header
  ...
  {  // camera_status
    PyObject * field = PyObject_GetAttrString(_pymsg, "camera_status");
    if (!field) {
      return false;
    }
    assert(PyLong_Check(field));
    ros_message->camera_status = (uint8_t)PyLong_AsUnsignedLong(field);
    Py_DECREF(field);
  }
  {  // is_valid
...
{
  /* NOTE(esteve): Call constructor of TrafficLightList */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("ros2_interface.msg._traffic_light_list");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "TrafficLightList");
  ...
  {  // camera_status
    PyObject * field = NULL;
    field = PyLong_FromUnsignedLong(ros_message->camera_status);
    {
      int rc = PyObject_SetAttrString(_pymessage, "camera_status", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
