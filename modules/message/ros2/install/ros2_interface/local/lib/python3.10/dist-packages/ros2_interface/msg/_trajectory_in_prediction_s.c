...
bool ros2_interface__msg__trajectory_in_prediction__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("ros2_interface.msg._trajectory_in_prediction.TrajectoryInPrediction", full_classname_dest, 67) == 0);
  }
  ros2_interface__msg__TrajectoryInPrediction * ros_message = _ros_message;
  {  // probability
...
{
  /* NOTE(esteve): Call constructor of TrajectoryInPrediction */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("ros2_interface.msg._trajectory_in_prediction");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "TrajectoryInPrediction");
