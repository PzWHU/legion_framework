...
bool ros2_interface__msg__radar_obstacle_list__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("ros2_interface.msg._radar_obstacle_list.RadarObstacleList", full_classname_dest, 57) == 0);
  }
  ros2_interface__msg__RadarObstacleList * ros_message = _ros_message;
  {  // header
...
{
  /* NOTE(esteve): Call constructor of RadarObstacleList */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("ros2_interface.msg._radar_obstacle_list");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "RadarObstacleList");
