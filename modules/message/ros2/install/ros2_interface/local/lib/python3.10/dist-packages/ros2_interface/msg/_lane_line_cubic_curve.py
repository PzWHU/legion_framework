...
class Metaclass_LaneLineCubicCurve(type):
    """Metaclass of message 'LaneLineCubicCurve'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__msg__lane_line_cubic_curve
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__msg__lane_line_cubic_curve
            cls._CONVERT_TO_PY = module.convert_to_py_msg__msg__lane_line_cubic_curve
            cls._TYPE_SUPPORT = module.type_support_msg__msg__lane_line_cubic_curve
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__msg__lane_line_cubic_curve
...
class LaneLineCubicCurve(metaclass=Metaclass_LaneLineCubicCurve):
    """Message class 'LaneLineCubicCurve'."""
    ...
    def __init__(self, **kwargs):
        ...
        self.end_x = kwargs.get('end_x', float())
    ...
    def end_x(self, value):
        if __debug__:
            assert \
                isinstance(value, float), \
                "The 'end_x' field must be of type 'float'"
            assert not (value < -1.7976931348623157e+308 or value > 1.7976931348623157e+308) or math.isinf(value), \
                "The 'end_x' field must be a double in [-1.7976931348623157e+308, 1.7976931348623157e+308]"
        self._end_x = value
