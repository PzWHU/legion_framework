...
{
  new (message_memory) ros2_interface::msg::Point2D(_init);
}

void Point2D_fini_function(void * message_memory)
{
  auto typed_message = static_cast<ros2_interface::msg::Point2D *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Point2D_message_member_array[2] = {
  {
    ...
    offsetof(ros2_interface::msg::Point2D, x),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(ros2_interface::msg::Point2D, y),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers Point2D_message_members = {
  ...
  2,  // number of fields
  sizeof(ros2_interface::msg::Point2D),
...
{
  return &::ros2_interface::msg::rosidl_typesupport_introspection_cpp::Point2D_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, ros2_interface, msg, Point2D)() {
  return &::ros2_interface::msg::rosidl_typesupport_introspection_cpp::Point2D_message_type_support_handle;
}
