...
#include "ros2_interface/msg/detail/quaternion__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const ros2_interface::msg::Quaternion & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  ros2_interface::msg::Quaternion & ros_message)
{
  // Member: qx
  cdr >> ros_message.qx;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = ros2_interface::msg::Quaternion;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const ros2_interface::msg::Quaternion *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<ros2_interface::msg::Quaternion *>(
    untyped_ros_message);
...
{
  return &ros2_interface::msg::typesupport_fastrtps_cpp::_Quaternion__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, ros2_interface, msg, Quaternion)() {
  return &ros2_interface::msg::typesupport_fastrtps_cpp::_Quaternion__handle;
}
