...
#include "ros2_interface/msg/detail/polygon__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const ros2_interface::msg::Polygon & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  ros2_interface::msg::Polygon & ros_message)
{
  // Member: points
  {
    uint32_t cdrSize;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = ros2_interface::msg::Polygon;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const ros2_interface::msg::Polygon *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<ros2_interface::msg::Polygon *>(
    untyped_ros_message);
...
static size_t _Polygon__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_Polygon(full_bounded, is_plain, 0);
...
{
  return &ros2_interface::msg::typesupport_fastrtps_cpp::_Polygon__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, ros2_interface, msg, Polygon)() {
  return &ros2_interface::msg::typesupport_fastrtps_cpp::_Polygon__handle;
}
