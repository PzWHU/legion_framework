...
#include "ros2_interface/msg/detail/radar_state__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
bool cdr_serialize(
  const ros2_interface::msg::RadarStateError &,
...
{
bool cdr_serialize(
  const ros2_interface::msg::RadarStateMode &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
...
cdr_serialize(
  const ros2_interface::msg::RadarState & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  ros2_interface::msg::typesupport_fastrtps_cpp::cdr_serialize(
    ros_message.radar_state_error,
    cdr);
  // Member: radar_state_mode
  ros2_interface::msg::typesupport_fastrtps_cpp::cdr_serialize(
    ros_message.radar_state_mode,
    cdr);
  // Member: max_distance
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  ros2_interface::msg::RadarState & ros_message)
{
  // Member: sensor_id
  cdr >> ros_message.sensor_id;
  ...
  size_t current_alignment)
{
  ...
  // Member: radar_state_error
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        ros2_interface::msg::typesupport_fastrtps_cpp::max_serialized_size_RadarStateError(
  ...
  // Member: radar_state_mode
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        ros2_interface::msg::typesupport_fastrtps_cpp::max_serialized_size_RadarStateMode(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    using DataType = ros2_interface::msg::RadarState;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const ros2_interface::msg::RadarState *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<ros2_interface::msg::RadarState *>(
    untyped_ros_message);
...
get_message_type_support_handle<ros2_interface::msg::RadarState>()
{
  return &ros2_interface::msg::typesupport_fastrtps_cpp::_RadarState__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, ros2_interface, msg, RadarState)() {
  return &ros2_interface::msg::typesupport_fastrtps_cpp::_RadarState__handle;
}
