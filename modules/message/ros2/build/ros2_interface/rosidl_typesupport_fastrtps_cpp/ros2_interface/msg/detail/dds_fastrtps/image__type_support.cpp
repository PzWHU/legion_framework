...
#include "ros2_interface/msg/detail/image__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = ros2_interface::msg::Image;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const ros2_interface::msg::Image *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<ros2_interface::msg::Image *>(
    untyped_ros_message);
...
{
  return &ros2_interface::msg::typesupport_fastrtps_cpp::_Image__handle;
}
