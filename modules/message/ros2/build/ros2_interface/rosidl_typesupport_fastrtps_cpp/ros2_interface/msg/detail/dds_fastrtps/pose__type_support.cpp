...
#include "ros2_interface/msg/detail/pose__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
bool cdr_serialize(
  const ros2_interface::msg::Quaternion &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
  ros2_interface::msg::Quaternion &);
size_t get_serialized_size(
  const ros2_interface::msg::Quaternion &,
  size_t current_alignment);
size_t
...
cdr_serialize(
  const ros2_interface::msg::Pose & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  ros2_interface::msg::typesupport_fastrtps_cpp::cdr_serialize(
    ros_message.linear_acceleration_vrf,
    cdr);
  // Member: angular_velocity_vrf
  ros2_interface::msg::typesupport_fastrtps_cpp::cdr_serialize(
    ros_message.angular_velocity_vrf,
    cdr);
  // Member: euler_angles
  ros2_interface::msg::typesupport_fastrtps_cpp::cdr_serialize(
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  ros2_interface::msg::Pose & ros_message)
{
  // Member: position
  ...
  size_t current_alignment)
{
  ...
  // Member: orientation
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        ros2_interface::msg::typesupport_fastrtps_cpp::max_serialized_size_Quaternion(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    using DataType = ros2_interface::msg::Pose;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const ros2_interface::msg::Pose *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<ros2_interface::msg::Pose *>(
    untyped_ros_message);
...
get_message_type_support_handle<ros2_interface::msg::Pose>()
{
  return &ros2_interface::msg::typesupport_fastrtps_cpp::_Pose__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, ros2_interface, msg, Pose)() {
  return &ros2_interface::msg::typesupport_fastrtps_cpp::_Pose__handle;
}
