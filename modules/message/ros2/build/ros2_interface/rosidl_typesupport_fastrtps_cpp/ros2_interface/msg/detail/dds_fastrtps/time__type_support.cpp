...
#include "ros2_interface/msg/detail/time__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const ros2_interface::msg::Time & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: sec
  cdr << ros_message.sec;
  // Member: nsec
  cdr << ros_message.nsec;
  return true;
}
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  ros2_interface::msg::Time & ros_message)
{
  // Member: sec
  cdr >> ros_message.sec;
  ...
  size_t current_alignment)
{
  ...
  // Member: nsec
  {
    size_t item_size = sizeof(ros_message.nsec);
    current_alignment += item_size +
      eprosima::fastcdr::Cdr::alignment(current_alignment, item_size);
  }
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = ros2_interface::msg::Time;
    is_plain =
      (
      offsetof(DataType, nsec) +
      last_member_size
      ) == ret_val;
  }
...
{
  auto typed_message =
    static_cast<const ros2_interface::msg::Time *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<ros2_interface::msg::Time *>(
    untyped_ros_message);
...
get_message_type_support_handle<ros2_interface::msg::Time>()
{
  return &ros2_interface::msg::typesupport_fastrtps_cpp::_Time__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, ros2_interface, msg, Time)() {
  return &ros2_interface::msg::typesupport_fastrtps_cpp::_Time__handle;
}
