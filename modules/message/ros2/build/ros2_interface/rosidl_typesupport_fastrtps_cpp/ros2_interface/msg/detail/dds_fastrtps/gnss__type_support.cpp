...
#include "ros2_interface/msg/detail/gnss__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const ros2_interface::msg::Gnss & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  ros2_interface::msg::Gnss & ros_message)
{
  // Member: is_valid
  {
    uint8_t tmp;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = ros2_interface::msg::Gnss;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const ros2_interface::msg::Gnss *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<ros2_interface::msg::Gnss *>(
    untyped_ros_message);
...
get_message_type_support_handle<ros2_interface::msg::Gnss>()
{
  return &ros2_interface::msg::typesupport_fastrtps_cpp::_Gnss__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, ros2_interface, msg, Gnss)() {
  return &ros2_interface::msg::typesupport_fastrtps_cpp::_Gnss__handle;
}
