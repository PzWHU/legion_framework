...
#include "ros2_interface/msg/detail/fault__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const ros2_interface::msg::Fault & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  ros2_interface::msg::Fault & ros_message)
{
  // Member: timestamp
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = ros2_interface::msg::Fault;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const ros2_interface::msg::Fault *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<ros2_interface::msg::Fault *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _Fault__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const ros2_interface::msg::Fault *>(
...
static size_t _Fault__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_Fault(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _Fault__callbacks = {
  "ros2_interface::msg",
  "Fault",
...
static rosidl_message_type_support_t _Fault__handle = {
...
{
  return &ros2_interface::msg::typesupport_fastrtps_cpp::_Fault__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, ros2_interface, msg, Fault)() {
  return &ros2_interface::msg::typesupport_fastrtps_cpp::_Fault__handle;
}
