...
#include "ros2_interface/msg/detail/point_cloud__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
bool cdr_serialize(
  const ros2_interface::msg::PointXYZIRT &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
...
cdr_serialize(
  const ros2_interface::msg::PointCloud & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  ros2_interface::msg::PointCloud & ros_message)
{
  // Member: header
  ...
  size_t current_alignment)
{
  ...
  // Member: point
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        ros2_interface::msg::typesupport_fastrtps_cpp::max_serialized_size_PointXYZIRT(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    using DataType = ros2_interface::msg::PointCloud;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const ros2_interface::msg::PointCloud *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<ros2_interface::msg::PointCloud *>(
    untyped_ros_message);
...
{
  return &ros2_interface::msg::typesupport_fastrtps_cpp::_PointCloud__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, ros2_interface, msg, PointCloud)() {
  return &ros2_interface::msg::typesupport_fastrtps_cpp::_PointCloud__handle;
}
