...
#include "ros2_interface/msg/detail/vehicle_state__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  // Member: pose
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        ros2_interface::msg::typesupport_fastrtps_cpp::max_serialized_size_Pose(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    using DataType = ros2_interface::msg::VehicleState;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const ros2_interface::msg::VehicleState *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<ros2_interface::msg::VehicleState *>(
    untyped_ros_message);
...
{
  return &ros2_interface::msg::typesupport_fastrtps_cpp::_VehicleState__handle;
}
