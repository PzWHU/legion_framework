...
#include "ros2_interface/msg/detail/polygon2_d__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const ros2_interface::msg::Polygon2D & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  ros2_interface::msg::Polygon2D & ros_message)
{
  // Member: coordinate_system
  cdr >> ros_message.coordinate_system;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = ros2_interface::msg::Polygon2D;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const ros2_interface::msg::Polygon2D *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<ros2_interface::msg::Polygon2D *>(
    untyped_ros_message);
...
{
  return &ros2_interface::msg::typesupport_fastrtps_cpp::_Polygon2D__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, ros2_interface, msg, Polygon2D)() {
  return &ros2_interface::msg::typesupport_fastrtps_cpp::_Polygon2D__handle;
}
