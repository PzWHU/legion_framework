...
#include "ros2_interface/msg/detail/lane_info__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const ros2_interface::msg::LaneInfo & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  cdr << ros_message.predecessor_id;
  // Member: successor_id
  cdr << ros_message.successor_id;
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  ros2_interface::msg::LaneInfo & ros_message)
{
  // Member: priority
  cdr >> ros_message.priority;
  ...
  size_t current_alignment)
{
  ...
  // Member: predecessor_id
  {
    size_t item_size = sizeof(ros_message.predecessor_id);
    current_alignment += item_size +
      eprosima::fastcdr::Cdr::alignment(current_alignment, item_size);
  }
  // Member: successor_id
  {
    size_t item_size = sizeof(ros_message.successor_id);
    current_alignment += item_size +
      eprosima::fastcdr::Cdr::alignment(current_alignment, item_size);
  }
  // Member: left_neighbor_id
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = ros2_interface::msg::LaneInfo;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const ros2_interface::msg::LaneInfo *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<ros2_interface::msg::LaneInfo *>(
    untyped_ros_message);
...
{
  return &ros2_interface::msg::typesupport_fastrtps_cpp::_LaneInfo__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, ros2_interface, msg, LaneInfo)() {
  return &ros2_interface::msg::typesupport_fastrtps_cpp::_LaneInfo__handle;
}
