...
#include "ros2_interface/msg/detail/key_point__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const ros2_interface::msg::KeyPoint & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  ros2_interface::msg::KeyPoint & ros_message)
{
  // Member: id
  cdr >> ros_message.id;
  ...
  size_t current_alignment)
{
  ...
  // Member: ele
  {
    size_t item_size = sizeof(ros_message.ele);
    current_alignment += item_size +
      eprosima::fastcdr::Cdr::alignment(current_alignment, item_size);
  }
  // Member: heading
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = ros2_interface::msg::KeyPoint;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const ros2_interface::msg::KeyPoint *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<ros2_interface::msg::KeyPoint *>(
    untyped_ros_message);
...
static size_t _KeyPoint__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_KeyPoint(full_bounded, is_plain, 0);
...
get_message_type_support_handle<ros2_interface::msg::KeyPoint>()
{
  return &ros2_interface::msg::typesupport_fastrtps_cpp::_KeyPoint__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, ros2_interface, msg, KeyPoint)() {
  return &ros2_interface::msg::typesupport_fastrtps_cpp::_KeyPoint__handle;
}
