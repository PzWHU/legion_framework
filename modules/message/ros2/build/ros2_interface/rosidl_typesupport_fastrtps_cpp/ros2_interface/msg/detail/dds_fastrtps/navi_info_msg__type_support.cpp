...
#include "ros2_interface/msg/detail/navi_info_msg__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const ros2_interface::msg::NaviInfoMsg & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  ros2_interface::msg::NaviInfoMsg & ros_message)
{
  // Member: header
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_ros2_interface
max_serialized_size_NaviInfoMsg(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = ros2_interface::msg::NaviInfoMsg;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const ros2_interface::msg::NaviInfoMsg *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<ros2_interface::msg::NaviInfoMsg *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _NaviInfoMsg__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const ros2_interface::msg::NaviInfoMsg *>(
...
static size_t _NaviInfoMsg__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_NaviInfoMsg(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _NaviInfoMsg__callbacks = {
  "ros2_interface::msg",
  "NaviInfoMsg",
...
static rosidl_message_type_support_t _NaviInfoMsg__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_NaviInfoMsg__callbacks,
...
{
  return &ros2_interface::msg::typesupport_fastrtps_cpp::_NaviInfoMsg__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, ros2_interface, msg, NaviInfoMsg)() {
  return &ros2_interface::msg::typesupport_fastrtps_cpp::_NaviInfoMsg__handle;
}
