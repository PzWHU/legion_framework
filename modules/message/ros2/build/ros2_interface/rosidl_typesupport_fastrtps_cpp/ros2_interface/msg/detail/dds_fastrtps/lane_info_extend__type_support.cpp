...
#include "ros2_interface/msg/detail/lane_info_extend__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
bool cdr_serialize(
  const ros2_interface::msg::LanePoint &,
...
cdr_serialize(
  const ros2_interface::msg::LaneInfoExtend & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  {
    cdr << ros_message.predecessor_ids;
  }
  // Member: successor_ids
  {
    cdr << ros_message.successor_ids;
  }
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  ros2_interface::msg::LaneInfoExtend & ros_message)
{
  // Member: priority
  cdr >> ros_message.priority;
  ...
  // Member: lane_points
  {
    ...
    ros_message.lane_points.resize(size);
    for (size_t i = 0; i < size; i++) {
      ros2_interface::msg::typesupport_fastrtps_cpp::cdr_deserialize(
        cdr, ros_message.lane_points[i]);
    }
  }
  ...
  size_t current_alignment)
{
  ...
  // Member: predecessor_ids
  {
    ...
    size_t item_size = sizeof(ros_message.predecessor_ids[0]);
  ...
  // Member: successor_ids
  {
    ...
    current_alignment += padding +
      eprosima::fastcdr::Cdr::alignment(current_alignment, padding);
    size_t item_size = sizeof(ros_message.successor_ids[0]);
    current_alignment += array_size * item_size +
      eprosima::fastcdr::Cdr::alignment(current_alignment, item_size);
  }
  // Member: left_neighbor_id
  ...
  // Member: lane_points
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        ...
        ros_message.lane_points[index], current_alignment);
    }
  }
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_ros2_interface
max_serialized_size_LaneInfoExtend(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  // Member: lane_points
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        ros2_interface::msg::typesupport_fastrtps_cpp::max_serialized_size_LanePoint(
  ...
  if (is_plain) {
    ...
    using DataType = ros2_interface::msg::LaneInfoExtend;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const ros2_interface::msg::LaneInfoExtend *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<ros2_interface::msg::LaneInfoExtend *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _LaneInfoExtend__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const ros2_interface::msg::LaneInfoExtend *>(
...
static size_t _LaneInfoExtend__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_LaneInfoExtend(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _LaneInfoExtend__callbacks = {
  "ros2_interface::msg",
  "LaneInfoExtend",
...
static rosidl_message_type_support_t _LaneInfoExtend__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_LaneInfoExtend__callbacks,
...
{
  return &ros2_interface::msg::typesupport_fastrtps_cpp::_LaneInfoExtend__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, ros2_interface, msg, LaneInfoExtend)() {
  return &ros2_interface::msg::typesupport_fastrtps_cpp::_LaneInfoExtend__handle;
}
