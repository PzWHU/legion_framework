...
#include "ros2_interface/msg/detail/path_point__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const ros2_interface::msg::PathPoint & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  ros2_interface::msg::PathPoint & ros_message)
{
  // Member: x
  cdr >> ros_message.x;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = ros2_interface::msg::PathPoint;
    is_plain =
      (
      offsetof(DataType, y_derivative) +
      last_member_size
      ) == ret_val;
  }
...
{
  auto typed_message =
    static_cast<const ros2_interface::msg::PathPoint *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<ros2_interface::msg::PathPoint *>(
    untyped_ros_message);
...
get_message_type_support_handle<ros2_interface::msg::PathPoint>()
{
  return &ros2_interface::msg::typesupport_fastrtps_cpp::_PathPoint__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, ros2_interface, msg, PathPoint)() {
  return &ros2_interface::msg::typesupport_fastrtps_cpp::_PathPoint__handle;
}
