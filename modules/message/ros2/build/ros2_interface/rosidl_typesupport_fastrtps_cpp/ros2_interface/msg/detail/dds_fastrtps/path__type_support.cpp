...
#include "ros2_interface/msg/detail/path__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = ros2_interface::msg::Path;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const ros2_interface::msg::Path *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<ros2_interface::msg::Path *>(
    untyped_ros_message);
...
{
  return &ros2_interface::msg::typesupport_fastrtps_cpp::_Path__handle;
}
