...
#include "ros2_interface/msg/detail/junction_info__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const ros2_interface::msg::JunctionInfo & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  ros2_interface::msg::JunctionInfo & ros_message)
{
  // Member: id
  cdr >> ros_message.id;
  ...
  // Member: stop_line
  {
    ...
    ros_message.stop_line.resize(size);
    for (size_t i = 0; i < size; i++) {
      ros2_interface::msg::typesupport_fastrtps_cpp::cdr_deserialize(
        cdr, ros_message.stop_line[i]);
    }
  }
  ...
  // Member: stop_line
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        ...
        ros_message.stop_line[index], current_alignment);
    }
  }
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = ros2_interface::msg::JunctionInfo;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const ros2_interface::msg::JunctionInfo *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<ros2_interface::msg::JunctionInfo *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _JunctionInfo__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const ros2_interface::msg::JunctionInfo *>(
...
static size_t _JunctionInfo__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_JunctionInfo(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _JunctionInfo__callbacks = {
  "ros2_interface::msg",
  "JunctionInfo",
...
static rosidl_message_type_support_t _JunctionInfo__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_JunctionInfo__callbacks,
...
{
  return &ros2_interface::msg::typesupport_fastrtps_cpp::_JunctionInfo__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, ros2_interface, msg, JunctionInfo)() {
  return &ros2_interface::msg::typesupport_fastrtps_cpp::_JunctionInfo__handle;
}
