...
#include "ros2_interface/msg/detail/holistic_path_prediction__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const ros2_interface::msg::HolisticPathPrediction & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  ros2_interface::msg::HolisticPathPrediction & ros_message)
{
  // Member: hpp
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = ros2_interface::msg::HolisticPathPrediction;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const ros2_interface::msg::HolisticPathPrediction *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<ros2_interface::msg::HolisticPathPrediction *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _HolisticPathPrediction__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const ros2_interface::msg::HolisticPathPrediction *>(
...
static size_t _HolisticPathPrediction__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_HolisticPathPrediction(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _HolisticPathPrediction__callbacks = {
  "ros2_interface::msg",
...
static rosidl_message_type_support_t _HolisticPathPrediction__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_HolisticPathPrediction__callbacks,
...
{
  return &ros2_interface::msg::typesupport_fastrtps_cpp::_HolisticPathPrediction__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, ros2_interface, msg, HolisticPathPrediction)() {
  return &ros2_interface::msg::typesupport_fastrtps_cpp::_HolisticPathPrediction__handle;
}
