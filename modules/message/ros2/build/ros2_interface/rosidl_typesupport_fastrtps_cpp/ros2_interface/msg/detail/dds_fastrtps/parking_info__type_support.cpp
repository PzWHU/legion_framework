...
#include "ros2_interface/msg/detail/parking_info__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
bool cdr_serialize(
  const ros2_interface::msg::ParkingStopper &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
...
cdr_serialize(
  const ros2_interface::msg::ParkingInfo & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Member: parking_stoppers
  {
    ...
    for (size_t i = 0; i < size; i++) {
      ros2_interface::msg::typesupport_fastrtps_cpp::cdr_serialize(
        ros_message.parking_stoppers[i],
        cdr);
    }
  }
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  ros2_interface::msg::ParkingInfo & ros_message)
{
  // Member: header
  ...
  // Member: parking_stoppers
  {
    ...
    ros_message.parking_stoppers.resize(size);
    for (size_t i = 0; i < size; i++) {
      ros2_interface::msg::typesupport_fastrtps_cpp::cdr_deserialize(
        cdr, ros_message.parking_stoppers[i]);
    }
  }
  ...
  size_t current_alignment)
{
  ...
  // Member: parking_stoppers
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        ros2_interface::msg::typesupport_fastrtps_cpp::get_serialized_size(
        ros_message.parking_stoppers[index], current_alignment);
    }
  }
  // Member: parking_direction_type
  {
  ...
  size_t current_alignment)
{
  ...
  // Member: parking_stoppers
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        ros2_interface::msg::typesupport_fastrtps_cpp::max_serialized_size_ParkingStopper(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    using DataType = ros2_interface::msg::ParkingInfo;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const ros2_interface::msg::ParkingInfo *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<ros2_interface::msg::ParkingInfo *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _ParkingInfo__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const ros2_interface::msg::ParkingInfo *>(
...
static size_t _ParkingInfo__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_ParkingInfo(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _ParkingInfo__callbacks = {
  "ros2_interface::msg",
  "ParkingInfo",
...
static rosidl_message_type_support_t _ParkingInfo__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_ParkingInfo__callbacks,
...
{
  return &ros2_interface::msg::typesupport_fastrtps_cpp::_ParkingInfo__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, ros2_interface, msg, ParkingInfo)() {
  return &ros2_interface::msg::typesupport_fastrtps_cpp::_ParkingInfo__handle;
}
