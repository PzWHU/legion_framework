...
#include "ros2_interface/msg/detail/prediction_obstacles__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
bool cdr_serialize(
  const ros2_interface::msg::PredictionObstacle &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
...
cdr_serialize(
  const ros2_interface::msg::PredictionObstacles & ros_message,
  ...
  // Member: prediction_obstacles
  {
    ...
    for (size_t i = 0; i < size; i++) {
      ros2_interface::msg::typesupport_fastrtps_cpp::cdr_serialize(
        ros_message.prediction_obstacles[i],
        cdr);
    }
  }
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  ros2_interface::msg::PredictionObstacles & ros_message)
{
  // Member: header
  ...
  // Member: prediction_obstacles
  {
    ...
    ros_message.prediction_obstacles.resize(size);
    for (size_t i = 0; i < size; i++) {
      ros2_interface::msg::typesupport_fastrtps_cpp::cdr_deserialize(
        cdr, ros_message.prediction_obstacles[i]);
    }
  }
  ...
  // Member: prediction_obstacles
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        ...
        ros_message.prediction_obstacles[index], current_alignment);
    }
  }
  // Member: change_origin_flag
  {
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_ros2_interface
max_serialized_size_PredictionObstacles(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  // Member: prediction_obstacles
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        ros2_interface::msg::typesupport_fastrtps_cpp::max_serialized_size_PredictionObstacle(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    using DataType = ros2_interface::msg::PredictionObstacles;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const ros2_interface::msg::PredictionObstacles *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<ros2_interface::msg::PredictionObstacles *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _PredictionObstacles__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const ros2_interface::msg::PredictionObstacles *>(
...
static size_t _PredictionObstacles__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_PredictionObstacles(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _PredictionObstacles__callbacks = {
  "ros2_interface::msg",
  "PredictionObstacles",
...
static rosidl_message_type_support_t _PredictionObstacles__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_PredictionObstacles__callbacks,
...
{
  return &ros2_interface::msg::typesupport_fastrtps_cpp::_PredictionObstacles__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, ros2_interface, msg, PredictionObstacles)() {
  return &ros2_interface::msg::typesupport_fastrtps_cpp::_PredictionObstacles__handle;
}
