...
#include "ros2_interface/msg/detail/routing_request__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
bool cdr_serialize(
  const ros2_interface::msg::KeyPoint &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
  ros2_interface::msg::KeyPoint &);
size_t get_serialized_size(
  const ros2_interface::msg::KeyPoint &,
  size_t current_alignment);
size_t
...
cdr_serialize(
  const ros2_interface::msg::RoutingRequest & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  ros2_interface::msg::RoutingRequest & ros_message)
{
  // Member: header
  ...
  // Member: key_point_list
  {
    ...
    ros_message.key_point_list.resize(size);
    for (size_t i = 0; i < size; i++) {
      ros2_interface::msg::typesupport_fastrtps_cpp::cdr_deserialize(
        cdr, ros_message.key_point_list[i]);
    }
  }
  ...
  // Member: key_point_list
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        ...
        ros_message.key_point_list[index], current_alignment);
    }
  }
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_ros2_interface
max_serialized_size_RoutingRequest(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  // Member: key_point_list
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        ros2_interface::msg::typesupport_fastrtps_cpp::max_serialized_size_KeyPoint(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    using DataType = ros2_interface::msg::RoutingRequest;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const ros2_interface::msg::RoutingRequest *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<ros2_interface::msg::RoutingRequest *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _RoutingRequest__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const ros2_interface::msg::RoutingRequest *>(
...
static size_t _RoutingRequest__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_RoutingRequest(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _RoutingRequest__callbacks = {
  "ros2_interface::msg",
  "RoutingRequest",
...
static rosidl_message_type_support_t _RoutingRequest__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_RoutingRequest__callbacks,
...
{
  return &ros2_interface::msg::typesupport_fastrtps_cpp::_RoutingRequest__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, ros2_interface, msg, RoutingRequest)() {
  return &ros2_interface::msg::typesupport_fastrtps_cpp::_RoutingRequest__handle;
}
