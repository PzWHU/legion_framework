...
#include "ros2_interface/msg/detail/guide_road__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
bool cdr_serialize(
  const ros2_interface::msg::CurvatureInfo &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
  ros2_interface::msg::CurvatureInfo &);
...
cdr_serialize(
  const ros2_interface::msg::GuideRoad & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  ros2_interface::msg::GuideRoad & ros_message)
{
  // Member: road_id
  cdr >> ros_message.road_id;
  ...
  // Member: curvature
  {
    ...
    ros_message.curvature.resize(size);
    for (size_t i = 0; i < size; i++) {
      ros2_interface::msg::typesupport_fastrtps_cpp::cdr_deserialize(
        cdr, ros_message.curvature[i]);
    }
  }
  ...
  // Member: curvature
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        ...
        ros_message.curvature[index], current_alignment);
    }
  }
  ...
  size_t current_alignment)
{
  ...
  // Member: curvature
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        ros2_interface::msg::typesupport_fastrtps_cpp::max_serialized_size_CurvatureInfo(
  ...
  if (is_plain) {
    ...
    using DataType = ros2_interface::msg::GuideRoad;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const ros2_interface::msg::GuideRoad *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<ros2_interface::msg::GuideRoad *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _GuideRoad__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const ros2_interface::msg::GuideRoad *>(
...
static size_t _GuideRoad__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_GuideRoad(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _GuideRoad__callbacks = {
  "ros2_interface::msg",
  "GuideRoad",
...
static rosidl_message_type_support_t _GuideRoad__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_GuideRoad__callbacks,
...
{
  return &ros2_interface::msg::typesupport_fastrtps_cpp::_GuideRoad__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, ros2_interface, msg, GuideRoad)() {
  return &ros2_interface::msg::typesupport_fastrtps_cpp::_GuideRoad__handle;
}
