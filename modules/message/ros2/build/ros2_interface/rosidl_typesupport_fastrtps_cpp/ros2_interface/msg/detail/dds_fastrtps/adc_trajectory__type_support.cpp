...
#include "ros2_interface/msg/detail/adc_trajectory__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
bool cdr_serialize(
  const ros2_interface::msg::EStop &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
  ros2_interface::msg::EStop &);
size_t get_serialized_size(
  const ros2_interface::msg::EStop &,
  size_t current_alignment);
size_t
max_serialized_size_EStop(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment);
}  // namespace typesupport_fastrtps_cpp
...
{
bool cdr_serialize(
  const ros2_interface::msg::RSSInfo &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
...
cdr_serialize(
  const ros2_interface::msg::ADCTrajectory & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  ros2_interface::msg::ADCTrajectory & ros_message)
{
  // Member: header
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_ros2_interface
max_serialized_size_ADCTrajectory(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  // Member: estop
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        ros2_interface::msg::typesupport_fastrtps_cpp::max_serialized_size_EStop(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  // Member: rss_info
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        ros2_interface::msg::typesupport_fastrtps_cpp::max_serialized_size_RSSInfo(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    using DataType = ros2_interface::msg::ADCTrajectory;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const ros2_interface::msg::ADCTrajectory *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<ros2_interface::msg::ADCTrajectory *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _ADCTrajectory__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const ros2_interface::msg::ADCTrajectory *>(
...
static size_t _ADCTrajectory__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_ADCTrajectory(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _ADCTrajectory__callbacks = {
  "ros2_interface::msg",
  "ADCTrajectory",
...
static rosidl_message_type_support_t _ADCTrajectory__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_ADCTrajectory__callbacks,
...
{
  return &ros2_interface::msg::typesupport_fastrtps_cpp::_ADCTrajectory__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, ros2_interface, msg, ADCTrajectory)() {
  return &ros2_interface::msg::typesupport_fastrtps_cpp::_ADCTrajectory__handle;
}
