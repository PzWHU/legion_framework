...
#include "ros2_interface/msg/detail/twist__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = ros2_interface::msg::Twist;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const ros2_interface::msg::Twist *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<ros2_interface::msg::Twist *>(
    untyped_ros_message);
...
{
  return &ros2_interface::msg::typesupport_fastrtps_cpp::_Twist__handle;
}
