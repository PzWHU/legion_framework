...
static const _HolisticPathPrediction_type_support_symbol_names_t _HolisticPathPrediction_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, ros2_interface, msg, HolisticPathPrediction)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, ros2_interface, msg, HolisticPathPrediction)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, ros2_interface, msg, HolisticPathPrediction)() {
  return &::ros2_interface::msg::rosidl_typesupport_c::HolisticPathPrediction_message_type_support_handle;
}
