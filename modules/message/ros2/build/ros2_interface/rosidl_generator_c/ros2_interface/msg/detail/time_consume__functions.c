...
ros2_interface__msg__TimeConsume__init(ros2_interface__msg__TimeConsume * msg)
{
  ...
  if (!rosidl_runtime_c__String__init(&msg->name)) {
    ros2_interface__msg__TimeConsume__fini(msg);
    return false;
  }
  // time_consume
  return true;
...
ros2_interface__msg__TimeConsume__are_equal(const ros2_interface__msg__TimeConsume * lhs, const ros2_interface__msg__TimeConsume * rhs)
{
  ...
  // time_consume
  if (lhs->time_consume != rhs->time_consume) {
    return false;
  }
  return true;
}
  ...
  ros2_interface__msg__TimeConsume * output)
{
  ...
  // time_consume
  output->time_consume = input->time_consume;
  return true;
}
...
ros2_interface__msg__TimeConsume__create()
{
  ...
  ros2_interface__msg__TimeConsume * msg = (ros2_interface__msg__TimeConsume *)allocator.allocate(sizeof(ros2_interface__msg__TimeConsume), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(ros2_interface__msg__TimeConsume));
  bool success = ros2_interface__msg__TimeConsume__init(msg);
  if (!success) {
...
ros2_interface__msg__TimeConsume__Sequence__init(ros2_interface__msg__TimeConsume__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  ros2_interface__msg__TimeConsume * data = NULL;

  if (size) {
    data = (ros2_interface__msg__TimeConsume *)allocator.zero_allocate(size, sizeof(ros2_interface__msg__TimeConsume), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = ros2_interface__msg__TimeConsume__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        ros2_interface__msg__TimeConsume__fini(&data[i - 1]);
      }
...
ros2_interface__msg__TimeConsume__Sequence__fini(ros2_interface__msg__TimeConsume__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      ros2_interface__msg__TimeConsume__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  ros2_interface__msg__TimeConsume__Sequence * array = (ros2_interface__msg__TimeConsume__Sequence *)allocator.allocate(sizeof(ros2_interface__msg__TimeConsume__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = ros2_interface__msg__TimeConsume__Sequence__init(array, size);
  if (!success) {
...
ros2_interface__msg__TimeConsume__Sequence__destroy(ros2_interface__msg__TimeConsume__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    ros2_interface__msg__TimeConsume__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
ros2_interface__msg__TimeConsume__Sequence__are_equal(const ros2_interface__msg__TimeConsume__Sequence * lhs, const ros2_interface__msg__TimeConsume__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!ros2_interface__msg__TimeConsume__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  ros2_interface__msg__TimeConsume__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(ros2_interface__msg__TimeConsume);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    ros2_interface__msg__TimeConsume * data =
      (ros2_interface__msg__TimeConsume *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!ros2_interface__msg__TimeConsume__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          ros2_interface__msg__TimeConsume__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!ros2_interface__msg__TimeConsume__copy(
