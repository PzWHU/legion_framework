...
bool ros2_interface__msg__point_cloud__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("ros2_interface.msg._point_cloud.PointCloud", full_classname_dest, 42) == 0);
  }
  ros2_interface__msg__PointCloud * ros_message = _ros_message;
  {  // header
  ...
  {  // point
    ...
    if (!ros2_interface__msg__PointXYZIRT__Sequence__init(&(ros_message->point), size)) {
      PyErr_SetString(PyExc_RuntimeError, "unable to create ros2_interface__msg__PointXYZIRT__Sequence ros_message");
      Py_DECREF(seq_field);
      Py_DECREF(field);
      return false;
    }
    ros2_interface__msg__PointXYZIRT * dest = ros_message->point.data;
    for (Py_ssize_t i = 0; i < size; ++i) {
      if (!ros2_interface__msg__point_xyzirt__convert_from_py(PySequence_Fast_GET_ITEM(seq_field, i), &dest[i])) {
        Py_DECREF(seq_field);
        Py_DECREF(field);
        return false;
      }
  ...
  {  // measurement_time
    ...
    ros_message->measurement_time = PyFloat_AS_DOUBLE(field);
    Py_DECREF(field);
  }
  {  // width
...
PyObject * ros2_interface__msg__point_cloud__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("ros2_interface.msg._point_cloud");
  ...
  {  // point
    ...
    for (size_t i = 0; i < size; ++i) {
      ...
      PyObject * pyitem = ros2_interface__msg__point_xyzirt__convert_to_py(item);
      if (!pyitem) {
        Py_DECREF(field);
        return NULL;
      }
  ...
  {  // measurement_time
    PyObject * field = NULL;
    field = PyFloat_FromDouble(ros_message->measurement_time);
    {
