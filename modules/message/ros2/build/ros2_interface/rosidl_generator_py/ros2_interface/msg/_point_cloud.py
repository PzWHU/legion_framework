...
class Metaclass_PointCloud(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from ros2_interface.msg import PointXYZIRT
            if PointXYZIRT.__class__._TYPE_SUPPORT is None:
                PointXYZIRT.__class__.__import_type_support__()
...
class PointCloud(metaclass=Metaclass_PointCloud):
    ...
    _fields_and_field_types = {
        ...
        'frame_id': 'string',
        'is_dense': 'boolean',
        'point': 'sequence<ros2_interface/PointXYZIRT>',
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.UnboundedSequence(rosidl_parser.definition.NamespacedType(['ros2_interface', 'msg'], 'PointXYZIRT')),  # noqa: E501
        ...
        if __debug__:
            ...
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 all(isinstance(v, PointXYZIRT) for v in value) and
                 True), \
                "The 'point' field must be a set or sequence and each value of type 'PointXYZIRT'"
        self._point = value
