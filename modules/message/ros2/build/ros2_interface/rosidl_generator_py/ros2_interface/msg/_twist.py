...
class Twist(metaclass=Metaclass_Twist):
    ...
    _fields_and_field_types = {
        ...
        'linear': 'ros2_interface/Point3D',
        'angular': 'ros2_interface/Point3D',
    }
    ...
    def __init__(self, **kwargs):
        ...
        from ros2_interface.msg import Point3D
        self.linear = kwargs.get('linear', Point3D())
        from ros2_interface.msg import Point3D
        self.angular = kwargs.get('angular', Point3D())
    ...
    def linear(self, value):
        if __debug__:
            ...
            assert \
                ...
                "The 'linear' field must be a sub message of type 'Point3D'"
        self._linear = value
    ...
    def angular(self, value):
        if __debug__:
            ...
            assert \
                isinstance(value, Point3D), \
                "The 'angular' field must be a sub message of type 'Point3D'"
        self._angular = value
