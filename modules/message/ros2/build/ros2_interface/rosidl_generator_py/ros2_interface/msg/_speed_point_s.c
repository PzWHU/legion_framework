...
bool ros2_interface__msg__speed_point__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("ros2_interface.msg._speed_point.SpeedPoint", full_classname_dest, 42) == 0);
  }
  ros2_interface__msg__SpeedPoint * ros_message = _ros_message;
  {  // s
...
{
  /* NOTE(esteve): Call constructor of SpeedPoint */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("ros2_interface.msg._speed_point");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "SpeedPoint");
