...
bool ros2_interface__msg__time__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("ros2_interface.msg._time.Time", full_classname_dest, 29) == 0);
  }
  ros2_interface__msg__Time * ros_message = _ros_message;
  {  // sec
  ...
  {  // nsec
    PyObject * field = PyObject_GetAttrString(_pymsg, "nsec");
    if (!field) {
      return false;
    }
    assert(PyLong_Check(field));
    ros_message->nsec = PyLong_AsUnsignedLong(field);
    Py_DECREF(field);
  }
...
PyObject * ros2_interface__msg__time__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("ros2_interface.msg._time");
  ...
  {  // nsec
    PyObject * field = NULL;
    field = PyLong_FromUnsignedLong(ros_message->nsec);
    {
      int rc = PyObject_SetAttrString(_pymessage, "nsec", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
