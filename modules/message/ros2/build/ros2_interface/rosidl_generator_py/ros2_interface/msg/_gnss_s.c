...
bool ros2_interface__msg__gnss__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("ros2_interface.msg._gnss.Gnss", full_classname_dest, 29) == 0);
  }
  ros2_interface__msg__Gnss * ros_message = _ros_message;
  {  // is_valid
  ...
  {  // utm_zone_num
    PyObject * field = PyObject_GetAttrString(_pymsg, "utm_zone_num");
    if (!field) {
      return false;
    }
    assert(PyLong_Check(field));
    ros_message->utm_zone_num = (int32_t)PyLong_AsLong(field);
    Py_DECREF(field);
  }
  {  // utm_zone_char
...
PyObject * ros2_interface__msg__gnss__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("ros2_interface.msg._gnss");
  ...
  {  // utm_zone_num
    PyObject * field = NULL;
    field = PyLong_FromLong(ros_message->utm_zone_num);
    {
      int rc = PyObject_SetAttrString(_pymessage, "utm_zone_num", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
