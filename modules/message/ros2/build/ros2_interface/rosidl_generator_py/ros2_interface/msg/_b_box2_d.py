...
class Metaclass_BBox2D(type):
    """Metaclass of message 'BBox2D'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__msg__b_box2_d
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__msg__b_box2_d
            cls._CONVERT_TO_PY = module.convert_to_py_msg__msg__b_box2_d
            cls._TYPE_SUPPORT = module.type_support_msg__msg__b_box2_d
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__msg__b_box2_d
...
class BBox2D(metaclass=Metaclass_BBox2D):
    """Message class 'BBox2D'."""
