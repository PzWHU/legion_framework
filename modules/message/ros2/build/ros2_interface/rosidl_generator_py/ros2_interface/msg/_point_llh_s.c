...
bool ros2_interface__msg__point_llh__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("ros2_interface.msg._point_llh.PointLLH", full_classname_dest, 38) == 0);
  }
  ros2_interface__msg__PointLLH * ros_message = _ros_message;
  {  // lon
...
{
  /* NOTE(esteve): Call constructor of PointLLH */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("ros2_interface.msg._point_llh");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "PointLLH");
