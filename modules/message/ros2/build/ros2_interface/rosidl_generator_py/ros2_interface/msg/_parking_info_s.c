...
bool ros2_interface__msg__parking_info__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("ros2_interface.msg._parking_info.ParkingInfo", full_classname_dest, 44) == 0);
  }
  ros2_interface__msg__ParkingInfo * ros_message = _ros_message;
  {  // header
  ...
  {  // is_lane_width_valid
    PyObject * field = PyObject_GetAttrString(_pymsg, "is_lane_width_valid");
    if (!field) {
      return false;
    }
    assert(PyBool_Check(field));
    ros_message->is_lane_width_valid = (Py_True == field);
    Py_DECREF(field);
  }
  {  // lane_width
  ...
  {  // parking_stoppers
    PyObject * field = PyObject_GetAttrString(_pymsg, "parking_stoppers");
    if (!field) {
      return false;
    }
    PyObject * seq_field = PySequence_Fast(field, "expected a sequence in 'parking_stoppers'");
    if (!seq_field) {
      Py_DECREF(field);
      return false;
    }
    ...
    if (!ros2_interface__msg__ParkingStopper__Sequence__init(&(ros_message->parking_stoppers), size)) {
      PyErr_SetString(PyExc_RuntimeError, "unable to create ros2_interface__msg__ParkingStopper__Sequence ros_message");
      Py_DECREF(seq_field);
      Py_DECREF(field);
      return false;
    }
    ros2_interface__msg__ParkingStopper * dest = ros_message->parking_stoppers.data;
    for (Py_ssize_t i = 0; i < size; ++i) {
      if (!ros2_interface__msg__parking_stopper__convert_from_py(PySequence_Fast_GET_ITEM(seq_field, i), &dest[i])) {
        Py_DECREF(seq_field);
        Py_DECREF(field);
        return false;
      }
  ...
  {  // left_occupied_status
    PyObject * field = PyObject_GetAttrString(_pymsg, "left_occupied_status");
    if (!field) {
      return false;
    }
    assert(PyLong_Check(field));
    ros_message->left_occupied_status = (int32_t)PyLong_AsLong(field);
    Py_DECREF(field);
  }
  {  // right_occupied_status
    PyObject * field = PyObject_GetAttrString(_pymsg, "right_occupied_status");
    if (!field) {
      return false;
    }
    assert(PyLong_Check(field));
    ros_message->right_occupied_status = (int32_t)PyLong_AsLong(field);
    Py_DECREF(field);
  }
  {  // parking_source_type
...
{
  /* NOTE(esteve): Call constructor of ParkingInfo */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("ros2_interface.msg._parking_info");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "ParkingInfo");
  ...
  {  // is_lane_width_valid
    PyObject * field = NULL;
    field = PyBool_FromLong(ros_message->is_lane_width_valid ? 1 : 0);
    {
      int rc = PyObject_SetAttrString(_pymessage, "is_lane_width_valid", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
  ...
  {  // parking_stoppers
    ...
    for (size_t i = 0; i < size; ++i) {
      item = &(ros_message->parking_stoppers.data[i]);
      PyObject * pyitem = ros2_interface__msg__parking_stopper__convert_to_py(item);
      if (!pyitem) {
        Py_DECREF(field);
        return NULL;
      }
    ...
    {
      int rc = PyObject_SetAttrString(_pymessage, "parking_stoppers", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
  ...
  {  // left_occupied_status
    PyObject * field = NULL;
    field = PyLong_FromLong(ros_message->left_occupied_status);
    {
      int rc = PyObject_SetAttrString(_pymessage, "left_occupied_status", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
  ...
  {  // right_occupied_status
    PyObject * field = NULL;
    field = PyLong_FromLong(ros_message->right_occupied_status);
    {
      int rc = PyObject_SetAttrString(_pymessage, "right_occupied_status", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
