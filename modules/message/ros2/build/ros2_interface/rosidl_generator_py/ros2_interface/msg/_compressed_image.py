    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger(
                'ros2_interface.msg.CompressedImage')
            logger.debug(
...
class CompressedImage(metaclass=Metaclass_CompressedImage):
    ...
    def __init__(self, **kwargs):
        ...
        self.frame_type = kwargs.get('frame_type', int())
    ...
    def frame_type(self, value):
        if __debug__:
            assert \
                ...
                "The 'frame_type' field must be of type 'int'"
            assert value >= 0 and value < 4294967296, \
                "The 'frame_type' field must be an unsigned integer in [0, 4294967295]"
