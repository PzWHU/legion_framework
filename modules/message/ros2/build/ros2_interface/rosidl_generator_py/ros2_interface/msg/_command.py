...
class Command(metaclass=Metaclass_Command):
    ...
    def __init__(self, **kwargs):
        ...
        self.target_module = kwargs.get('target_module', str())
        self.target_id = kwargs.get('target_id', int())
        self.target_switch = kwargs.get('target_switch', int())
    ...
    def __eq__(self, other):
        if not isinstance(other, self.__class__):
            return False
        if self.target_module != other.target_module:
            return False
        if self.target_id != other.target_id:
            return False
        if self.target_switch != other.target_switch:
            return False
        return True
    ...
    def target_module(self):
        """Message field 'target_module'."""
        return self._target_module

    @target_module.setter
    def target_module(self, value):
        if __debug__:
            assert \
                isinstance(value, str), \
                "The 'target_module' field must be of type 'str'"
    ...
    def target_id(self, value):
        if __debug__:
            ...
            assert value >= -128 and value < 128, \
                "The 'target_id' field must be an integer in [-128, 127]"
        self._target_id = value

    @builtins.property
    def target_switch(self):
        """Message field 'target_switch'."""
        return self._target_switch

    @target_switch.setter
    def target_switch(self, value):
        if __debug__:
            assert \
                isinstance(value, int), \
                "The 'target_switch' field must be of type 'int'"
            assert value >= -2147483648 and value < 2147483648, \
                "The 'target_switch' field must be an integer in [-2147483648, 2147483647]"
        self._target_switch = value
