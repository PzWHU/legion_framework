...
bool ros2_interface__msg__polygon2_d__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("ros2_interface.msg._polygon2_d.Polygon2D", full_classname_dest, 40) == 0);
  }
  ros2_interface__msg__Polygon2D * ros_message = _ros_message;
  {  // coordinate_system
    ...
    ros_message->coordinate_system = (int32_t)PyLong_AsLong(field);
    Py_DECREF(field);
  }
  {  // points
    ...
    ros2_interface__msg__Point2D * dest = ros_message->points.data;
...
PyObject * ros2_interface__msg__polygon2_d__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("ros2_interface.msg._polygon2_d");
  ...
  {  // coordinate_system
    PyObject * field = NULL;
    field = PyLong_FromLong(ros_message->coordinate_system);
    {
