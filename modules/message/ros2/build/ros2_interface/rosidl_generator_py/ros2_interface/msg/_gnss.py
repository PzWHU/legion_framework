...
class Gnss(metaclass=Metaclass_Gnss):
    ...
    def __init__(self, **kwargs):
        ...
        self.utm_zone_num = kwargs.get('utm_zone_num', int())
    ...
    def __eq__(self, other):
        ...
        if self.utm_position != other.utm_position:
            return False
        if self.utm_zone_num != other.utm_zone_num:
            return False
    ...
    @builtins.property
    def utm_zone_num(self):
        """Message field 'utm_zone_num'."""
        return self._utm_zone_num

    @utm_zone_num.setter
    def utm_zone_num(self, value):
        if __debug__:
            assert \
                isinstance(value, int), \
                "The 'utm_zone_num' field must be of type 'int'"
            assert value >= -2147483648 and value < 2147483648, \
                "The 'utm_zone_num' field must be an integer in [-2147483648, 2147483647]"
        self._utm_zone_num = value
