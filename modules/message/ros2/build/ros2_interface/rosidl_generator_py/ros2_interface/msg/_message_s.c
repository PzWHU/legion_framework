...
bool ros2_interface__msg__message__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("ros2_interface.msg._message.Message", full_classname_dest, 35) == 0);
  }
  ros2_interface__msg__Message * ros_message = _ros_message;
  {  // code
...
PyObject * ros2_interface__msg__message__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("ros2_interface.msg._message");
