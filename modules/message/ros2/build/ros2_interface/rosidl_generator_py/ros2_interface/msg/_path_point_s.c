...
bool ros2_interface__msg__path_point__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("ros2_interface.msg._path_point.PathPoint", full_classname_dest, 40) == 0);
  }
  ros2_interface__msg__PathPoint * ros_message = _ros_message;
  {  // x
  ...
  {  // lane_id
    ...
    assert(PyFloat_Check(field));
    ros_message->lane_id = PyFloat_AS_DOUBLE(field);
    Py_DECREF(field);
  }
  {  // x_derivative
...
PyObject * ros2_interface__msg__path_point__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("ros2_interface.msg._path_point");
  ...
  {  // lane_id
    PyObject * field = NULL;
    field = PyFloat_FromDouble(ros_message->lane_id);
    {
