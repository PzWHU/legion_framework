...
bool ros2_interface__msg__obstacle_priority__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("ros2_interface.msg._obstacle_priority.ObstaclePriority", full_classname_dest, 54) == 0);
  }
  ros2_interface__msg__ObstaclePriority * ros_message = _ros_message;
  {  // priority
...
{
  /* NOTE(esteve): Call constructor of ObstaclePriority */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("ros2_interface.msg._obstacle_priority");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "ObstaclePriority");
