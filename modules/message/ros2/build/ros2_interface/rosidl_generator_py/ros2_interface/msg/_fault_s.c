...
bool ros2_interface__msg__fault__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("ros2_interface.msg._fault.Fault", full_classname_dest, 31) == 0);
  }
  ros2_interface__msg__Fault * ros_message = _ros_message;
  {  // timestamp
...
{
  /* NOTE(esteve): Call constructor of Fault */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("ros2_interface.msg._fault");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "Fault");
