...
bool ros2_interface__msg__key_values__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("ros2_interface.msg._key_values.KeyValues", full_classname_dest, 40) == 0);
  }
  ros2_interface__msg__KeyValues * ros_message = _ros_message;
  {  // key
...
{
  /* NOTE(esteve): Call constructor of KeyValues */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("ros2_interface.msg._key_values");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "KeyValues");
