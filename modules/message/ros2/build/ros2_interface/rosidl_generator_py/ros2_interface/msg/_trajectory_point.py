...
class TrajectoryPoint(metaclass=Metaclass_TrajectoryPoint):
    ...
    _fields_and_field_types = {
        'path_point': 'ros2_interface/PathPoint',
        'v': 'double',
        'a': 'double',
        'relative_time': 'double',
        'da': 'double',
        'is_steer_valid': 'boolean',
        'front_steer': 'double',
        'rear_steer': 'double',
        'gear': 'int32',
    }
    ...
    SLOT_TYPES = (
        rosidl_parser.definition.NamespacedType(['ros2_interface', 'msg'], 'PathPoint'),  # noqa: E501
    ...
    def __init__(self, **kwargs):
        ...
        self.is_steer_valid = kwargs.get('is_steer_valid', bool())
        self.front_steer = kwargs.get('front_steer', float())
        self.rear_steer = kwargs.get('rear_steer', float())
    ...
    def __eq__(self, other):
        ...
        if self.da != other.da:
            return False
        if self.is_steer_valid != other.is_steer_valid:
            return False
    ...
    @builtins.property
    def is_steer_valid(self):
        """Message field 'is_steer_valid'."""
        return self._is_steer_valid

    @is_steer_valid.setter
    def is_steer_valid(self, value):
        if __debug__:
            assert \
                isinstance(value, bool), \
                "The 'is_steer_valid' field must be of type 'bool'"
        self._is_steer_valid = value
    ...
    def front_steer(self, value):
        if __debug__:
            assert \
                isinstance(value, float), \
                "The 'front_steer' field must be of type 'float'"
            assert not (value < -1.7976931348623157e+308 or value > 1.7976931348623157e+308) or math.isinf(value), \
                "The 'front_steer' field must be a double in [-1.7976931348623157e+308, 1.7976931348623157e+308]"
    ...
    def rear_steer(self, value):
        if __debug__:
            assert \
                isinstance(value, float), \
                "The 'rear_steer' field must be of type 'float'"
            assert not (value < -1.7976931348623157e+308 or value > 1.7976931348623157e+308) or math.isinf(value), \
                "The 'rear_steer' field must be a double in [-1.7976931348623157e+308, 1.7976931348623157e+308]"
