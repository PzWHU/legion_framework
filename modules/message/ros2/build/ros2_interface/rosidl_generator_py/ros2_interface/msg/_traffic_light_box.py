...
class Metaclass_TrafficLightBox(type):
    """Metaclass of message 'TrafficLightBox'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__msg__traffic_light_box
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__msg__traffic_light_box
            cls._CONVERT_TO_PY = module.convert_to_py_msg__msg__traffic_light_box
            cls._TYPE_SUPPORT = module.type_support_msg__msg__traffic_light_box
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__msg__traffic_light_box
...
class TrafficLightBox(metaclass=Metaclass_TrafficLightBox):
    """Message class 'TrafficLightBox'."""
    ...
    def __init__(self, **kwargs):
        ...
        self.selected = kwargs.get('selected', bool())
    ...
    def selected(self, value):
        if __debug__:
            assert \
                ...
                "The 'selected' field must be of type 'bool'"
