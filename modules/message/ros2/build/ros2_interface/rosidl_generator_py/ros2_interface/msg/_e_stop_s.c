...
bool ros2_interface__msg__e_stop__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("ros2_interface.msg._e_stop.EStop", full_classname_dest, 32) == 0);
  }
  ros2_interface__msg__EStop * ros_message = _ros_message;
  {  // is_estop
...
{
  /* NOTE(esteve): Call constructor of EStop */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("ros2_interface.msg._e_stop");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "EStop");
