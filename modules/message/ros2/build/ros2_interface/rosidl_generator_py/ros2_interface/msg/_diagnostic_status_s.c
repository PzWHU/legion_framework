...
bool ros2_interface__msg__key_values__convert_from_py(PyObject * _pymsg, void * _ros_message);
...
bool ros2_interface__msg__diagnostic_status__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("ros2_interface.msg._diagnostic_status.DiagnosticStatus", full_classname_dest, 54) == 0);
  }
  ros2_interface__msg__DiagnosticStatus * ros_message = _ros_message;
  {  // header
  ...
  {  // values
    ...
    if (!ros2_interface__msg__KeyValues__Sequence__init(&(ros_message->values), size)) {
      PyErr_SetString(PyExc_RuntimeError, "unable to create ros2_interface__msg__KeyValues__Sequence ros_message");
      Py_DECREF(seq_field);
      Py_DECREF(field);
      return false;
    }
    ros2_interface__msg__KeyValues * dest = ros_message->values.data;
    for (Py_ssize_t i = 0; i < size; ++i) {
      if (!ros2_interface__msg__key_values__convert_from_py(PySequence_Fast_GET_ITEM(seq_field, i), &dest[i])) {
        Py_DECREF(seq_field);
        Py_DECREF(field);
        return false;
      }
...
PyObject * ros2_interface__msg__diagnostic_status__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("ros2_interface.msg._diagnostic_status");
  ...
  {  // values
    ...
    for (size_t i = 0; i < size; ++i) {
      ...
      PyObject * pyitem = ros2_interface__msg__key_values__convert_to_py(item);
      if (!pyitem) {
        Py_DECREF(field);
        return NULL;
      }
