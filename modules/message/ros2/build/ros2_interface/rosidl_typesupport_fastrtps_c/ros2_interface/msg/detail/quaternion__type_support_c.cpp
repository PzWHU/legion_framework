...
#include "ros2_interface/msg/detail/quaternion__rosidl_typesupport_fastrtps_c.h"
...
using _Quaternion__ros_msg_type = ros2_interface__msg__Quaternion;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _Quaternion__ros_msg_type * ros_message = static_cast<const _Quaternion__ros_msg_type *>(untyped_ros_message);
  // Field name: qx
  {
    cdr << ros_message->qx;
  }
  ...
  void * untyped_ros_message)
{
  ...
  _Quaternion__ros_msg_type * ros_message = static_cast<_Quaternion__ros_msg_type *>(untyped_ros_message);
  // Field name: qx
  {
    cdr >> ros_message->qx;
  }
...
static uint32_t _Quaternion__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_ros2_interface__msg__Quaternion(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = ros2_interface__msg__Quaternion;
    is_plain =
      (
...
static size_t _Quaternion__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_ros2_interface__msg__Quaternion(
