...
#include "ros2_interface/msg/detail/diagnostic_status__rosidl_typesupport_fastrtps_c.h"
...
#include "ros2_interface/msg/detail/key_values__functions.h"  // values
...
size_t get_serialized_size_ros2_interface__msg__KeyValues(
  const void * untyped_ros_message,
  size_t current_alignment);

size_t max_serialized_size_ros2_interface__msg__KeyValues(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment);

const rosidl_message_type_support_t *
  ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, ros2_interface, msg, KeyValues)();
...
using _DiagnosticStatus__ros_msg_type = ros2_interface__msg__DiagnosticStatus;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: values
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, ros2_interface, msg, KeyValues
      )()->data);
  ...
  void * untyped_ros_message)
{
  ...
  // Field name: values
  {
    ...
    if (ros_message->values.data) {
      ros2_interface__msg__KeyValues__Sequence__fini(&ros_message->values);
    }
    if (!ros2_interface__msg__KeyValues__Sequence__init(&ros_message->values, size)) {
  ...
  size_t current_alignment)
{
  ...
  // field.name values
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment += get_serialized_size_ros2_interface__msg__KeyValues(
...
static uint32_t _DiagnosticStatus__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_ros2_interface__msg__DiagnosticStatus(
  ...
  size_t current_alignment)
{
  ...
  // member: values
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_ros2_interface__msg__KeyValues(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    using DataType = ros2_interface__msg__DiagnosticStatus;
    is_plain =
      (
...
static size_t _DiagnosticStatus__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_ros2_interface__msg__DiagnosticStatus(
