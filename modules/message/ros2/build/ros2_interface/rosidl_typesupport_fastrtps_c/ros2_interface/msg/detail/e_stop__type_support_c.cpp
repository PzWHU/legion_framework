...
#include "ros2_interface/msg/detail/e_stop__rosidl_typesupport_fastrtps_c.h"
...
using _EStop__ros_msg_type = ros2_interface__msg__EStop;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _EStop__ros_msg_type * ros_message = static_cast<const _EStop__ros_msg_type *>(untyped_ros_message);
  // Field name: is_estop
  {
  ...
  void * untyped_ros_message)
{
  ...
  _EStop__ros_msg_type * ros_message = static_cast<_EStop__ros_msg_type *>(untyped_ros_message);
  // Field name: is_estop
  {
    uint8_t tmp;
    cdr >> tmp;
...
static uint32_t _EStop__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_ros2_interface__msg__EStop(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = ros2_interface__msg__EStop;
    is_plain =
      (
...
static size_t _EStop__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_ros2_interface__msg__EStop(
...
static message_type_support_callbacks_t __callbacks_EStop = {
  "ros2_interface::msg",
  "EStop",
...
static rosidl_message_type_support_t _EStop__type_support = {
