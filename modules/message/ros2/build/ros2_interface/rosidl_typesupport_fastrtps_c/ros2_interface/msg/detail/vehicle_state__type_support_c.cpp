...
#include "ros2_interface/msg/detail/vehicle_state__rosidl_typesupport_fastrtps_c.h"
...
#include "ros2_interface/msg/detail/pose__functions.h"  // pose
...
using _VehicleState__ros_msg_type = ros2_interface__msg__VehicleState;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: pose
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, ros2_interface, msg, Pose
      )()->data);
    if (!callbacks->cdr_serialize(
...
size_t get_serialized_size_ros2_interface__msg__VehicleState(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _VehicleState__ros_msg_type * ros_message = static_cast<const _VehicleState__ros_msg_type *>(untyped_ros_message);
  ...
  // field.name linear_acceleration
  {
    size_t item_size = sizeof(ros_message->linear_acceleration);
    current_alignment += item_size +
      eprosima::fastcdr::Cdr::alignment(current_alignment, item_size);
  }
  // field.name gear
  ...
  current_alignment += get_serialized_size_ros2_interface__msg__Pose(
...
static uint32_t _VehicleState__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_ros2_interface__msg__VehicleState(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_ros2_interface
size_t max_serialized_size_ros2_interface__msg__VehicleState(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  // member: pose
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_ros2_interface__msg__Pose(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    using DataType = ros2_interface__msg__VehicleState;
    is_plain =
      (
      offsetof(DataType, rear_steering_value) +
      last_member_size
      ) == ret_val;
  }
...
static size_t _VehicleState__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_ros2_interface__msg__VehicleState(
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, ros2_interface, msg, VehicleState)() {
