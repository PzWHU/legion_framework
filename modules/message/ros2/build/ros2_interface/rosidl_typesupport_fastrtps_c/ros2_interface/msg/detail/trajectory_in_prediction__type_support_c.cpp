...
#include "ros2_interface/msg/detail/trajectory_in_prediction__rosidl_typesupport_fastrtps_c.h"
...
using _TrajectoryInPrediction__ros_msg_type = ros2_interface__msg__TrajectoryInPrediction;

static bool _TrajectoryInPrediction__cdr_serialize(
  const void * untyped_ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _TrajectoryInPrediction__ros_msg_type * ros_message = static_cast<const _TrajectoryInPrediction__ros_msg_type *>(untyped_ros_message);
...
static bool _TrajectoryInPrediction__cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  void * untyped_ros_message)
{
  ...
  _TrajectoryInPrediction__ros_msg_type * ros_message = static_cast<_TrajectoryInPrediction__ros_msg_type *>(untyped_ros_message);
  // Field name: probability
  {
    cdr >> ros_message->probability;
  }
...
static uint32_t _TrajectoryInPrediction__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_ros2_interface__msg__TrajectoryInPrediction(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = ros2_interface__msg__TrajectoryInPrediction;
    is_plain =
      (
...
static size_t _TrajectoryInPrediction__max_serialized_size(char & bounds_info)
{
  bool full_bounded;
  bool is_plain;
  size_t ret_val;

  ret_val = max_serialized_size_ros2_interface__msg__TrajectoryInPrediction(
...
static message_type_support_callbacks_t __callbacks_TrajectoryInPrediction = {
  "ros2_interface::msg",
  "TrajectoryInPrediction",
  _TrajectoryInPrediction__cdr_serialize,
  _TrajectoryInPrediction__cdr_deserialize,
  _TrajectoryInPrediction__get_serialized_size,
  _TrajectoryInPrediction__max_serialized_size
};

static rosidl_message_type_support_t _TrajectoryInPrediction__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_TrajectoryInPrediction,
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, ros2_interface, msg, TrajectoryInPrediction)() {
  return &_TrajectoryInPrediction__type_support;
}
