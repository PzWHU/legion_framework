...
#include "ros2_interface/msg/detail/gnss__rosidl_typesupport_fastrtps_c.h"
...
#include "ros2_interface/msg/detail/point3_d__functions.h"  // attitude, attitude_dual, linear_velocity, sd_angle_dual, sd_attitude, sd_position, sd_velocity, utm_position
...
using _Gnss__ros_msg_type = ros2_interface__msg__Gnss;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: utm_zone_num
  {
    cdr << ros_message->utm_zone_num;
  }

  // Field name: utm_zone_char
  {
  ...
  // Field name: sd_position
  {
    ...
    if (!callbacks->cdr_serialize(
        &ros_message->sd_position, cdr))
    {
      return false;
    }
  }

  // Field name: sd_velocity
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
    ...
    if (!callbacks->cdr_serialize(
        &ros_message->sd_velocity, cdr))
    {
      return false;
    }
  }

  // Field name: sd_attitude
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
  ...
  // Field name: sat_use_num
  {
    cdr << ros_message->sat_use_num;
  }

  // Field name: sat_in_view_num
  {
  ...
  // Field name: attitude_dual
  {
    ...
    if (!callbacks->cdr_serialize(
        &ros_message->attitude_dual, cdr))
    {
      return false;
    }
  }

  // Field name: sd_angle_dual
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
    ...
    if (!callbacks->cdr_serialize(
        &ros_message->sd_angle_dual, cdr))
    {
      return false;
    }
  }

  // Field name: base_line_length_dual
  {
    cdr << ros_message->base_line_length_dual;
  }

  // Field name: solution_status_dual
  {
    cdr << ros_message->solution_status_dual;
  }

  // Field name: position_type_dual
  {
    cdr << ros_message->position_type_dual;
  }

  // Field name: solution_source_dual
  {
...
size_t get_serialized_size_ros2_interface__msg__Gnss(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _Gnss__ros_msg_type * ros_message = static_cast<const _Gnss__ros_msg_type *>(untyped_ros_message);
  ...
  // field.name utm_zone_num
  {
    size_t item_size = sizeof(ros_message->utm_zone_num);
    current_alignment += item_size +
      eprosima::fastcdr::Cdr::alignment(current_alignment, item_size);
  }
  // field.name utm_zone_char
...
static uint32_t _Gnss__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_ros2_interface__msg__Gnss(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_ros2_interface
size_t max_serialized_size_ros2_interface__msg__Gnss(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = ros2_interface__msg__Gnss;
    is_plain =
      (
      offsetof(DataType, v_dop) +
      last_member_size
      ) == ret_val;
  }
...
static size_t _Gnss__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_ros2_interface__msg__Gnss(
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, ros2_interface, msg, Gnss)() {
