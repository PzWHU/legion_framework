...
#include "ros2_interface/msg/detail/path_point__rosidl_typesupport_fastrtps_c.h"
...
using _PathPoint__ros_msg_type = ros2_interface__msg__PathPoint;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: x_derivative
  {
    cdr << ros_message->x_derivative;
  }

  // Field name: y_derivative
  {
...
static uint32_t _PathPoint__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_ros2_interface__msg__PathPoint(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = ros2_interface__msg__PathPoint;
    is_plain =
      (
...
static size_t _PathPoint__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_ros2_interface__msg__PathPoint(
