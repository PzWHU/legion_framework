...
#include "ros2_interface/msg/detail/lane_list__rosidl_typesupport_fastrtps_c.h"
...
#include "ros2_interface/msg/detail/holistic_path_prediction__functions.h"  // hpp
#include "ros2_interface/msg/detail/lane_line__functions.h"  // camera_laneline
#include "ros2_interface/msg/detail/road_mark__functions.h"  // road_marks
...
using _LaneList__ros_msg_type = ros2_interface__msg__LaneList;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: camera_laneline
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, ros2_interface, msg, LaneLine
      )()->data);
    size_t size = ros_message->camera_laneline.size;
    auto array_ptr = ros_message->camera_laneline.data;
  ...
  // Field name: hpp
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, ros2_interface, msg, HolisticPathPrediction
      )()->data);
    if (!callbacks->cdr_serialize(
        &ros_message->hpp, cdr))
    {
  ...
  // Field name: road_marks
  {
    ...
    auto array_ptr = ros_message->road_marks.data;
    cdr << static_cast<uint32_t>(size);
    for (size_t i = 0; i < size; ++i) {
      if (!callbacks->cdr_serialize(
          &array_ptr[i], cdr))
  ...
  void * untyped_ros_message)
{
  ...
  // Field name: camera_laneline
  {
    ...
    if (ros_message->camera_laneline.data) {
      ros2_interface__msg__LaneLine__Sequence__fini(&ros_message->camera_laneline);
    }
    if (!ros2_interface__msg__LaneLine__Sequence__init(&ros_message->camera_laneline, size)) {
      fprintf(stderr, "failed to create array for field 'camera_laneline'");
      return false;
    }
    auto array_ptr = ros_message->camera_laneline.data;
    for (size_t i = 0; i < size; ++i) {
  ...
  // Field name: road_marks
  {
    ...
    if (ros_message->road_marks.data) {
      ros2_interface__msg__RoadMark__Sequence__fini(&ros_message->road_marks);
    }
    if (!ros2_interface__msg__RoadMark__Sequence__init(&ros_message->road_marks, size)) {
      fprintf(stderr, "failed to create array for field 'road_marks'");
      return false;
    }
    auto array_ptr = ros_message->road_marks.data;
    for (size_t i = 0; i < size; ++i) {
...
size_t get_serialized_size_ros2_interface__msg__LaneList(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _LaneList__ros_msg_type * ros_message = static_cast<const _LaneList__ros_msg_type *>(untyped_ros_message);
  ...
  // field.name camera_laneline
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment += get_serialized_size_ros2_interface__msg__LaneLine(
        &array_ptr[index], current_alignment);
    }
  }
  // field.name hpp

  current_alignment += get_serialized_size_ros2_interface__msg__HolisticPathPrediction(
...
static uint32_t _LaneList__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_ros2_interface__msg__LaneList(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_ros2_interface
size_t max_serialized_size_ros2_interface__msg__LaneList(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  // member: camera_laneline
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_ros2_interface__msg__LaneLine(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  // member: hpp
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_ros2_interface__msg__HolisticPathPrediction(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    using DataType = ros2_interface__msg__LaneList;
    is_plain =
      (
...
static size_t _LaneList__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_ros2_interface__msg__LaneList(
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, ros2_interface, msg, LaneList)() {
