...
#include "ros2_interface/msg/detail/twist__rosidl_typesupport_fastrtps_c.h"
...
#include "ros2_interface/msg/detail/point3_d__functions.h"  // angular, linear
...
using _Twist__ros_msg_type = ros2_interface__msg__Twist;
...
size_t get_serialized_size_ros2_interface__msg__Twist(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _Twist__ros_msg_type * ros_message = static_cast<const _Twist__ros_msg_type *>(untyped_ros_message);
...
static uint32_t _Twist__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_ros2_interface__msg__Twist(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_ros2_interface
size_t max_serialized_size_ros2_interface__msg__Twist(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = ros2_interface__msg__Twist;
    is_plain =
      (
...
static size_t _Twist__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_ros2_interface__msg__Twist(
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, ros2_interface, msg, Twist)() {
