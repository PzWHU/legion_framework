...
#include "ros2_interface/msg/detail/local_map__rosidl_typesupport_fastrtps_c.h"
...
#include "ros2_interface/msg/detail/lane_info_extend__functions.h"  // lane_list
#include "ros2_interface/msg/detail/point3_d__functions.h"  // ego_point
...
using _LocalMap__ros_msg_type = ros2_interface__msg__LocalMap;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: lane_list
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, ros2_interface, msg, LaneInfoExtend
      )()->data);
  ...
  void * untyped_ros_message)
{
  ...
  // Field name: lane_list
  {
    ...
    if (ros_message->lane_list.data) {
      ros2_interface__msg__LaneInfoExtend__Sequence__fini(&ros_message->lane_list);
    }
...
size_t get_serialized_size_ros2_interface__msg__LocalMap(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _LocalMap__ros_msg_type * ros_message = static_cast<const _LocalMap__ros_msg_type *>(untyped_ros_message);
  ...
  current_alignment += get_serialized_size_ros2_interface__msg__Point3D(
    &(ros_message->ego_point), current_alignment);
  // field.name range
  {
  ...
  // field.name lane_list
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment += get_serialized_size_ros2_interface__msg__LaneInfoExtend(
...
static uint32_t _LocalMap__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_ros2_interface__msg__LocalMap(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_ros2_interface
size_t max_serialized_size_ros2_interface__msg__LocalMap(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  // member: lane_list
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_ros2_interface__msg__LaneInfoExtend(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    using DataType = ros2_interface__msg__LocalMap;
    is_plain =
      (
...
static size_t _LocalMap__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_ros2_interface__msg__LocalMap(
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, ros2_interface, msg, LocalMap)() {
