...
#include "ros2_interface/msg/detail/obstacle_priority__rosidl_typesupport_fastrtps_c.h"
...
using _ObstaclePriority__ros_msg_type = ros2_interface__msg__ObstaclePriority;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _ObstaclePriority__ros_msg_type * ros_message = static_cast<const _ObstaclePriority__ros_msg_type *>(untyped_ros_message);
  // Field name: priority
  {
  ...
  void * untyped_ros_message)
{
  ...
  _ObstaclePriority__ros_msg_type * ros_message = static_cast<_ObstaclePriority__ros_msg_type *>(untyped_ros_message);
  // Field name: priority
  {
    cdr >> ros_message->priority;
  }
...
static uint32_t _ObstaclePriority__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_ros2_interface__msg__ObstaclePriority(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = ros2_interface__msg__ObstaclePriority;
    is_plain =
      (
...
static size_t _ObstaclePriority__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_ros2_interface__msg__ObstaclePriority(
...
static message_type_support_callbacks_t __callbacks_ObstaclePriority = {
  "ros2_interface::msg",
  "ObstaclePriority",
...
static rosidl_message_type_support_t _ObstaclePriority__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_ObstaclePriority,
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, ros2_interface, msg, ObstaclePriority)() {
  return &_ObstaclePriority__type_support;
}
