...
#include "ros2_interface/msg/detail/sl_boundary__rosidl_typesupport_fastrtps_c.h"
...
#include "ros2_interface/msg/detail/sl_point__functions.h"  // boundary_point
...
using _SLBoundary__ros_msg_type = ros2_interface__msg__SLBoundary;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _SLBoundary__ros_msg_type * ros_message = static_cast<const _SLBoundary__ros_msg_type *>(untyped_ros_message);
  // Field name: start_s
  {
  ...
  // Field name: boundary_point
  {
    ...
    auto array_ptr = ros_message->boundary_point.data;
  ...
  void * untyped_ros_message)
{
  ...
  _SLBoundary__ros_msg_type * ros_message = static_cast<_SLBoundary__ros_msg_type *>(untyped_ros_message);
  // Field name: start_s
  {
    cdr >> ros_message->start_s;
  }
  ...
  // Field name: boundary_point
  {
    ...
    if (ros_message->boundary_point.data) {
      ros2_interface__msg__SLPoint__Sequence__fini(&ros_message->boundary_point);
    }
    if (!ros2_interface__msg__SLPoint__Sequence__init(&ros_message->boundary_point, size)) {
      fprintf(stderr, "failed to create array for field 'boundary_point'");
      return false;
    }
    auto array_ptr = ros_message->boundary_point.data;
    for (size_t i = 0; i < size; ++i) {
...
size_t get_serialized_size_ros2_interface__msg__SLBoundary(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _SLBoundary__ros_msg_type * ros_message = static_cast<const _SLBoundary__ros_msg_type *>(untyped_ros_message);
...
static uint32_t _SLBoundary__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_ros2_interface__msg__SLBoundary(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_ros2_interface
size_t max_serialized_size_ros2_interface__msg__SLBoundary(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = ros2_interface__msg__SLBoundary;
    is_plain =
      (
...
static size_t _SLBoundary__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_ros2_interface__msg__SLBoundary(
...
static message_type_support_callbacks_t __callbacks_SLBoundary = {
  "ros2_interface::msg",
  "SLBoundary",
...
static rosidl_message_type_support_t _SLBoundary__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_SLBoundary,
  get_message_typesupport_handle_function,
};

const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, ros2_interface, msg, SLBoundary)() {
  return &_SLBoundary__type_support;
}
