...
#include "ros2_interface/msg/detail/trajectory__rosidl_typesupport_fastrtps_c.h"
...
using _Trajectory__ros_msg_type = ros2_interface__msg__Trajectory;
...
static uint32_t _Trajectory__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_ros2_interface__msg__Trajectory(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = ros2_interface__msg__Trajectory;
    is_plain =
      (
...
static size_t _Trajectory__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_ros2_interface__msg__Trajectory(
