...
#include "ros2_interface/msg/detail/odometry__rosidl_typesupport_fastrtps_c.h"
...
#include "rosidl_runtime_c/primitives_sequence.h"  // covariance
#include "rosidl_runtime_c/primitives_sequence_functions.h"  // covariance
...
using _Odometry__ros_msg_type = ros2_interface__msg__Odometry;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: covariance
  {
    ...
    auto array_ptr = ros_message->covariance.data;
  ...
  void * untyped_ros_message)
{
  ...
  // Field name: covariance
  {
    ...
    if (ros_message->covariance.data) {
      rosidl_runtime_c__double__Sequence__fini(&ros_message->covariance);
    }
    if (!rosidl_runtime_c__double__Sequence__init(&ros_message->covariance, size)) {
      fprintf(stderr, "failed to create array for field 'covariance'");
      return false;
    }
    auto array_ptr = ros_message->covariance.data;
...
size_t get_serialized_size_ros2_interface__msg__Odometry(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _Odometry__ros_msg_type * ros_message = static_cast<const _Odometry__ros_msg_type *>(untyped_ros_message);
...
static uint32_t _Odometry__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_ros2_interface__msg__Odometry(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_ros2_interface
size_t max_serialized_size_ros2_interface__msg__Odometry(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = ros2_interface__msg__Odometry;
    is_plain =
      (
...
static size_t _Odometry__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_ros2_interface__msg__Odometry(
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, ros2_interface, msg, Odometry)() {
