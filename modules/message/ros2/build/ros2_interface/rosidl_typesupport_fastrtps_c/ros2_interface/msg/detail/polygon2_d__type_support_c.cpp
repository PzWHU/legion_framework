...
#include "ros2_interface/msg/detail/polygon2_d__rosidl_typesupport_fastrtps_c.h"
...
#include "ros2_interface/msg/detail/point2_d__functions.h"  // points
...
using _Polygon2D__ros_msg_type = ros2_interface__msg__Polygon2D;
  ...
  void * untyped_ros_message)
{
  ...
  _Polygon2D__ros_msg_type * ros_message = static_cast<_Polygon2D__ros_msg_type *>(untyped_ros_message);
  // Field name: coordinate_system
  {
    cdr >> ros_message->coordinate_system;
  }
  ...
  // Field name: points
  {
    ...
    if (ros_message->points.data) {
      ros2_interface__msg__Point2D__Sequence__fini(&ros_message->points);
    }
    if (!ros2_interface__msg__Point2D__Sequence__init(&ros_message->points, size)) {
...
static uint32_t _Polygon2D__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_ros2_interface__msg__Polygon2D(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = ros2_interface__msg__Polygon2D;
    is_plain =
      (
...
static size_t _Polygon2D__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_ros2_interface__msg__Polygon2D(
