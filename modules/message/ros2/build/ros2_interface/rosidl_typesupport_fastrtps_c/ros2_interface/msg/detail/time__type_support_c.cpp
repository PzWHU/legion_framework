...
#include "ros2_interface/msg/detail/time__rosidl_typesupport_fastrtps_c.h"
...
using _Time__ros_msg_type = ros2_interface__msg__Time;
...
static uint32_t _Time__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_ros2_interface__msg__Time(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = ros2_interface__msg__Time;
    is_plain =
      (
...
static size_t _Time__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_ros2_interface__msg__Time(
