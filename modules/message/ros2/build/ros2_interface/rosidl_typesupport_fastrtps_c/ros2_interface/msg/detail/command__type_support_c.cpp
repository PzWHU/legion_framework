...
#include "ros2_interface/msg/detail/command__rosidl_typesupport_fastrtps_c.h"
...
#include "rosidl_runtime_c/string.h"  // target_module
#include "rosidl_runtime_c/string_functions.h"  // target_module

// forward declare type support functions


using _Command__ros_msg_type = ros2_interface__msg__Command;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  {
    const rosidl_runtime_c__String * str = &ros_message->target_module;
  ...
  void * untyped_ros_message)
{
  ...
  // Field name: target_module
  {
    std::string tmp;
    cdr >> tmp;
    if (!ros_message->target_module.data) {
      rosidl_runtime_c__String__init(&ros_message->target_module);
    }
    bool succeeded = rosidl_runtime_c__String__assign(
      &ros_message->target_module,
      tmp.c_str());
    if (!succeeded) {
      fprintf(stderr, "failed to assign string into field 'target_module'\n");
      return false;
    }
  }
...
static uint32_t _Command__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_ros2_interface__msg__Command(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = ros2_interface__msg__Command;
    is_plain =
      (
...
static size_t _Command__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_ros2_interface__msg__Command(
