...
#include "ros2_interface/msg/detail/lane_point__rosidl_typesupport_fastrtps_c.h"
...
using _LanePoint__ros_msg_type = ros2_interface__msg__LanePoint;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _LanePoint__ros_msg_type * ros_message = static_cast<const _LanePoint__ros_msg_type *>(untyped_ros_message);
  // Field name: point
  {
  ...
  // Field name: left_road_width
  {
    cdr << ros_message->left_road_width;
  }

  // Field name: right_road_width
  {
    cdr << ros_message->right_road_width;
  }

  // Field name: left_line_type
  {
    cdr << ros_message->left_line_type;
  }

  // Field name: right_line_type
  {
  ...
  void * untyped_ros_message)
{
  ...
  _LanePoint__ros_msg_type * ros_message = static_cast<_LanePoint__ros_msg_type *>(untyped_ros_message);
  // Field name: point
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
...
static uint32_t _LanePoint__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_ros2_interface__msg__LanePoint(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = ros2_interface__msg__LanePoint;
    is_plain =
      (
...
static size_t _LanePoint__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_ros2_interface__msg__LanePoint(
...
static message_type_support_callbacks_t __callbacks_LanePoint = {
  "ros2_interface::msg",
  "LanePoint",
