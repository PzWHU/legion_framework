...
#include "ros2_interface/msg/detail/path__rosidl_typesupport_fastrtps_c.h"
...
using _Path__ros_msg_type = ros2_interface__msg__Path;
...
static uint32_t _Path__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_ros2_interface__msg__Path(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = ros2_interface__msg__Path;
    is_plain =
      (
...
static size_t _Path__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_ros2_interface__msg__Path(
