...
#include "ros2_interface/msg/detail/key_point__rosidl_typesupport_fastrtps_c.h"
...
using _KeyPoint__ros_msg_type = ros2_interface__msg__KeyPoint;
...
static uint32_t _KeyPoint__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_ros2_interface__msg__KeyPoint(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = ros2_interface__msg__KeyPoint;
    is_plain =
      (
...
static size_t _KeyPoint__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_ros2_interface__msg__KeyPoint(
