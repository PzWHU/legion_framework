...
#include "ros2_interface/msg/detail/polygon__rosidl_typesupport_fastrtps_c.h"
...
using _Polygon__ros_msg_type = ros2_interface__msg__Polygon;
...
size_t get_serialized_size_ros2_interface__msg__Polygon(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _Polygon__ros_msg_type * ros_message = static_cast<const _Polygon__ros_msg_type *>(untyped_ros_message);
...
static uint32_t _Polygon__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_ros2_interface__msg__Polygon(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_ros2_interface
size_t max_serialized_size_ros2_interface__msg__Polygon(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = ros2_interface__msg__Polygon;
    is_plain =
      (
...
static size_t _Polygon__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_ros2_interface__msg__Polygon(
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, ros2_interface, msg, Polygon)() {
