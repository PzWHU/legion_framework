...
#include "ros2_interface/msg/detail/camera_parking_info__rosidl_typesupport_fastrtps_c.h"
...
#include "ros2_interface/msg/detail/image_key_point__functions.h"  // parking_points_in_image
...
using _CameraParkingInfo__ros_msg_type = ros2_interface__msg__CameraParkingInfo;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _CameraParkingInfo__ros_msg_type * ros_message = static_cast<const _CameraParkingInfo__ros_msg_type *>(untyped_ros_message);
  // Field name: header
  {
  ...
  // Field name: parking_points_in_image
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
    ...
    auto array_ptr = ros_message->parking_points_in_image.data;
  ...
  void * untyped_ros_message)
{
  ...
  _CameraParkingInfo__ros_msg_type * ros_message = static_cast<_CameraParkingInfo__ros_msg_type *>(untyped_ros_message);
  // Field name: header
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
  ...
  // Field name: parking_points_in_image
  {
    ...
    if (ros_message->parking_points_in_image.data) {
      ros2_interface__msg__ImageKeyPoint__Sequence__fini(&ros_message->parking_points_in_image);
    }
    if (!ros2_interface__msg__ImageKeyPoint__Sequence__init(&ros_message->parking_points_in_image, size)) {
      fprintf(stderr, "failed to create array for field 'parking_points_in_image'");
      return false;
    }
    auto array_ptr = ros_message->parking_points_in_image.data;
    for (size_t i = 0; i < size; ++i) {
...
static uint32_t _CameraParkingInfo__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_ros2_interface__msg__CameraParkingInfo(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = ros2_interface__msg__CameraParkingInfo;
    is_plain =
      (
...
static size_t _CameraParkingInfo__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_ros2_interface__msg__CameraParkingInfo(
...
static message_type_support_callbacks_t __callbacks_CameraParkingInfo = {
  "ros2_interface::msg",
  "CameraParkingInfo",
...
static rosidl_message_type_support_t _CameraParkingInfo__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_CameraParkingInfo,
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, ros2_interface, msg, CameraParkingInfo)() {
  return &_CameraParkingInfo__type_support;
}
