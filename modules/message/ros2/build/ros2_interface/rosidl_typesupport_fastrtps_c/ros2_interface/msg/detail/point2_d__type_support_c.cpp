...
#include "ros2_interface/msg/detail/point2_d__rosidl_typesupport_fastrtps_c.h"
...
using _Point2D__ros_msg_type = ros2_interface__msg__Point2D;
...
static uint32_t _Point2D__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_ros2_interface__msg__Point2D(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = ros2_interface__msg__Point2D;
    is_plain =
      (
      offsetof(DataType, y) +
      last_member_size
...
static size_t _Point2D__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_ros2_interface__msg__Point2D(
