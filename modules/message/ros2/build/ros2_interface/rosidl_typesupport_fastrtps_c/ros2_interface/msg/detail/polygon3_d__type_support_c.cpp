...
#include "ros2_interface/msg/detail/polygon3_d__rosidl_typesupport_fastrtps_c.h"
...
#include "ros2_interface/msg/detail/point3_d__functions.h"  // points
...
using _Polygon3D__ros_msg_type = ros2_interface__msg__Polygon3D;

static bool _Polygon3D__cdr_serialize(
  const void * untyped_ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _Polygon3D__ros_msg_type * ros_message = static_cast<const _Polygon3D__ros_msg_type *>(untyped_ros_message);
...
static bool _Polygon3D__cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  void * untyped_ros_message)
{
  ...
  _Polygon3D__ros_msg_type * ros_message = static_cast<_Polygon3D__ros_msg_type *>(untyped_ros_message);
  // Field name: coordinate_system
  {
    cdr >> ros_message->coordinate_system;
  }
  ...
  // Field name: points
  {
    ...
    if (ros_message->points.data) {
      ros2_interface__msg__Point3D__Sequence__fini(&ros_message->points);
    }
...
static uint32_t _Polygon3D__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_ros2_interface__msg__Polygon3D(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = ros2_interface__msg__Polygon3D;
    is_plain =
      (
...
static size_t _Polygon3D__max_serialized_size(char & bounds_info)
{
  bool full_bounded;
  bool is_plain;
  size_t ret_val;

  ret_val = max_serialized_size_ros2_interface__msg__Polygon3D(
...
static message_type_support_callbacks_t __callbacks_Polygon3D = {
  "ros2_interface::msg",
  "Polygon3D",
  _Polygon3D__cdr_serialize,
  _Polygon3D__cdr_deserialize,
  _Polygon3D__get_serialized_size,
  _Polygon3D__max_serialized_size
};

static rosidl_message_type_support_t _Polygon3D__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_Polygon3D,
  get_message_typesupport_handle_function,
};

const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, ros2_interface, msg, Polygon3D)() {
  return &_Polygon3D__type_support;
}
