...
#include "ros2_interface/msg/detail/planning_cmd__rosidl_typesupport_fastrtps_c.h"
...
using _PlanningCmd__ros_msg_type = ros2_interface__msg__PlanningCmd;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _PlanningCmd__ros_msg_type * ros_message = static_cast<const _PlanningCmd__ros_msg_type *>(untyped_ros_message);
  // Field name: header
  {
  ...
  void * untyped_ros_message)
{
  ...
  _PlanningCmd__ros_msg_type * ros_message = static_cast<_PlanningCmd__ros_msg_type *>(untyped_ros_message);
  // Field name: header
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
...
size_t get_serialized_size_ros2_interface__msg__PlanningCmd(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _PlanningCmd__ros_msg_type * ros_message = static_cast<const _PlanningCmd__ros_msg_type *>(untyped_ros_message);
...
static uint32_t _PlanningCmd__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_ros2_interface__msg__PlanningCmd(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_ros2_interface
size_t max_serialized_size_ros2_interface__msg__PlanningCmd(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = ros2_interface__msg__PlanningCmd;
    is_plain =
      (
...
static size_t _PlanningCmd__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_ros2_interface__msg__PlanningCmd(
...
static message_type_support_callbacks_t __callbacks_PlanningCmd = {
  "ros2_interface::msg",
  "PlanningCmd",
...
static rosidl_message_type_support_t _PlanningCmd__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_PlanningCmd,
  get_message_typesupport_handle_function,
};

const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, ros2_interface, msg, PlanningCmd)() {
  return &_PlanningCmd__type_support;
}
