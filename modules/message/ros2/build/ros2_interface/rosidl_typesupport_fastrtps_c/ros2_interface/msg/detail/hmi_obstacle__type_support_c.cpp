...
#include "ros2_interface/msg/detail/hmi_obstacle__rosidl_typesupport_fastrtps_c.h"
...
#include "ros2_interface/msg/detail/point3_d__functions.h"  // center_pos_abs, center_pos_vehicle, points
...
using _HMIObstacle__ros_msg_type = ros2_interface__msg__HMIObstacle;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _HMIObstacle__ros_msg_type * ros_message = static_cast<const _HMIObstacle__ros_msg_type *>(untyped_ros_message);
  // Field name: id
  {
    cdr << ros_message->id;
  }
  ...
  void * untyped_ros_message)
{
  ...
  _HMIObstacle__ros_msg_type * ros_message = static_cast<_HMIObstacle__ros_msg_type *>(untyped_ros_message);
  // Field name: id
  {
    cdr >> ros_message->id;
  }
...
static uint32_t _HMIObstacle__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_ros2_interface__msg__HMIObstacle(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = ros2_interface__msg__HMIObstacle;
    is_plain =
      (
...
static size_t _HMIObstacle__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_ros2_interface__msg__HMIObstacle(
...
static message_type_support_callbacks_t __callbacks_HMIObstacle = {
  "ros2_interface::msg",
  "HMIObstacle",
