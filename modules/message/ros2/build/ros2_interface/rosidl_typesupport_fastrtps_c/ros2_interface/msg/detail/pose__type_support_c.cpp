...
#include "ros2_interface/msg/detail/pose__rosidl_typesupport_fastrtps_c.h"
...
#include "ros2_interface/msg/detail/point3_d__functions.h"  // angular_velocity, angular_velocity_vrf, euler_angles, linear_acceleration, linear_acceleration_vrf, linear_velocity
#include "ros2_interface/msg/detail/point_enu__functions.h"  // position
...
using _Pose__ros_msg_type = ros2_interface__msg__Pose;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: linear_acceleration_vrf
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
    ...
    if (!callbacks->cdr_serialize(
        &ros_message->linear_acceleration_vrf, cdr))
    {
      return false;
    }
  }

  // Field name: angular_velocity_vrf
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
    ...
    if (!callbacks->cdr_serialize(
        &ros_message->angular_velocity_vrf, cdr))
    {
      return false;
    }
  }
  ...
  void * untyped_ros_message)
{
  ...
  // Field name: linear_acceleration_vrf
  {
    ...
    if (!callbacks->cdr_deserialize(
        cdr, &ros_message->linear_acceleration_vrf))
    {
      return false;
    }
  }
  ...
  // Field name: angular_velocity_vrf
  {
    ...
    if (!callbacks->cdr_deserialize(
        cdr, &ros_message->angular_velocity_vrf))
    {
      return false;
    }
  }
...
size_t get_serialized_size_ros2_interface__msg__Pose(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _Pose__ros_msg_type * ros_message = static_cast<const _Pose__ros_msg_type *>(untyped_ros_message);
  ...
  current_alignment += get_serialized_size_ros2_interface__msg__Point3D(
    &(ros_message->linear_acceleration_vrf), current_alignment);
  // field.name angular_velocity_vrf

  current_alignment += get_serialized_size_ros2_interface__msg__Point3D(
    &(ros_message->angular_velocity_vrf), current_alignment);
  // field.name euler_angles
...
static uint32_t _Pose__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_ros2_interface__msg__Pose(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_ros2_interface
size_t max_serialized_size_ros2_interface__msg__Pose(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = ros2_interface__msg__Pose;
    is_plain =
      (
      offsetof(DataType, euler_angles) +
      last_member_size
      ) == ret_val;
  }
...
static size_t _Pose__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_ros2_interface__msg__Pose(
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, ros2_interface, msg, Pose)() {
