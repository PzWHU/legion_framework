...
#include "ros2_interface/msg/detail/region__rosidl_typesupport_fastrtps_c.h"
...
#include "ros2_interface/msg/detail/point3_d__functions.h"  // region_polygon
...
using _Region__ros_msg_type = ros2_interface__msg__Region;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: rank_risk
  {
    cdr << ros_message->rank_risk;
  }

  // Field name: region_polygon
  {
    ...
    auto array_ptr = ros_message->region_polygon.data;
  ...
  void * untyped_ros_message)
{
  ...
  // Field name: region_polygon
  {
    ...
    if (ros_message->region_polygon.data) {
      ros2_interface__msg__Point3D__Sequence__fini(&ros_message->region_polygon);
    }
    if (!ros2_interface__msg__Point3D__Sequence__init(&ros_message->region_polygon, size)) {
      fprintf(stderr, "failed to create array for field 'region_polygon'");
      return false;
    }
    auto array_ptr = ros_message->region_polygon.data;
    for (size_t i = 0; i < size; ++i) {
...
size_t get_serialized_size_ros2_interface__msg__Region(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _Region__ros_msg_type * ros_message = static_cast<const _Region__ros_msg_type *>(untyped_ros_message);
...
static uint32_t _Region__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_ros2_interface__msg__Region(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_ros2_interface
size_t max_serialized_size_ros2_interface__msg__Region(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = ros2_interface__msg__Region;
    is_plain =
      (
...
static size_t _Region__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_ros2_interface__msg__Region(
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, ros2_interface, msg, Region)() {
