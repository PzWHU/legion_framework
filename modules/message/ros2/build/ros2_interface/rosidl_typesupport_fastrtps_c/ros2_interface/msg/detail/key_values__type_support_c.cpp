...
#include "ros2_interface/msg/detail/key_values__rosidl_typesupport_fastrtps_c.h"
...
using _KeyValues__ros_msg_type = ros2_interface__msg__KeyValues;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _KeyValues__ros_msg_type * ros_message = static_cast<const _KeyValues__ros_msg_type *>(untyped_ros_message);
  // Field name: key
  {
  ...
  void * untyped_ros_message)
{
  ...
  _KeyValues__ros_msg_type * ros_message = static_cast<_KeyValues__ros_msg_type *>(untyped_ros_message);
  // Field name: key
  {
    std::string tmp;
    cdr >> tmp;
...
static uint32_t _KeyValues__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_ros2_interface__msg__KeyValues(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = ros2_interface__msg__KeyValues;
    is_plain =
      (
...
static size_t _KeyValues__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_ros2_interface__msg__KeyValues(
...
static message_type_support_callbacks_t __callbacks_KeyValues = {
  "ros2_interface::msg",
  "KeyValues",
...
static rosidl_message_type_support_t _KeyValues__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_KeyValues,
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, ros2_interface, msg, KeyValues)() {
  return &_KeyValues__type_support;
}
