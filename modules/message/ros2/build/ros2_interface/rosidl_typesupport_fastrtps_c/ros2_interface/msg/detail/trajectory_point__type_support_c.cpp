...
#include "ros2_interface/msg/detail/trajectory_point__rosidl_typesupport_fastrtps_c.h"
...
using _TrajectoryPoint__ros_msg_type = ros2_interface__msg__TrajectoryPoint;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: is_steer_valid
  {
    cdr << (ros_message->is_steer_valid ? true : false);
  }

  // Field name: front_steer
  {
    cdr << ros_message->front_steer;
  }

  // Field name: rear_steer
  {
...
static uint32_t _TrajectoryPoint__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_ros2_interface__msg__TrajectoryPoint(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = ros2_interface__msg__TrajectoryPoint;
    is_plain =
      (
...
static size_t _TrajectoryPoint__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_ros2_interface__msg__TrajectoryPoint(
