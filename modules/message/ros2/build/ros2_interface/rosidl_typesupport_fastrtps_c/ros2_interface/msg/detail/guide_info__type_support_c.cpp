...
#include "ros2_interface/msg/detail/guide_info__rosidl_typesupport_fastrtps_c.h"
...
#include "ros2_interface/msg/detail/guide_road__functions.h"  // current_road, next_road
...
using _GuideInfo__ros_msg_type = ros2_interface__msg__GuideInfo;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _GuideInfo__ros_msg_type * ros_message = static_cast<const _GuideInfo__ros_msg_type *>(untyped_ros_message);
  // Field name: header
  {
  ...
  // Field name: current_road
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, ros2_interface, msg, GuideRoad
      )()->data);
    if (!callbacks->cdr_serialize(
        &ros_message->current_road, cdr))
    {
      return false;
    }
  }

  // Field name: next_road
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
  ...
  void * untyped_ros_message)
{
  ...
  _GuideInfo__ros_msg_type * ros_message = static_cast<_GuideInfo__ros_msg_type *>(untyped_ros_message);
  // Field name: header
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
...
size_t get_serialized_size_ros2_interface__msg__GuideInfo(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _GuideInfo__ros_msg_type * ros_message = static_cast<const _GuideInfo__ros_msg_type *>(untyped_ros_message);
  ...
  current_alignment += get_serialized_size_ros2_interface__msg__GuideRoad(
...
static uint32_t _GuideInfo__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_ros2_interface__msg__GuideInfo(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_ros2_interface
size_t max_serialized_size_ros2_interface__msg__GuideInfo(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  // member: current_road
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_ros2_interface__msg__GuideRoad(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    using DataType = ros2_interface__msg__GuideInfo;
    is_plain =
      (
...
static size_t _GuideInfo__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_ros2_interface__msg__GuideInfo(
...
static message_type_support_callbacks_t __callbacks_GuideInfo = {
  "ros2_interface::msg",
  "GuideInfo",
...
static rosidl_message_type_support_t _GuideInfo__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_GuideInfo,
  get_message_typesupport_handle_function,
};

const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, ros2_interface, msg, GuideInfo)() {
  return &_GuideInfo__type_support;
}
