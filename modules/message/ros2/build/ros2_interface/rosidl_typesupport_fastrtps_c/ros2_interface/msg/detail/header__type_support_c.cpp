...
#include "ros2_interface/msg/detail/header__rosidl_typesupport_fastrtps_c.h"
...
using _Header__ros_msg_type = ros2_interface__msg__Header;
...
size_t get_serialized_size_ros2_interface__msg__Header(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _Header__ros_msg_type * ros_message = static_cast<const _Header__ros_msg_type *>(untyped_ros_message);
...
static uint32_t _Header__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_ros2_interface__msg__Header(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_ros2_interface
size_t max_serialized_size_ros2_interface__msg__Header(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = ros2_interface__msg__Header;
    is_plain =
      (
...
static size_t _Header__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_ros2_interface__msg__Header(
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, ros2_interface, msg, Header)() {
