...
#include "ros2_interface/msg/detail/lane_info__rosidl_typesupport_fastrtps_c.h"
...
using _LaneInfo__ros_msg_type = ros2_interface__msg__LaneInfo;
...
static uint32_t _LaneInfo__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_ros2_interface__msg__LaneInfo(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = ros2_interface__msg__LaneInfo;
    is_plain =
      (
...
static size_t _LaneInfo__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_ros2_interface__msg__LaneInfo(
