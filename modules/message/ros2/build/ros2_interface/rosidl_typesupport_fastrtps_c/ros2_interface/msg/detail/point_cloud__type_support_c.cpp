...
#include "ros2_interface/msg/detail/point_cloud__rosidl_typesupport_fastrtps_c.h"
...
#include "ros2_interface/msg/detail/point_xyzirt__functions.h"  // point
...
using _PointCloud__ros_msg_type = ros2_interface__msg__PointCloud;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: point
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, ros2_interface, msg, PointXYZIRT
      )()->data);
  ...
  void * untyped_ros_message)
{
  ...
  // Field name: point
  {
    ...
    if (ros_message->point.data) {
      ros2_interface__msg__PointXYZIRT__Sequence__fini(&ros_message->point);
    }
    if (!ros2_interface__msg__PointXYZIRT__Sequence__init(&ros_message->point, size)) {
...
size_t get_serialized_size_ros2_interface__msg__PointCloud(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _PointCloud__ros_msg_type * ros_message = static_cast<const _PointCloud__ros_msg_type *>(untyped_ros_message);
  ...
  // field.name point
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment += get_serialized_size_ros2_interface__msg__PointXYZIRT(
        &array_ptr[index], current_alignment);
    }
  }
  // field.name measurement_time
  {
    size_t item_size = sizeof(ros_message->measurement_time);
    current_alignment += item_size +
      eprosima::fastcdr::Cdr::alignment(current_alignment, item_size);
  }
  // field.name width
...
static uint32_t _PointCloud__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_ros2_interface__msg__PointCloud(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_ros2_interface
size_t max_serialized_size_ros2_interface__msg__PointCloud(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  // member: point
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_ros2_interface__msg__PointXYZIRT(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    using DataType = ros2_interface__msg__PointCloud;
    is_plain =
      (
...
static size_t _PointCloud__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_ros2_interface__msg__PointCloud(
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, ros2_interface, msg, PointCloud)() {
