...
#include "ros2_interface/msg/detail/sensor_calibrator__rosidl_typesupport_fastrtps_c.h"
...
#include "ros2_interface/msg/detail/point3_d__functions.h"  // angle, pose
...
using _SensorCalibrator__ros_msg_type = ros2_interface__msg__SensorCalibrator;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _SensorCalibrator__ros_msg_type * ros_message = static_cast<const _SensorCalibrator__ros_msg_type *>(untyped_ros_message);
  // Field name: pose
  {
  ...
  void * untyped_ros_message)
{
  ...
  _SensorCalibrator__ros_msg_type * ros_message = static_cast<_SensorCalibrator__ros_msg_type *>(untyped_ros_message);
  // Field name: pose
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
...
static uint32_t _SensorCalibrator__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_ros2_interface__msg__SensorCalibrator(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = ros2_interface__msg__SensorCalibrator;
    is_plain =
      (
...
static size_t _SensorCalibrator__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_ros2_interface__msg__SensorCalibrator(
...
static message_type_support_callbacks_t __callbacks_SensorCalibrator = {
  "ros2_interface::msg",
  "SensorCalibrator",
...
static rosidl_message_type_support_t _SensorCalibrator__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_SensorCalibrator,
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, ros2_interface, msg, SensorCalibrator)() {
  return &_SensorCalibrator__type_support;
}
