...
#ifndef _FAST_DDS_GENERATED_ROS2_INTERFACE_MSG_TIME_PUBSUBTYPES_H_
#define _FAST_DDS_GENERATED_ROS2_INTERFACE_MSG_TIME_PUBSUBTYPES_H_
...
namespace ros2_interface
{
    namespace msg
    {
        ...
        namespace detail {
            ...
            struct Time_f
            {
                typedef uint32_t Time::* type;
                friend constexpr type get(
                        Time_f);
            };

            template struct Time_rob<Time_f, &Time::m_nsec>;

            template <typename T, typename Tag>
            inline size_t constexpr Time_offset_of() {
        ...
        private:
            ...
            {
                return 8ULL == (detail::Time_offset_of<Time, detail::Time_f>() + sizeof(uint32_t));

            }};
    }
}

#endif // _FAST_DDS_GENERATED_ROS2_INTERFACE_MSG_TIME_PUBSUBTYPES_H_
