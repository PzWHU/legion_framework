%module fastdds_parking_info_list 
%{
...
#include "ParkingInfoListPubSubTypes.h"
...
namespace std {
    %template(VectorParkingInfo) vector<ros2_interface::msg::ParkingInfo>;
}
...
namespace msg{
    ...
    public:
        ...
        const std::vector<ros2_interface::msg::ParkingInfo>& parking_info() const;
        void error_code(
            int _error_code);
    ...
    class ParkingInfoListPubSubType
    {
    public:
        typedef ParkingInfoList type;

        ParkingInfoListPubSubType();
        ~ParkingInfoListPubSubType();
    };
...
%template(ParkingInfoListDataWriter) FastddsDataWriter<ros2_interface::msg::ParkingInfoListPubSubType>;
%template(ParkingInfoListDataReader) FastddsDataReader<ros2_interface::msg::ParkingInfoListPubSubType>;
