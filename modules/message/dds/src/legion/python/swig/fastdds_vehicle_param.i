...
%template(VehicleParamDataWriter) FastddsDataWriter<ros2_interface::msg::VehicleParamPubSubType>;
%template(VehicleParamDataReader) FastddsDataReader<ros2_interface::msg::VehicleParamPubSubType>;
