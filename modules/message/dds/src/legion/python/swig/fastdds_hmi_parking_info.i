%module fastdds_hmi_parking_info 
%{
...
%template(HMIParkingInfoDataWriter) FastddsDataWriter<ros2_interface::msg::HMIParkingInfoPubSubType>;
%template(HMIParkingInfoDataReader) FastddsDataReader<ros2_interface::msg::HMIParkingInfoPubSubType>;
