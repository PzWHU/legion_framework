%module fastdds_prediction_obstacles 
%{
#include "FastddsDataReader.hpp"
#include "FastddsDataWriter.hpp"
#include "PredictionObstaclesPubSubTypes.h"
...
namespace std {
    %template(VectorPredictionObstacle) vector<ros2_interface::msg::PredictionObstacle>;
}
...
namespace msg{
    ...
    public:
        ...
        void prediction_obstacles(
            const std::vector<ros2_interface::msg::PredictionObstacle> &_prediction_obstacles);
        const std::vector<ros2_interface::msg::PredictionObstacle>& prediction_obstacles() const;
    ...
    class PredictionObstaclesPubSubType
    {
    public:
        typedef PredictionObstacles type;

        PredictionObstaclesPubSubType();
        ~PredictionObstaclesPubSubType();
    };
...
%template(PredictionObstaclesDataWriter) FastddsDataWriter<ros2_interface::msg::PredictionObstaclesPubSubType>;
%template(PredictionObstaclesDataReader) FastddsDataReader<ros2_interface::msg::PredictionObstaclesPubSubType>;
