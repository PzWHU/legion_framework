...
namespace std {
    %template(VectorLaneInfoExtend) vector<ros2_interface::msg::LaneInfoExtend>;
}
...
namespace msg{
    ...
    public:
        ...
        const ros2_interface::msg::Point3D &ego_point() const;
        void range(
            double _range);
        double range() const;
        void lane_list(
            const std::vector<ros2_interface::msg::LaneInfoExtend> &_lane_list);
        const std::vector<ros2_interface::msg::LaneInfoExtend>& lane_list() const;
    };
    ...
    class LocalMapPubSubType
    {
    public:
        typedef LocalMap type;
...
%template(LocalMapDataWriter) FastddsDataWriter<ros2_interface::msg::LocalMapPubSubType>;
%template(LocalMapDataReader) FastddsDataReader<ros2_interface::msg::LocalMapPubSubType>;
