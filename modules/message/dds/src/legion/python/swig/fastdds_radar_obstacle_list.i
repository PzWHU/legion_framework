%module fastdds_radar_obstacle_list 
%{
#include "FastddsDataReader.hpp"
#include "FastddsDataWriter.hpp"
#include "Point2DPubSubTypes.h"
#include "RadarObstacleListPubSubTypes.h"
...
namespace msg{
    ...
    class RadarObstacleListPubSubType
    {
    public:
        typedef RadarObstacleList type;

        RadarObstacleListPubSubType();
        ~RadarObstacleListPubSubType();
    };
...
%template(RadarObstacleListDataWriter) FastddsDataWriter<ros2_interface::msg::RadarObstacleListPubSubType>;
%template(RadarObstacleListDataReader) FastddsDataReader<ros2_interface::msg::RadarObstacleListPubSubType>;
