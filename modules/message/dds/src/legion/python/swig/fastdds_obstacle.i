...
%template(ObstacleDataWriter) FastddsDataWriter<ros2_interface::msg::ObstaclePubSubType>;
%template(ObstacleDataReader) FastddsDataReader<ros2_interface::msg::ObstaclePubSubType>;
