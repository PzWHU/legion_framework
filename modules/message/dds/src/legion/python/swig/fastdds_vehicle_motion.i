%module fastdds_vehicle_motion 
%{
#include "FastddsDataReader.hpp"
#include "FastddsDataWriter.hpp"
#include "VehicleMotionPubSubTypes.h"
...
namespace std {
    %template(VectorVehicleMotionPoint) vector<ros2_interface::msg::VehicleMotionPoint>;
}
...
namespace msg{
    ...
    public:
        ...
        void vehicle_motion_point(
            const std::vector<ros2_interface::msg::VehicleMotionPoint> &_vehicle_motion_point);
        const std::vector<ros2_interface::msg::VehicleMotionPoint>& vehicle_motion_point() const;
    };
    ...
    class VehicleMotionPubSubType
    {
    public:
        typedef VehicleMotion type;

        VehicleMotionPubSubType();
        ~VehicleMotionPubSubType();
    };
...
%template(VehicleMotionDataWriter) FastddsDataWriter<ros2_interface::msg::VehicleMotionPubSubType>;
%template(VehicleMotionDataReader) FastddsDataReader<ros2_interface::msg::VehicleMotionPubSubType>;
