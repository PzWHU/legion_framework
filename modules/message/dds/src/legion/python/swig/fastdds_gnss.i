...
%template(GnssDataWriter) FastddsDataWriter<ros2_interface::msg::GnssPubSubType>;
%template(GnssDataReader) FastddsDataReader<ros2_interface::msg::GnssPubSubType>;
