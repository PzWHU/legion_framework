...
%template(LaneInfoDataWriter) FastddsDataWriter<ros2_interface::msg::LaneInfoPubSubType>;
%template(LaneInfoDataReader) FastddsDataReader<ros2_interface::msg::LaneInfoPubSubType>;
