...
%template(LaneLineDataWriter) FastddsDataWriter<ros2_interface::msg::LaneLinePubSubType>;
%template(LaneLineDataReader) FastddsDataReader<ros2_interface::msg::LaneLinePubSubType>;
