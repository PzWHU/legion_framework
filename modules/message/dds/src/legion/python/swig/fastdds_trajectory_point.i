%module fastdds_trajectory_point 
%{
...
%template(TrajectoryPointDataWriter) FastddsDataWriter<ros2_interface::msg::TrajectoryPointPubSubType>;
%template(TrajectoryPointDataReader) FastddsDataReader<ros2_interface::msg::TrajectoryPointPubSubType>;
