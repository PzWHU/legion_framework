...
%template(TrajectoryDataWriter) FastddsDataWriter<ros2_interface::msg::TrajectoryPubSubType>;
%template(TrajectoryDataReader) FastddsDataReader<ros2_interface::msg::TrajectoryPubSubType>;
