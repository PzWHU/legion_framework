...
if (args.endpoint == 'publisher'):
    ...
    try:
        c3_od_obstacle_list1_pub = fastdds_obstacle_list.ObstacleListDataWriter(0, "rt/perception/camera/camera_3d_object_detect/C3ODObstacleList1")
        c3_od_obstacle_list3_pub = fastdds_obstacle_list.ObstacleListDataWriter(0, "rt/perception/camera/camera_3d_object_detect/C3ODObstacleList3")
        c3_od_obstacle_list4_pub = fastdds_obstacle_list.ObstacleListDataWriter(0, "rt/perception/camera/camera_3d_object_detect/C3ODObstacleList4")
    ...
    try:
        ...
        while True:
            ...
            counter = counter + 1
            # publish
            c3_od_obstacle_list1_pub.write_sample(c3_od_obstacle_list1)
            c3_od_obstacle_list3_pub.write_sample(c3_od_obstacle_list3)
            c3_od_obstacle_list4_pub.write_sample(c3_od_obstacle_list4)
