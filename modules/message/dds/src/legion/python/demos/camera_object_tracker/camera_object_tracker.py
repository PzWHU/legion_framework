...
if (args.endpoint == 'publisher'):
    ...
    try:
        obstacle_list_output_pub = fastdds_obstacle_list.ObstacleListDataWriter(0, "rt/perception/camera/camera_object_tracker/COTObstacleList")
        faults_pub = fastdds_faults.FaultsDataWriter(0, "rt/perception/camera/camera_object_tracker/Faults")
...
# Loop for the subscriber
    ...
    # Create a publisher on the topic
    try:
        obstacle_list_input_sub = fastdds_obstacle_list.ObstacleListDataReader(0, "rt/perception/camera/camera_objects_fusion/COFObstacleList")
