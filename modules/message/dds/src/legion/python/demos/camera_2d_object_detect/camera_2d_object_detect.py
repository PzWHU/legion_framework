...
if (args.endpoint == 'publisher'):
    ...
    try:
        obstacle_list_pub = fastdds_obstacle_list.ObstacleListDataWriter(0, "rt/perception/camera/camera_2d_object_detect/C2ODObstacleList")
        faults_pub = fastdds_faults.FaultsDataWriter(0, "rt/perception/camera/camera_2d_object_detect/Faults")
