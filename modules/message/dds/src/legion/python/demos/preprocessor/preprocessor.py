...
# Loop for the subscriber
    ...
    try:
        ...
        c3_od_obstacle_list4_sub = fastdds_obstacle_list.ObstacleListDataReader(0, "rt/perception/camera/camera_3d_object_detect/C3ODObstacleList4")
        c3_od_obstacle_list3_sub = fastdds_obstacle_list.ObstacleListDataReader(0, "rt/perception/camera/camera_3d_object_detect/C3ODObstacleList3")
        c3_od_obstacle_list2_sub = fastdds_obstacle_list.ObstacleListDataReader(0, "rt/perception/camera/camera_3d_object_detect/C3ODObstacleList2")
        c3_od_obstacle_list1_sub = fastdds_obstacle_list.ObstacleListDataReader(0, "rt/perception/camera/camera_3d_object_detect/C3ODObstacleList1")
    ...
    c3_od_obstacle_list4 = fastdds_obstacle_list.ObstacleList()
    c3_od_obstacle_list3 = fastdds_obstacle_list.ObstacleList()
    c3_od_obstacle_list2 = fastdds_obstacle_list.ObstacleList()
    c3_od_obstacle_list1 = fastdds_obstacle_list.ObstacleList()
    ...
    try:
        while True:
            ...
            # Wait for a message for 2 seconds
            if (c3_od_obstacle_list4_sub.wait_for_sample(2)):
                # Read the received message
                if (c3_od_obstacle_list4_sub.take_sample(c3_od_obstacle_list4)):
                    print("success")
                ...
                print('No messages received in the last loop')
            # Wait for a message for 2 seconds
            if (c3_od_obstacle_list3_sub.wait_for_sample(2)):
                # Read the received message
                if (c3_od_obstacle_list3_sub.take_sample(c3_od_obstacle_list3)):
                    print("success")
                ...
                print('No messages received in the last loop')
            # Wait for a message for 2 seconds
            if (c3_od_obstacle_list2_sub.wait_for_sample(2)):
                # Read the received message
                if (c3_od_obstacle_list2_sub.take_sample(c3_od_obstacle_list2)):
                    print("success")
                ...
                print('No messages received in the last loop')
            # Wait for a message for 2 seconds
            if (c3_od_obstacle_list1_sub.wait_for_sample(2)):
                # Read the received message
                if (c3_od_obstacle_list1_sub.take_sample(c3_od_obstacle_list1)):
                    print("success")
