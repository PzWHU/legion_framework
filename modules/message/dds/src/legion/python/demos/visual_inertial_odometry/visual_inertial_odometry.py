...
if (args.endpoint == 'publisher'):
    ...
    try:
        odometry_pub = fastdds_odometry.OdometryDataWriter(0, "rt/localization/visual_inertial_odometry/VIOOdometry")
        faults_pub = fastdds_faults.FaultsDataWriter(0, "rt/localization/visual_inertial_odometry/Faults")
