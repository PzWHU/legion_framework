...
if (args.endpoint == 'publisher'):
    ...
    try:
        ground_points_pub = fastdds_point_cloud.PointCloudDataWriter(0, "rt/perception/lidar/lidar_segment_ground/GroundPoints")
        no_ground_points_pub = fastdds_point_cloud.PointCloudDataWriter(0, "rt/perception/lidar/lidar_segment_ground/NoGroundPoints")
        faults_pub = fastdds_faults.FaultsDataWriter(0, "rt/perception/lidar/lidar_segment_ground/Faults")
