...
if (args.endpoint == 'publisher'):
    ...
    try:
        ...
        navi_info_msg_pub = fastdds_navi_info_msg.NaviInfoMsgDataWriter(0, "rt/routing/NaviInfoMsg")
    ...
    navi_info_msg = fastdds_navi_info_msg.NaviInfoMsg()
    ...
    try:
        ...
        while True:
            ...
            navi_info_msg_pub.write_sample(navi_info_msg)
