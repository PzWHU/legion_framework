...
namespace legion
{
  namespace control
  {
    ...
    legion::common::Status LonSpeedController::ComputeControlCommand(const legion::interface::LocalizationEstimate *localization,
    ...
    // if (epb_sm_)
      ...
      // std::cout << "刹车命令     :"<< cmd ->brake_value()<< std::endl;
                                                       ...
                                                       SimpleLongitudinalDebug *debug)
    {
      ...
      // 修复人工驾驶状态下车速设置的bug
      if (std::isnan(heading_error) || chassis-> accel_driving_mode() == legion::common::DrivingMode::COMPLETE_MANUAL)
      {
        heading_error = 0;
      }
    ...
    void LonSpeedController::SetAnalysis(const legion::interface::ControlCommand *cmd,
