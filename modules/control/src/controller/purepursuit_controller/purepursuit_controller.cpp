...
namespace legion
{
  namespace control
  {
    ...
    legion::common::Status PurePursuitController::Init(
    ...
    legion::common::Status PurePursuitController::ComputeControlCommand(const legion::interface::LocalizationEstimate *localization,
                                                                        ...
                                                                        legion::interface::ControlAnalysis *analysis)
    {
      ...
      else if (vehicle_state->gear() == legion::common::GearPosition::GEAR_DRIVE)
      {
        front_heading_error_feedback = -heading_pid_feedback_;
      }
      ...
      // }
      // 非泊车过程中，转角赋0
      if (chassis->steer_driving_mode() == legion::common::DrivingMode::COMPLETE_MANUAL ||
      ...
      //     legion::interface::ADCTrajectory::BehaviourState::PARKING_FINISH_STATE
      //     || trajectory->behaviour_state() ==
      //     legion::interface::ADCTrajectory::BehaviourState::FINISH_STATE)
      {
      ...
      //   legion::interface::ADCTrajectory::BehaviourState::PARKING_FINISH_STATE
      //      && trajectory->behaviour_state() !=
      //      legion::interface::ADCTrajectory::BehaviourState::INITIAL_STATE)
      //   {
      //     steer_back_step_ = 0;
      //   }
      //   break;
    ...
    void PurePursuitController::ComputeLateralErrors(
        ...
        const legion::interface::TrajectoryPoint &target_point,
    ...
    legion::interface::TrajectoryPoint PurePursuitController::ComputeTargetPoint(
        const legion::common::math::Vec2d pos, const double theta, const double s,
        const legion::interface::ADCTrajectory *trajectory)
    {
    ...
    double PurePursuitController::ComputePointsDistanceSquared(
        const legion::common::math::Vec2d pos1,
        const legion::common::math::Vec2d pos2)
    {
    ...
    legion::common::math::Vec2d PurePursuitController::ComputeRelativeXYOffset(
        const legion::common::math::Vec2d pos1,
        const legion::common::math::Vec2d pos2)
    {
      ...
      const legion::common::math::Vec2d relative_xy(relative_x, relative_y);
      return relative_xy;
    }
    ...
    void PurePursuitController::SetAnalysis(const legion::interface::ControlCommand *cmd,
                                            const SimpleLateralDebug *debug,
                                            const legion::interface::Chassis *chassis,
                                            legion::interface::ControlAnalysis *analysis)
    {
    ...
    legion::common::Status PurePursuitController::Reset()
    {
