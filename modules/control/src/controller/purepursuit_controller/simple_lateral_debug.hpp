...
class SimpleLateralDebug {
 public:
  ...
  void set_current_target_point(
      interface::TrajectoryPoint current_target_point) {
    current_target_point_ = current_target_point;
  }

  interface::TrajectoryPoint current_target_point() const {
 ...
 protected:
  ...
  interface::TrajectoryPoint current_target_point_;
