...
class Controller {
 public:
   ...
   * @return Status 初始化状态
   */
  virtual legion::common::Status Init(
   ...
   * @return legion::common::Status 计算状态
   */
  virtual legion::common::Status ComputeControlCommand(
      const legion::interface::LocalizationEstimate *localization,
      const legion::interface::Chassis *chassis, const legion::interface::ADCTrajectory *trajectory,
      legion::interface::ControlCommand *cmd, legion::interface::ControlAnalysis *analysis) = 0;

  /**
   * @brief 重置控制器
   * @return legion::common::Status 重置状态
   */
  virtual legion::common::Status Reset() = 0;
