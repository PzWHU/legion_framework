...
namespace legion 
{
  namespace control 
  {
    legion::interface::ControlCommand *lon_cmd_;
    ...
    void LonController::GearTransition(legion::interface::ControlCommand *cmd) 
    {
      if (cmd == nullptr) 
      {
    ...
    void LonController::GearNEntry(const std::string &state_name, int state) {
      ...
      lon_cmd_->set_gear_location(legion::common::GearPosition::GEAR_NEUTRAL);
    }
    ...
    void LonController::GearDEntry(const std::string &state_name, int state) {
      ...
      lon_cmd_->set_gear_location(legion::common::GearPosition::GEAR_DRIVE);
    }
    ...
    void LonController::GearREntry(const std::string &state_name, int state) {
      ...
      lon_cmd_->set_gear_location(legion::common::GearPosition::GEAR_REVERSE);
    }
    ...
    void LonController::EPBAppliedEntry(const std::string &state_name, int state) {
      lon_cmd_->set_epb_level(legion::common::EPBLevel::APPLIED);
    }
    ...
    void LonController::EPBReleaseEntry(const std::string &state_name, int state) {
      lon_cmd_->set_epb_level(legion::common::EPBLevel::RELEASED);
    }
