...
class SimpleLongitudinalDebug {
 public:
  ...
  void set_current_matched_point(
      legion::interface::TrajectoryPoint current_matched_point) {
    current_matched_point_ = current_matched_point;
  }

  legion::interface::TrajectoryPoint current_matched_point() const {
    return current_matched_point_;
  }

  void set_current_reference_point(
      legion::interface::TrajectoryPoint current_reference_point) {
    current_reference_point_ = current_reference_point;
  }

  legion::interface::TrajectoryPoint current_reference_point() const {
    return current_reference_point_;
  }

  void set_preview_reference_point(
      legion::interface::TrajectoryPoint preview_reference_point) {
    preview_reference_point_ = preview_reference_point;
  }

  legion::interface::TrajectoryPoint preview_reference_point() const {
 ...
 protected:
  ...
  double jerk_error_;
  legion::interface::TrajectoryPoint current_matched_point_;
  legion::interface::TrajectoryPoint current_reference_point_;
  legion::interface::TrajectoryPoint preview_reference_point_;
};
}  // namespace control
}  // namespace legion
