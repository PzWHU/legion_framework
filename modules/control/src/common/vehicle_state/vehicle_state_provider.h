...
class VehicleStateProvider {
 public:
   ...
   */
  Status Update(const legion::interface::LocalizationEstimate& localization,
 ...
 private:
  ...
  legion::interface::LocalizationEstimate original_localization_;
