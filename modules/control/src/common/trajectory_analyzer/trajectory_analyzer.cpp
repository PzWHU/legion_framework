...
TrajectoryAnalyzer::TrajectoryAnalyzer(
    const legion::interface::ADCTrajectory *planning_published_trajectory) {
  ...
  // }
  // int64_t time_diff_6 = legion::common::TimeTool::Now2Us() - current_time;
...
TrajectoryPoint TrajectoryAnalyzer::QueryNearestPointByAbsoluteTime(
  ...
  // std::cout<<"sequence_num:"<<seq_num_<<std::endl;
  // std::cout << "diff:" << t - header_time_ << std::endl;
  // std::cout << "t:" << t << std::fixed << std::endl;
  // std::cout << "header_time_:" << header_time_ << std::fixed << std::endl;
...
TrajectoryPoint TrajectoryAnalyzer::QueryNearestPointByRelativeTime(
  ...
  auto func_comp = [](const TrajectoryPoint &point,
    ...
    // std::cout<<"point.relative_time() : "<<point.relative_time() <<std::endl;
  ...
  if (it_low == trajectory_points_.begin()) {
    // std::cout<<"it_low.relative_time() : "<<it_low->relative_time()
    // <<std::endl; std::cout<<"trajectory_points_.begin() :
    // "<<trajectory_points_.begin() <<std::endl;
