...
class Control {
 ...
 protected:
   ...
   */
  void PublishControlCommand(legion::interface::ControlCommand control_cmd);
   ...
   */
  void SetBcmControlCmd(legion::interface::ControlCommand *control_cmd,
  ...
  bool StopIfObstacleClose(legion::interface::ObstacleList obstacle_list);
 ...
 public:
   ...
   * @return    void.
   */
  void HandleADCTrajectory(legion::interface::ADCTrajectory trajectory_msg);
   ...
   * @return    void.
   */
  void HandleObstacleList(legion::interface::ObstacleList obstacle_list);
   ...
   * @return    void.
   */
  void HandlePlanningCmd(legion::interface::PlanningCmd planning_cmd);
 ...
 protected:
  ...
  /// @brief 控制分析数据
  legion::interface::ControlAnalysis control_analysis_;
  /// @brief 故障码
  ...
  /// @brief debug调试定位
  legion::interface::Location localization_debug_;
