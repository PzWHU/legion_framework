...
#ifndef GOOGLE_PROTOBUF_INCLUDED_modules_2fcontrol_2fsrc_2fproto_2fpid_5fconf_2eproto
#define GOOGLE_PROTOBUF_INCLUDED_modules_2fcontrol_2fsrc_2fproto_2fpid_5fconf_2eproto
...
#include <google/protobuf/port_def.inc>
#define PROTOBUF_INTERNAL_EXPORT_modules_2fcontrol_2fsrc_2fproto_2fpid_5fconf_2eproto
...
struct TableStruct_modules_2fcontrol_2fsrc_2fproto_2fpid_5fconf_2eproto {
...
extern const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_modules_2fcontrol_2fsrc_2fproto_2fpid_5fconf_2eproto;
namespace legion {
namespace control {
class PIDConf;
...
PROTOBUF_NAMESPACE_OPEN
template<> ::legion::control::PIDConf* Arena::CreateMaybeMessage<::legion::control::PIDConf>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
namespace legion {
namespace control {
...
class PIDConf PROTOBUF_FINAL :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:legion.control.PIDConf) */ {
 public:
  ...
  static ::PROTOBUF_NAMESPACE_ID::Metadata GetMetadataStatic() {
    ::PROTOBUF_NAMESPACE_ID::internal::AssignDescriptors(&::descriptor_table_modules_2fcontrol_2fsrc_2fproto_2fpid_5fconf_2eproto);
    return ::descriptor_table_modules_2fcontrol_2fsrc_2fproto_2fpid_5fconf_2eproto.file_level_metadata[kIndexInFileMessages];
  }
  ...
  // @@protoc_insertion_point(class_scope:legion.control.PIDConf)
 private:
  class _Internal;
  ...
  friend struct ::TableStruct_modules_2fcontrol_2fsrc_2fproto_2fpid_5fconf_2eproto;
};
// ===================================================================
...
inline bool PIDConf::integrator_enable() const {
  // @@protoc_insertion_point(field_get:legion.control.PIDConf.integrator_enable)
...
inline void PIDConf::set_integrator_enable(bool value) {
  ...
  // @@protoc_insertion_point(field_set:legion.control.PIDConf.integrator_enable)
}
...
inline double PIDConf::integrator_saturation_level() const {
  // @@protoc_insertion_point(field_get:legion.control.PIDConf.integrator_saturation_level)
...
inline void PIDConf::set_integrator_saturation_level(double value) {
  ...
  // @@protoc_insertion_point(field_set:legion.control.PIDConf.integrator_saturation_level)
}
...
inline double PIDConf::kp() const {
  // @@protoc_insertion_point(field_get:legion.control.PIDConf.kp)
  return _internal_kp();
}
...
inline void PIDConf::set_kp(double value) {
  ...
  // @@protoc_insertion_point(field_set:legion.control.PIDConf.kp)
}
...
inline double PIDConf::ki() const {
  // @@protoc_insertion_point(field_get:legion.control.PIDConf.ki)
  return _internal_ki();
}
...
inline void PIDConf::set_ki(double value) {
  ...
  // @@protoc_insertion_point(field_set:legion.control.PIDConf.ki)
}
...
inline double PIDConf::kd() const {
  // @@protoc_insertion_point(field_get:legion.control.PIDConf.kd)
  return _internal_kd();
}
...
inline void PIDConf::set_kd(double value) {
  ...
  // @@protoc_insertion_point(field_set:legion.control.PIDConf.kd)
}
...
inline double PIDConf::kaw() const {
  // @@protoc_insertion_point(field_get:legion.control.PIDConf.kaw)
...
inline void PIDConf::set_kaw(double value) {
  ...
  // @@protoc_insertion_point(field_set:legion.control.PIDConf.kaw)
}
...
inline double PIDConf::output_saturation_level() const {
  // @@protoc_insertion_point(field_get:legion.control.PIDConf.output_saturation_level)
...
inline void PIDConf::set_output_saturation_level(double value) {
  ...
  // @@protoc_insertion_point(field_set:legion.control.PIDConf.output_saturation_level)
}
...
#include <google/protobuf/port_undef.inc>
#endif  // GOOGLE_PROTOBUF_INCLUDED_GOOGLE_PROTOBUF_INCLUDED_modules_2fcontrol_2fsrc_2fproto_2fpid_5fconf_2eproto
