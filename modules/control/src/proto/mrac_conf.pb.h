...
#ifndef GOOGLE_PROTOBUF_INCLUDED_modules_2fcontrol_2fsrc_2fproto_2fmrac_5fconf_2eproto
#define GOOGLE_PROTOBUF_INCLUDED_modules_2fcontrol_2fsrc_2fproto_2fmrac_5fconf_2eproto
...
#include <google/protobuf/port_def.inc>
#define PROTOBUF_INTERNAL_EXPORT_modules_2fcontrol_2fsrc_2fproto_2fmrac_5fconf_2eproto
...
struct TableStruct_modules_2fcontrol_2fsrc_2fproto_2fmrac_5fconf_2eproto {
...
extern const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_modules_2fcontrol_2fsrc_2fproto_2fmrac_5fconf_2eproto;
namespace legion {
namespace control {
class MracConf;
...
PROTOBUF_NAMESPACE_OPEN
template<> ::legion::control::MracConf* Arena::CreateMaybeMessage<::legion::control::MracConf>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
namespace legion {
namespace control {
...
class MracConf PROTOBUF_FINAL :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:legion.control.MracConf) */ {
 public:
  ...
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "legion.control.MracConf";
  }
  protected:
  ...
  static ::PROTOBUF_NAMESPACE_ID::Metadata GetMetadataStatic() {
    ::PROTOBUF_NAMESPACE_ID::internal::AssignDescriptors(&::descriptor_table_modules_2fcontrol_2fsrc_2fproto_2fmrac_5fconf_2eproto);
    return ::descriptor_table_modules_2fcontrol_2fsrc_2fproto_2fmrac_5fconf_2eproto.file_level_metadata[kIndexInFileMessages];
  }
  ...
  // @@protoc_insertion_point(class_scope:legion.control.MracConf)
 private:
  class _Internal;
  ...
  friend struct ::TableStruct_modules_2fcontrol_2fsrc_2fproto_2fmrac_5fconf_2eproto;
};
// ===================================================================
...
inline ::PROTOBUF_NAMESPACE_ID::int32 MracConf::mrac_model_order() const {
  // @@protoc_insertion_point(field_get:legion.control.MracConf.mrac_model_order)
...
inline void MracConf::set_mrac_model_order(::PROTOBUF_NAMESPACE_ID::int32 value) {
  ...
  // @@protoc_insertion_point(field_set:legion.control.MracConf.mrac_model_order)
}
...
inline double MracConf::reference_time_constant() const {
  // @@protoc_insertion_point(field_get:legion.control.MracConf.reference_time_constant)
...
inline void MracConf::set_reference_time_constant(double value) {
  ...
  // @@protoc_insertion_point(field_set:legion.control.MracConf.reference_time_constant)
}
...
inline double MracConf::reference_natural_frequency() const {
  // @@protoc_insertion_point(field_get:legion.control.MracConf.reference_natural_frequency)
...
inline void MracConf::set_reference_natural_frequency(double value) {
  ...
  // @@protoc_insertion_point(field_set:legion.control.MracConf.reference_natural_frequency)
}
...
inline double MracConf::reference_damping_ratio() const {
  // @@protoc_insertion_point(field_get:legion.control.MracConf.reference_damping_ratio)
...
inline void MracConf::set_reference_damping_ratio(double value) {
  ...
  // @@protoc_insertion_point(field_set:legion.control.MracConf.reference_damping_ratio)
}
...
inline double MracConf::adaption_state_gain(int index) const {
  // @@protoc_insertion_point(field_get:legion.control.MracConf.adaption_state_gain)
...
inline void MracConf::set_adaption_state_gain(int index, double value) {
  ...
  // @@protoc_insertion_point(field_set:legion.control.MracConf.adaption_state_gain)
}
...
inline void MracConf::add_adaption_state_gain(double value) {
  ...
  // @@protoc_insertion_point(field_add:legion.control.MracConf.adaption_state_gain)
}
...
MracConf::adaption_state_gain() const {
  // @@protoc_insertion_point(field_list:legion.control.MracConf.adaption_state_gain)
...
MracConf::mutable_adaption_state_gain() {
  // @@protoc_insertion_point(field_mutable_list:legion.control.MracConf.adaption_state_gain)
...
inline double MracConf::adaption_desired_gain() const {
  // @@protoc_insertion_point(field_get:legion.control.MracConf.adaption_desired_gain)
...
inline void MracConf::set_adaption_desired_gain(double value) {
  ...
  // @@protoc_insertion_point(field_set:legion.control.MracConf.adaption_desired_gain)
}
...
inline double MracConf::adaption_nonlinear_gain() const {
  // @@protoc_insertion_point(field_get:legion.control.MracConf.adaption_nonlinear_gain)
...
inline void MracConf::set_adaption_nonlinear_gain(double value) {
  ...
  // @@protoc_insertion_point(field_set:legion.control.MracConf.adaption_nonlinear_gain)
}
...
inline double MracConf::adaption_matrix_p(int index) const {
  // @@protoc_insertion_point(field_get:legion.control.MracConf.adaption_matrix_p)
...
inline void MracConf::set_adaption_matrix_p(int index, double value) {
  ...
  // @@protoc_insertion_point(field_set:legion.control.MracConf.adaption_matrix_p)
}
...
inline void MracConf::add_adaption_matrix_p(double value) {
  ...
  // @@protoc_insertion_point(field_add:legion.control.MracConf.adaption_matrix_p)
}
inline const ::PROTOBUF_NAMESPACE_ID::RepeatedField< double >&
...
MracConf::adaption_matrix_p() const {
  // @@protoc_insertion_point(field_list:legion.control.MracConf.adaption_matrix_p)
...
MracConf::mutable_adaption_matrix_p() {
  // @@protoc_insertion_point(field_mutable_list:legion.control.MracConf.adaption_matrix_p)
...
inline double MracConf::mrac_saturation_level() const {
  // @@protoc_insertion_point(field_get:legion.control.MracConf.mrac_saturation_level)
...
inline void MracConf::set_mrac_saturation_level(double value) {
  ...
  // @@protoc_insertion_point(field_set:legion.control.MracConf.mrac_saturation_level)
}
...
inline double MracConf::anti_windup_compensation_gain(int index) const {
  // @@protoc_insertion_point(field_get:legion.control.MracConf.anti_windup_compensation_gain)
...
inline void MracConf::set_anti_windup_compensation_gain(int index, double value) {
  ...
  // @@protoc_insertion_point(field_set:legion.control.MracConf.anti_windup_compensation_gain)
}
...
inline void MracConf::add_anti_windup_compensation_gain(double value) {
  ...
  // @@protoc_insertion_point(field_add:legion.control.MracConf.anti_windup_compensation_gain)
}
inline const ::PROTOBUF_NAMESPACE_ID::RepeatedField< double >&
...
MracConf::anti_windup_compensation_gain() const {
  // @@protoc_insertion_point(field_list:legion.control.MracConf.anti_windup_compensation_gain)
...
MracConf::mutable_anti_windup_compensation_gain() {
  // @@protoc_insertion_point(field_mutable_list:legion.control.MracConf.anti_windup_compensation_gain)
...
inline double MracConf::clamping_time_constant() const {
  // @@protoc_insertion_point(field_get:legion.control.MracConf.clamping_time_constant)
...
inline void MracConf::set_clamping_time_constant(double value) {
  ...
  // @@protoc_insertion_point(field_set:legion.control.MracConf.clamping_time_constant)
}
...
#include <google/protobuf/port_undef.inc>
#endif  // GOOGLE_PROTOBUF_INCLUDED_GOOGLE_PROTOBUF_INCLUDED_modules_2fcontrol_2fsrc_2fproto_2fmrac_5fconf_2eproto
