...
// source: modules/control/src/proto/mrac_conf.proto
...
static void InitDefaultsscc_info_MracConf_modules_2fcontrol_2fsrc_2fproto_2fmrac_5fconf_2eproto() {
  GOOGLE_PROTOBUF_VERIFY_VERSION;

  {
    void* ptr = &::legion::control::_MracConf_default_instance_;
    new (ptr) ::legion::control::MracConf();
    ::PROTOBUF_NAMESPACE_ID::internal::OnShutdownDestroyMessage(ptr);
  }
}

::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<0> scc_info_MracConf_modules_2fcontrol_2fsrc_2fproto_2fmrac_5fconf_2eproto =
    {{ATOMIC_VAR_INIT(::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase::kUninitialized), 0, 0, InitDefaultsscc_info_MracConf_modules_2fcontrol_2fsrc_2fproto_2fmrac_5fconf_2eproto}, {}};

static ::PROTOBUF_NAMESPACE_ID::Metadata file_level_metadata_modules_2fcontrol_2fsrc_2fproto_2fmrac_5fconf_2eproto[1];
static constexpr ::PROTOBUF_NAMESPACE_ID::EnumDescriptor const** file_level_enum_descriptors_modules_2fcontrol_2fsrc_2fproto_2fmrac_5fconf_2eproto = nullptr;
static constexpr ::PROTOBUF_NAMESPACE_ID::ServiceDescriptor const** file_level_service_descriptors_modules_2fcontrol_2fsrc_2fproto_2fmrac_5fconf_2eproto = nullptr;

const ::PROTOBUF_NAMESPACE_ID::uint32 TableStruct_modules_2fcontrol_2fsrc_2fproto_2fmrac_5fconf_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  PROTOBUF_FIELD_OFFSET(::legion::control::MracConf, _has_bits_),
  PROTOBUF_FIELD_OFFSET(::legion::control::MracConf, _internal_metadata_),
  ~0u,  // no _extensions_
  ~0u,  // no _oneof_case_
  ~0u,  // no _weak_field_map_
  PROTOBUF_FIELD_OFFSET(::legion::control::MracConf, mrac_model_order_),
  PROTOBUF_FIELD_OFFSET(::legion::control::MracConf, reference_time_constant_),
  PROTOBUF_FIELD_OFFSET(::legion::control::MracConf, reference_natural_frequency_),
  PROTOBUF_FIELD_OFFSET(::legion::control::MracConf, reference_damping_ratio_),
  PROTOBUF_FIELD_OFFSET(::legion::control::MracConf, adaption_state_gain_),
  PROTOBUF_FIELD_OFFSET(::legion::control::MracConf, adaption_desired_gain_),
  PROTOBUF_FIELD_OFFSET(::legion::control::MracConf, adaption_nonlinear_gain_),
  PROTOBUF_FIELD_OFFSET(::legion::control::MracConf, adaption_matrix_p_),
  PROTOBUF_FIELD_OFFSET(::legion::control::MracConf, mrac_saturation_level_),
  PROTOBUF_FIELD_OFFSET(::legion::control::MracConf, anti_windup_compensation_gain_),
  PROTOBUF_FIELD_OFFSET(::legion::control::MracConf, clamping_time_constant_),
  6,
  0,
  1,
  2,
...
static const ::PROTOBUF_NAMESPACE_ID::internal::MigrationSchema schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  { 0, 16, sizeof(::legion::control::MracConf)},
};

static ::PROTOBUF_NAMESPACE_ID::Message const * const file_default_instances[] = {
  reinterpret_cast<const ::PROTOBUF_NAMESPACE_ID::Message*>(&::legion::control::_MracConf_default_instance_),
};

const char descriptor_table_protodef_modules_2fcontrol_2fsrc_2fproto_2fmrac_5fconf_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  "\n)modules/control/src/proto/mrac_conf.pr"
  "oto\022\016legion.control\"\357\002\n\010MracConf\022\033\n\020mrac"
  "_model_order\030\001 \001(\005:\0011\022\037\n\027reference_time_"
  "constant\030\002 \001(\001\022#\n\033reference_natural_freq"
  "uency\030\003 \001(\001\022\037\n\027reference_damping_ratio\030\004"
  " \001(\001\022\033\n\023adaption_state_gain\030\005 \003(\001\022\035\n\025ada"
  "ption_desired_gain\030\006 \001(\001\022\037\n\027adaption_non"
  "linear_gain\030\007 \001(\001\022\031\n\021adaption_matrix_p\030\010"
  " \003(\001\022 \n\025mrac_saturation_level\030\t \001(\001:\0011\022%"
  "\n\035anti_windup_compensation_gain\030\n \003(\001\022\036\n"
  "\026clamping_time_constant\030\013 \001(\001"
  ;
static const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable*const descriptor_table_modules_2fcontrol_2fsrc_2fproto_2fmrac_5fconf_2eproto_deps[1] = {
};
static ::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase*const descriptor_table_modules_2fcontrol_2fsrc_2fproto_2fmrac_5fconf_2eproto_sccs[1] = {
  &scc_info_MracConf_modules_2fcontrol_2fsrc_2fproto_2fmrac_5fconf_2eproto.base,
};
static ::PROTOBUF_NAMESPACE_ID::internal::once_flag descriptor_table_modules_2fcontrol_2fsrc_2fproto_2fmrac_5fconf_2eproto_once;
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_modules_2fcontrol_2fsrc_2fproto_2fmrac_5fconf_2eproto = {
  false, false, descriptor_table_protodef_modules_2fcontrol_2fsrc_2fproto_2fmrac_5fconf_2eproto, "modules/control/src/proto/mrac_conf.proto", 429,
  &descriptor_table_modules_2fcontrol_2fsrc_2fproto_2fmrac_5fconf_2eproto_once, descriptor_table_modules_2fcontrol_2fsrc_2fproto_2fmrac_5fconf_2eproto_sccs, descriptor_table_modules_2fcontrol_2fsrc_2fproto_2fmrac_5fconf_2eproto_deps, 1, 0,
  schemas, file_default_instances, TableStruct_modules_2fcontrol_2fsrc_2fproto_2fmrac_5fconf_2eproto::offsets,
  file_level_metadata_modules_2fcontrol_2fsrc_2fproto_2fmrac_5fconf_2eproto, 1, file_level_enum_descriptors_modules_2fcontrol_2fsrc_2fproto_2fmrac_5fconf_2eproto, file_level_service_descriptors_modules_2fcontrol_2fsrc_2fproto_2fmrac_5fconf_2eproto,
};

// Force running AddDescriptors() at dynamic initialization time.
static bool dynamic_init_dummy_modules_2fcontrol_2fsrc_2fproto_2fmrac_5fconf_2eproto = (static_cast<void>(::PROTOBUF_NAMESPACE_ID::internal::AddDescriptors(&descriptor_table_modules_2fcontrol_2fsrc_2fproto_2fmrac_5fconf_2eproto)), true);
namespace legion {
namespace control {
...
MracConf::MracConf(::PROTOBUF_NAMESPACE_ID::Arena* arena)
  ...
  // @@protoc_insertion_point(arena_constructor:legion.control.MracConf)
}
MracConf::MracConf(const MracConf& from)
  ...
  // @@protoc_insertion_point(copy_constructor:legion.control.MracConf)
}
...
MracConf::~MracConf() {
  // @@protoc_insertion_point(destructor:legion.control.MracConf)
  SharedDtor();
...
const MracConf& MracConf::default_instance() {
  ::PROTOBUF_NAMESPACE_ID::internal::InitSCC(&::scc_info_MracConf_modules_2fcontrol_2fsrc_2fproto_2fmrac_5fconf_2eproto.base);
  return *internal_default_instance();
}


void MracConf::Clear() {
// @@protoc_insertion_point(message_clear_start:legion.control.MracConf)
...
::PROTOBUF_NAMESPACE_ID::uint8* MracConf::_InternalSerialize(
  ...
  // @@protoc_insertion_point(serialize_to_array_start:legion.control.MracConf)
  ::PROTOBUF_NAMESPACE_ID::uint32 cached_has_bits = 0;
  (void) cached_has_bits;
  ...
  // @@protoc_insertion_point(serialize_to_array_end:legion.control.MracConf)
  return target;
}

size_t MracConf::ByteSizeLong() const {
// @@protoc_insertion_point(message_byte_size_start:legion.control.MracConf)
  size_t total_size = 0;
...
// @@protoc_insertion_point(generalized_merge_from_start:legion.control.MracConf)
  GOOGLE_DCHECK_NE(&from, this);
  const MracConf* source =
      ::PROTOBUF_NAMESPACE_ID::DynamicCastToGenerated<MracConf>(
          &from);
  if (source == nullptr) {
  // @@protoc_insertion_point(generalized_merge_from_cast_fail:legion.control.MracConf)
    ::PROTOBUF_NAMESPACE_ID::internal::ReflectionOps::Merge(from, this);
  } else {
  // @@protoc_insertion_point(generalized_merge_from_cast_success:legion.control.MracConf)
    MergeFrom(*source);
  }
}

void MracConf::MergeFrom(const MracConf& from) {
// @@protoc_insertion_point(class_specific_merge_from_start:legion.control.MracConf)
  GOOGLE_DCHECK_NE(&from, this);
  _internal_metadata_.MergeFrom<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>(from._internal_metadata_);
  ::PROTOBUF_NAMESPACE_ID::uint32 cached_has_bits = 0;
  (void) cached_has_bits;
...
// @@protoc_insertion_point(generalized_copy_from_start:legion.control.MracConf)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
// @@protoc_insertion_point(class_specific_copy_from_start:legion.control.MracConf)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
template<> PROTOBUF_NOINLINE ::legion::control::MracConf* Arena::CreateMaybeMessage< ::legion::control::MracConf >(Arena* arena) {
  return Arena::CreateMessageInternal< ::legion::control::MracConf >(arena);
}
