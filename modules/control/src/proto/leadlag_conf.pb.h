...
#ifndef GOOGLE_PROTOBUF_INCLUDED_modules_2fcontrol_2fsrc_2fproto_2fleadlag_5fconf_2eproto
#define GOOGLE_PROTOBUF_INCLUDED_modules_2fcontrol_2fsrc_2fproto_2fleadlag_5fconf_2eproto
...
#include <google/protobuf/port_def.inc>
#define PROTOBUF_INTERNAL_EXPORT_modules_2fcontrol_2fsrc_2fproto_2fleadlag_5fconf_2eproto
...
struct TableStruct_modules_2fcontrol_2fsrc_2fproto_2fleadlag_5fconf_2eproto {
...
extern const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_modules_2fcontrol_2fsrc_2fproto_2fleadlag_5fconf_2eproto;
namespace legion {
namespace control {
class LeadlagConf;
...
PROTOBUF_NAMESPACE_OPEN
template<> ::legion::control::LeadlagConf* Arena::CreateMaybeMessage<::legion::control::LeadlagConf>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
namespace legion {
namespace control {
...
class LeadlagConf PROTOBUF_FINAL :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:legion.control.LeadlagConf) */ {
 public:
  ...
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "legion.control.LeadlagConf";
  }
  protected:
  ...
  static ::PROTOBUF_NAMESPACE_ID::Metadata GetMetadataStatic() {
    ::PROTOBUF_NAMESPACE_ID::internal::AssignDescriptors(&::descriptor_table_modules_2fcontrol_2fsrc_2fproto_2fleadlag_5fconf_2eproto);
    return ::descriptor_table_modules_2fcontrol_2fsrc_2fproto_2fleadlag_5fconf_2eproto.file_level_metadata[kIndexInFileMessages];
  }
  ...
  // @@protoc_insertion_point(class_scope:legion.control.LeadlagConf)
 private:
  class _Internal;
  ...
  double alpha_;
  double beta_;
  friend struct ::TableStruct_modules_2fcontrol_2fsrc_2fproto_2fleadlag_5fconf_2eproto;
};
// ===================================================================
...
inline double LeadlagConf::innerstate_saturation_level() const {
  // @@protoc_insertion_point(field_get:legion.control.LeadlagConf.innerstate_saturation_level)
...
inline void LeadlagConf::set_innerstate_saturation_level(double value) {
  ...
  // @@protoc_insertion_point(field_set:legion.control.LeadlagConf.innerstate_saturation_level)
}
...
inline double LeadlagConf::alpha() const {
  // @@protoc_insertion_point(field_get:legion.control.LeadlagConf.alpha)
...
inline void LeadlagConf::set_alpha(double value) {
  ...
  // @@protoc_insertion_point(field_set:legion.control.LeadlagConf.alpha)
}
...
inline double LeadlagConf::beta() const {
  // @@protoc_insertion_point(field_get:legion.control.LeadlagConf.beta)
...
inline void LeadlagConf::set_beta(double value) {
  ...
  // @@protoc_insertion_point(field_set:legion.control.LeadlagConf.beta)
}
...
inline double LeadlagConf::tau() const {
  // @@protoc_insertion_point(field_get:legion.control.LeadlagConf.tau)
...
inline void LeadlagConf::set_tau(double value) {
  ...
  // @@protoc_insertion_point(field_set:legion.control.LeadlagConf.tau)
}
...
#include <google/protobuf/port_undef.inc>
#endif  // GOOGLE_PROTOBUF_INCLUDED_GOOGLE_PROTOBUF_INCLUDED_modules_2fcontrol_2fsrc_2fproto_2fleadlag_5fconf_2eproto
