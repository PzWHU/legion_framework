...
template <typename T>
void LcmMessageManager<T>::PublishGuideInfo(legion::interface::GuideInfo msg) {
  if (is_init_ == false)
    return;
...
template <typename T>
void LcmMessageManager<T>::PublishLaneList(legion::interface::LaneList msg) {
...
template <typename T>
void LcmMessageManager<T>::PublishStopInfo(legion::interface::StopInfo msg) {
  if (is_init_ == false)
    return;
...
template <typename T>
void LcmMessageManager<T>::PublishPolygon2D(legion::interface::Polygon2D msg) {
  if (is_init_ == false)
    return;
