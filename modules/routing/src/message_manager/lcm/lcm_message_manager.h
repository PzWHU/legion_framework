...
public:
   ...
   * @return    void.
   */
  void PublishRoutingResponse(legion::interface::RoutingResponse msg) override;
   ...
   * @return    void.
   */
  void PublishParkingInfo(legion::interface::ParkingInfo msg) override;
   ...
   * @return    void.
   */
  void PublishStopInfo(legion::interface::StopInfo msg) override;
   ...
   * @return    void.
   */
  void PublishGlobalRouteMsg(legion::interface::GlobalRouteMsg msg) override;
   ...
   * @return    void.
   */
  void PublishPolygon2D(legion::interface::Polygon2D msg) override;
   ...
   * @return    void.
   */
  void PublishTrafficEventsOutput(legion::interface::TrafficEvents msg) override;
   ...
   * @return    void.
   */
  void PublishGuideInfo(legion::interface::GuideInfo msg) override;
   ...
   * @return    void.
   */
  void PublishNaviInfoMsg(legion::interface::NaviInfoMsg msg) override;
   ...
   * @return    void.
   */
  // void PublishTrafficLightMsgOutput(legion::interface::TrafficLightMsg msg) override;
   ...
   * @return    void.
   */
  void PublishLaneList(legion::interface::LaneList msg) override;
