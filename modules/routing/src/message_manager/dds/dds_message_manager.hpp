...
template <typename T>
void DdsMessageManager<T>::PublishGuideInfo(legion::interface::GuideInfo msg) {
...
//     legion::interface::TrafficLightMsg msg) {
//   if (is_init_ == false)
//     return;
...
//   std::vector<legion::interface::TrafficLight> legion_traffic_light;
...
//   std::vector<legion::interface::TrafficLightBox> legion_box;
...
//   std::vector<legion::interface::TrafficLightBox> legion_crop_roi;
...
//   std::vector<legion::interface::TrafficLightBox> legion_projected_roi;
...
//   std::vector<legion::interface::TrafficLightBox> legion_rectified_roi;
...
//   std::vector<legion::interface::TrafficLightBox> legion_debug_roi;
...
template <typename T>
void DdsMessageManager<T>::PublishLaneList(legion::interface::LaneList msg) {
  if (is_init_ == false) return;
...
template <typename T>
void DdsMessageManager<T>::PublishStopInfo(legion::interface::StopInfo msg) {
  if (is_init_ == false)
    return;
...
void DdsMessageManager<T>::PublishGlobalRouteMsg(
  ...
  std::vector<legion::interface::PointLLH> legion_global_path;
...
template <typename T>
void DdsMessageManager<T>::PublishPolygon2D(legion::interface::Polygon2D msg) {
  if (is_init_ == false)
    return;
