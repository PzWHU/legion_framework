...
using ::ros2_interface::msg::GlobalRouteMsg;
using ::ros2_interface::msg::Location;
using ::ros2_interface::msg::NaviInfoMsg;
using ::ros2_interface::msg::ObuCmdMsg;
using ::ros2_interface::msg::Odometry;
using ::ros2_interface::msg::ParkingInfo;
using ::ros2_interface::msg::Polygon2D;
...
template <typename T>
Ros2MessageManager<T>::Ros2MessageManager() : Node{"routing"} {}
template <typename T> void Ros2MessageManager<T>::Init(T* t) {
  ...
  routing_response_pub_ =
      create_publisher<::ros2_interface::msg::RoutingResponse>(
  ...
  lane_list_pub_ = create_publisher<::ros2_interface::msg::LaneList>(
      "/routing/LaneList", 
      ROS2_QOS_LARGE_DATA(), 
      PubAllocT{});

  parking_info_pub_ = create_publisher<::ros2_interface::msg::ParkingInfo>(
      "/routing/ParkingInfo", 
      ROS2_QOS_TRIGGER(), 
      PubAllocT{});

  stop_info_pub_ = create_publisher<::ros2_interface::msg::StopInfo>(
      "/routing/StopInfo", 
      ROS2_QOS_TRIGGER(), 
      PubAllocT{});

  global_route_msg_pub_ =
      create_publisher<::ros2_interface::msg::GlobalRouteMsg>(
          "/routing/GlobalRouteMsg", 
          ROS2_QOS_LARGE_DATA(), 
          PubAllocT{});

  navi_info_msg_pub_ = create_publisher<::ros2_interface::msg::NaviInfoMsg>(
      "/routing/NaviInfoMsg",
      ROS2_QOS_NAVIGATION(), 
      PubAllocT{});
  ...
  polygon_2d_pub_ = create_publisher<::ros2_interface::msg::Polygon2D>(
      "/routing/MapBoundary", 
      ROS2_QOS_NAVIGATION(), 
      PubAllocT{});

  traffic_events_output_pub_ =
      create_publisher<::ros2_interface::msg::TrafficEvents>(
  ...
  traffic_light_msg_sub_ = create_subscription<TrafficLightMsg>(
      "/perception/fusion/traffic_sign_fusion/TrafficLightMsg", 
      ROS2_QOS_PERCEPTION(),
  ...
  traffic_events_input_sub_ = create_subscription<TrafficEvents>(
      "/legion_bridge/SpeedLimit", 
      ROS2_QOS_TRIGGER(),
      [this](const ros2_interface::msg::TrafficEvents::SharedPtr msg) {
        Ros2MessageManager::HandleTrafficEventsInputMessage(msg);
      },
      SubAllocT{});

  odometry_sub_ = create_subscription<Odometry>(
      "/localization/local_map_location/Map2LocalTF", 
      ROS2_QOS_PERIODIC_STATUS(),
      [this](const ros2_interface::msg::Odometry::SharedPtr msg) {
        Ros2MessageManager::HandleOdometryMessage(msg);
      },
      SubAllocT{});

  routing_request_sub_ = create_subscription<RoutingRequest>(
      "/legion_bridge/RoutingRequest", 
      ROS2_QOS_TRIGGER(),
      [this](const ros2_interface::msg::RoutingRequest::SharedPtr msg) {
        Ros2MessageManager::HandleRoutingRequestMessage(msg);
      },
      SubAllocT{});
...
void Ros2MessageManager<T>::TaskStart()
{
  ...
  traffic_light_msg_sub_ = create_subscription<TrafficLightMsg>(
      "/perception/fusion/traffic_sign_fusion/TrafficLightMsg", 
      ROS2_QOS_PERCEPTION(),
      [this](const ros2_interface::msg::TrafficLightMsg::SharedPtr msg){Ros2MessageManager::HandleTrafficLightMsgMessage(msg);}, 
      SubAllocT{});

  location_sub_ = create_subscription<Location>(
      "/localization/global_fusion/Location", 
      ROS2_QOS_PERIODIC_STATUS(),
      [this](const ros2_interface::msg::Location::SharedPtr msg){Ros2MessageManager::HandleLocationMessage(msg);}, 
      SubAllocT{});

  chassis_sub_ = create_subscription<Chassis>(
      "/drivers/canbus/Chassis", 
      ROS2_QOS_PERIODIC_STATUS(),
      [this](const ros2_interface::msg::Chassis::SharedPtr msg){Ros2MessageManager::HandleChassisMessage(msg);}, 
      SubAllocT{});

  traffic_events_input_sub_ = create_subscription<TrafficEvents>(
      "/legion_bridge/SpeedLimit", 
      ROS2_QOS_TRIGGER(),
      [this](const ros2_interface::msg::TrafficEvents::SharedPtr msg){Ros2MessageManager::HandleTrafficEventsInputMessage(msg);}, 
      SubAllocT{});

  odometry_sub_ = create_subscription<Odometry>(
      "/localization/local_map_location/Map2LocalTF", 
      ROS2_QOS_PERIODIC_STATUS(),
      [this](const ros2_interface::msg::Odometry::SharedPtr msg){Ros2MessageManager::HandleOdometryMessage(msg);}, 
      SubAllocT{});

  routing_request_sub_ = create_subscription<RoutingRequest>(
      "/legion_bridge/RoutingRequest", 
      ROS2_QOS_CRITICAL_CMD(),
      [this](const ros2_interface::msg::RoutingRequest::SharedPtr msg){Ros2MessageManager::HandleRoutingRequestMessage(msg);}, 
      SubAllocT{});
...
traffic_light_msg_sub_ = nullptr;
location_sub_ = nullptr;
chassis_sub_ = nullptr;
traffic_events_input_sub_ = nullptr;
odometry_sub_ = nullptr;
routing_request_sub_ = nullptr;
    action_mode_ = MessageActionMode::DO_NOTHING;
    is_active_ = false;
    return;
}
...
template <typename T>
void Ros2MessageManager<T>::PublishRoutingResponse(
    legion::interface::RoutingResponse msg) {
  if (is_init_ == false)
    return;
  ::ros2_interface::msg::RoutingResponse routing_response;
  MESSAGE_HEADER_ROS2_ASSIGN(std_msgs::msg, routing_response)
  ...
  std::vector<ros2_interface::msg::LaneInfo> ros_lane_list;
  std::vector<legion::interface::LaneInfo> legion_lane_list;
  ...
  for (auto it_lane_list : legion_lane_list) {
    ...
    std::vector<ros2_interface::msg::LanePoint> ros_lane_points;
    std::vector<legion::interface::LanePoint> legion_lane_points;
...
template <typename T>
void Ros2MessageManager<T>::PublishGuideInfo(legion::interface::GuideInfo msg) {
  if (is_active_ == false) return;
  ::ros2_interface::msg::GuideInfo guide_info;
  MESSAGE_HEADER_ROS2_ASSIGN(std_msgs::msg,guide_info)
  ...
  guide_info_current_road.curvature_size = msg.current_road().curvature_size();
    std::vector<ros2_interface::msg::CurvatureInfo> ros_curvature;
  std::vector<legion::interface::CurvatureInfo> legion_curvature;
...
guide_info.current_road = guide_info_current_road;
  ...
  guide_info_next_road.curvature_size = msg.next_road().curvature_size();
    std::vector<ros2_interface::msg::CurvatureInfo> ros_curvature_1;
  std::vector<legion::interface::CurvatureInfo> legion_curvature_1;
...
template <typename T>
void Ros2MessageManager<T>::PublishLaneList(legion::interface::LaneList msg) {
  if (is_active_ == false) return;
  ::ros2_interface::msg::LaneList lane_list;
  MESSAGE_HEADER_ROS2_ASSIGN(std_msgs::msg,lane_list)
...
lane_list.sensor_calibrator = lane_list_sensor_calibrator;
    std::vector<ros2_interface::msg::LaneLine> ros_camera_laneline;
  std::vector<legion::interface::LaneLine> legion_camera_laneline;
...
lane_list_lane_line.curve_abs = lane_list_lane_line_curve_abs;
    std::vector<ros2_interface::msg::Point3D> ros_pts_vehicle;
  std::vector<legion::interface::Point3D> legion_pts_vehicle;
...
ros_pts_vehicle.emplace_back(lane_list_lane_line_point_3d);
  ...
  lane_list_lane_line.pts_vehicle = ros_pts_vehicle;
    std::vector<ros2_interface::msg::Point2D> ros_pts_image;
  std::vector<legion::interface::Point2D> legion_pts_image;
...
ros_pts_image.emplace_back(lane_list_lane_line_point_2d);
  ...
  lane_list_lane_line.pts_image = ros_pts_image;
    std::vector<ros2_interface::msg::Point3D> ros_pts_abs;
  std::vector<legion::interface::Point3D> legion_pts_abs;
...
lane_list_lane_line.image_end_point = lane_list_lane_line_image_end_point;
    std::vector<ros2_interface::msg::Point2D> ros_pts_key;
  std::vector<legion::interface::Point2D> legion_pts_key;
...
lane_list.hpp = lane_list_hpp;
    std::vector<ros2_interface::msg::RoadMark> ros_road_marks;
  std::vector<legion::interface::RoadMark> legion_road_marks;
...
template <typename T>
void Ros2MessageManager<T>::PublishParkingInfo(
    legion::interface::ParkingInfo msg) {
  if (is_init_ == false)
    return;
  ::ros2_interface::msg::ParkingInfo parking_info;
  MESSAGE_HEADER_ROS2_ASSIGN(std_msgs::msg, parking_info)
  ...
  std::vector<ros2_interface::msg::Point3D> ros_points;
  std::vector<legion::interface::Point3D> legion_points;
  ...
  std::vector<ros2_interface::msg::ParkingStopper> ros_parking_stoppers;
  std::vector<legion::interface::ParkingStopper> legion_parking_stoppers;
  ...
  for (auto it_parking_stoppers : legion_parking_stoppers) {
    ...
    MESSAGE_HEADER_ROS2_ASSIGN(std_msgs::msg, parking_info_parking_stopper)
    ::ros2_interface::msg::Point3D
    ...
    parking_info_parking_stopper.center_point_abs =
        parking_info_parking_stopper_center_point_abs;
    std::vector<ros2_interface::msg::Point3D> ros_stopper_points_vehicle;
    std::vector<legion::interface::Point3D> legion_stopper_points_vehicle;
    ...
    std::vector<ros2_interface::msg::Point3D> ros_stopper_points_abs;
    std::vector<legion::interface::Point3D> legion_stopper_points_abs;
...
template <typename T>
void Ros2MessageManager<T>::PublishStopInfo(legion::interface::StopInfo msg) {
  if (is_init_ == false)
    return;
  ::ros2_interface::msg::StopInfo stop_info;
  MESSAGE_HEADER_ROS2_ASSIGN(std_msgs::msg, stop_info)
  std::vector<ros2_interface::msg::StopPoint> ros_stop_points;
  std::vector<legion::interface::StopPoint> legion_stop_points;
...
template <typename T>
void Ros2MessageManager<T>::PublishGlobalRouteMsg(
    legion::interface::GlobalRouteMsg msg) {
  if (is_init_ == false)
    return;
  ::ros2_interface::msg::GlobalRouteMsg global_route_msg;
  MESSAGE_HEADER_ROS2_ASSIGN(std_msgs::msg, global_route_msg)
  std::vector<ros2_interface::msg::LaneletInfo> ros_route;
  std::vector<legion::interface::LaneletInfo> legion_route;
  ...
  std::vector<ros2_interface::msg::LaneletInfo> ros_cur_slice;
  std::vector<legion::interface::LaneletInfo> legion_cur_slice;
...
template <typename T>
void Ros2MessageManager<T>::PublishPolygon2D(legion::interface::Polygon2D msg) {
  if (is_init_ == false)
    return;
...
template <typename T>
void Ros2MessageManager<T>::PublishTrafficEventsOutput(
    legion::interface::TrafficEvents msg) {
  if (is_init_ == false)
    return;
  ::ros2_interface::msg::TrafficEvents traffic_events;
  MESSAGE_HEADER_ROS2_ASSIGN(std_msgs::msg, traffic_events)
  ...
  std::vector<ros2_interface::msg::Point3D> ros_stop_line;
  std::vector<legion::interface::Point3D> legion_stop_line;
...
template <typename T>
void Ros2MessageManager<T>::PublishNaviInfoMsg(
    legion::interface::NaviInfoMsg msg) {
  if (is_init_ == false) return;
  ::ros2_interface::msg::NaviInfoMsg navi_info_msg;
  MESSAGE_HEADER_ROS2_ASSIGN(std_msgs::msg, navi_info_msg)
  ...
  navi_info_msg_pub_->publish(navi_info_msg);
}
...
template <typename T>
void Ros2MessageManager<T>::HandleTrafficEventsInputMessage(
...
template <typename T>
void Ros2MessageManager<T>::HandleOdometryMessage(
    const ros2_interface::msg::Odometry::SharedPtr msg_obj_ptr) {
  if (is_init_ == false)
    return;
  std::shared_ptr<ros2_interface::msg::Odometry> msg =
      std::const_pointer_cast<ros2_interface::msg::Odometry>(msg_obj_ptr);

  legion::interface::Odometry odometry;
  MESSAGE_HEADER_ROS2_PARSER(odometry)
  legion::interface::PointENU odometry_position;
  ...
  legion::interface::Quaternion odometry_orientation;
...
template <typename T>
void Ros2MessageManager<T>::HandleRoutingRequestMessage(
    const ros2_interface::msg::RoutingRequest::SharedPtr msg_obj_ptr) {
  if (is_init_ == false)
    return;
  std::shared_ptr<ros2_interface::msg::RoutingRequest> msg =
      std::const_pointer_cast<ros2_interface::msg::RoutingRequest>(msg_obj_ptr);

  legion::interface::RoutingRequest routing_request;
  MESSAGE_HEADER_ROS2_PARSER(routing_request)
  ...
  std::vector<legion::interface::KeyPoint> key_point_list;
  for (auto it_key_point_list : msg->key_point_list) {
    legion::interface::KeyPoint routing_request_key_point;
