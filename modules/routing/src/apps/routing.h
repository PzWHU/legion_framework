...
namespace legion
{
  namespace routing
  {
    ...
    struct StopData//@brief 一条停车线的相关信息
    {
      ...
      std::vector<legion::interface::Point3D> stop_points;//@brief 每条车道对应的停车点;
      legion::common::Direction direction;//@brief 停止线方向
      legion::common::TrafficLightColor color;//@brief 对应红绿灯颜色
    };
 ...
 */
   ...
   */
    ...
    protected:
      ...
      legion::local_map::transform::Transformer transformer_; //@brief 接收到的tf消息
      ...
      legion::interface::NaviInfoMsg navi_info_msg_;
      ...
      // std::map<std::string, legion::common::MessageStatus> message_status_;//@brief  消息状态
      ...
      std::vector<legion::common::Direction> junctions_directions_;      //@brief 和路口数量对应的路口转向方向
   ...
   */
      void
      PublishRoutingResponse(legion::interface::RoutingResponse routing_response);

      /**
   * @brief
   * @param  parking_info
   */
      void PublishParkingInfo(legion::interface::ParkingInfo parking_info);

      /**
   * @brief
   * @param  stop_info
   */
      void PublishStopInfo(legion::interface::StopInfo stop_info);

      /**
      * @brief
      * @param  guide_info
      */
      void PublishGuideInfo(legion::interface::GuideInfo guide_info);

      /**
      * @brief
      * @param  navi_info_msg
      */
      void PublishNaviInfoMsg(legion::interface::NaviInfoMsg navi_info_msg);

      /**
      * @brief
      * @param  lane_list
      */
      void PublishLaneList(legion::interface::LaneList lane_list);
	  
	  /**
	   * @brief
	   * @param  traffic_light_msg_output
	   */
  	  void PublishTrafficLightMsgOutput(legion::interface::TrafficLightMsg traffic_light_msg_output);
   ...
   */
       ...
       */
      void PublishGlobalRouteMsg(legion::interface::GlobalRouteMsg global_route_msg);

      /**
       * @brief
       * @param  polygon_2d
       */
      void PublishPolygon2D(legion::interface::Polygon2D polygon_2d);

      /**
       * @brief
       * @param  traffic_events
       */
      void PublishTrafficEventsOutput(legion::interface::TrafficEvents traffic_events_output);
   ...
   public:
       ...
       * @return    void.
       */
      void HandleTrafficLightMsg(legion::interface::TrafficLightMsg traffic_light_msg);
      /**
       * @brief     Odometry消息接收.
       * @param[in] ins .
       * @return    void.
   ...
   * @return    void.
   */
  void HandleTrafficEventsInput(legion::interface::TrafficEvents traffic_events_input);
      /**
   * @brief     RoutingRequest消息接收.
   * @param[in] routing_request .
   * @return    void.
   */
      void HandleRoutingRequest(legion::interface::RoutingRequest routing_request);
   ...
   */
      ...
      legion::common::Direction FindNextJunctionDirection(int id);


      //@brief 找出id对应的本路的转弯方向，用于转向提醒
      legion::common::Direction FindJunctionDirection(int id);
      ...
      /**
			 ...
			 */
      legion::interface::RoutingResponse::PlanStatus GlobalPlan(interface::RoutingRequest request);
      ...
      /**
			 ...
			 */
      legion::interface::RoutingResponse::PlanStatus GetSection(const std::vector<int> &singleroad, std::vector<std::vector<int>> &local_route, const interface::Location pose, const double back_length, const double forward_length);
      ...
      int MatchTrafficlight(legion::common::Direction dir,const std::vector<legion::interface::TrafficLight>& lights);

      // 根据中心点、长宽和旋转角度，计算矩形顶点
      std::vector<legion::interface::Point2D> getRectVertex(legion::interface::Point2D center,float theta,float w,float h);
      // 判断点是否在多边形内
      bool PointInPolygon(legion::interface::Point2D p, std::vector<legion::interface::Point2D>& ptPolygon, int nCount);
