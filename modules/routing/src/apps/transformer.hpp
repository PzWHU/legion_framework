/*
 * @FilePath: /local_map/modules/local_map/src/common/transformer.hpp
 * @Descripttion:
 * @version:
    ...
    namespace local_map
    {
        namespace transform
        {
            ...
            public:
                ...
                {
                    // Eigen::Vector3d rpy = rotation_matrix_.eulerAngles(1, 2, 1);
                    // return rpy.y();
                    return yaw_;
                }
                ...
                //@brief 坐标转换,反向转换
                inline Eigen::Vector3d trans_inv(Eigen::Vector3d input)
                {
